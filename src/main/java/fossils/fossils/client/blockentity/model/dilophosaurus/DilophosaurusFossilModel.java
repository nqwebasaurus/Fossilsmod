...
public class DilophosaurusFossilModel extends SkullModelBase {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition cube_r1 = Dilophosaurus.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(79, 38).mirror().addBox(-2.9455F, -0.3256F, -0.5F, 2.0F, 0.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-0.5F, -0.5098F, -2.8792F, -0.0251F, -0.1095F, -1.2296F));

		PartDefinition cube_r2 = Dilophosaurus.addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(85, 23).mirror().addBox(-1.0F, 0.0F, -0.5F, 1.0F, 0.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-0.5F, -0.5098F, -2.8792F, -0.0595F, -0.0953F, -0.8966F));

		PartDefinition cube_r3 = Dilophosaurus.addOrReplaceChild("cube_r3", CubeListBuilder.create().texOffs(54, 0).mirror().addBox(-1.3206F, -5.3518F, 0.3718F, 1.0F, 1.0F, 4.0F, new CubeDeformation(-0.003F)).mirror(false), PartPose.offsetAndRotation(-0.7794F, 3.1238F, -1.6755F, -0.2443F, 0.0F, 0.1309F));

		PartDefinition cube_r4 = Dilophosaurus.addOrReplaceChild("cube_r4", CubeListBuilder.create().texOffs(55, 73).mirror().addBox(-1.3206F, -3.7654F, 0.3439F, 1.0F, 1.0F, 2.0F, new CubeDeformation(-0.005F)).mirror(false), PartPose.offsetAndRotation(-0.7794F, 3.1238F, -1.6755F, 0.4538F, 0.0F, 0.1309F));

		PartDefinition cube_r5 = Dilophosaurus.addOrReplaceChild("cube_r5", CubeListBuilder.create().texOffs(73, 52).mirror().addBox(-1.3206F, -4.4414F, -1.5674F, 1.0F, 1.0F, 2.0F, new CubeDeformation(-0.003F)).mirror(false)
				.texOffs(19, 51).mirror().addBox(-1.3206F, -4.4414F, -0.0674F, 1.0F, 1.0F, 5.0F, new CubeDeformation(0.003F)).mirror(false), PartPose.offsetAndRotation(-0.7794F, 3.1238F, -1.6755F, -0.0698F, 0.0F, 0.1309F));

		PartDefinition cube_r6 = Dilophosaurus.addOrReplaceChild("cube_r6", CubeListBuilder.create().texOffs(60, 83).mirror().addBox(-1.3206F, -4.5065F, 1.3839F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.003F)).mirror(false), PartPose.offsetAndRotation(-0.7794F, 3.1238F, -1.6755F, 0.5585F, 0.0F, 0.1309F));

		PartDefinition cube_r7 = Dilophosaurus.addOrReplaceChild("cube_r7", CubeListBuilder.create().texOffs(73, 40).mirror().addBox(-1.3206F, -5.0808F, -0.255F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-0.7794F, 3.1238F, -1.6755F, 0.0175F, 0.0F, 0.1309F));

		PartDefinition cube_r8 = Dilophosaurus.addOrReplaceChild("cube_r8", CubeListBuilder.create().texOffs(45, 83).mirror().addBox(0.4042F, 5.9764F, -2.6532F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.203F)).mirror(false), PartPose.offsetAndRotation(-1.7794F, 1.3238F, -2.4755F, -0.1869F, -0.0503F, -0.0987F));

		PartDefinition cube_r9 = Dilophosaurus.addOrReplaceChild("cube_r9", CubeListBuilder.create().texOffs(56, 77).mirror().addBox(0.4042F, 3.8427F, -0.8532F, 1.0F, 3.0F, 1.0F, new CubeDeformation(-0.2F)).mirror(false), PartPose.offsetAndRotation(-1.7794F, 1.3238F, -2.4755F, -0.4661F, -0.0503F, -0.0987F));

		PartDefinition cube_r10 = Dilophosaurus.addOrReplaceChild("cube_r10", CubeListBuilder.create().texOffs(27, 83).mirror().addBox(-0.0042F, 4.0421F, 2.8205F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.24F)).mirror(false), PartPose.offsetAndRotation(-1.4794F, 2.1238F, -0.0755F, 0.0494F, 0.0143F, -0.1494F));

		PartDefinition cube_r11 = Dilophosaurus.addOrReplaceChild("cube_r11", CubeListBuilder.create().texOffs(55, 69).mirror().addBox(-0.0042F, 4.1872F, -1.4915F, 1.0F, 2.0F, 1.0F, new CubeDeformation(-0.23F)).mirror(false), PartPose.offsetAndRotation(-1.4794F, 2.1238F, -0.0755F, 0.9657F, 0.0143F, -0.1494F));

		PartDefinition cube_r12 = Dilophosaurus.addOrReplaceChild("cube_r12", CubeListBuilder.create().texOffs(67, 71).mirror().addBox(-0.4475F, -0.874F, -1.3994F, 1.0F, 2.0F, 2.0F, new CubeDeformation(-0.204F)).mirror(false), PartPose.offsetAndRotation(-1.4794F, 2.1238F, -0.0755F, 1.6972F, 0.1323F, -0.2908F));

		PartDefinition cube_r13 = Dilophosaurus.addOrReplaceChild("cube_r13", CubeListBuilder.create().texOffs(33, 62).mirror().addBox(-1.3206F, -1.6404F, -1.3065F, 1.0F, 1.0F, 3.0F, new CubeDeformation(0.009F)).mirror(false), PartPose.offsetAndRotation(-0.7794F, 3.1238F, -1.6755F, -0.2793F, 0.0F, 0.1309F));

		PartDefinition cube_r14 = Dilophosaurus.addOrReplaceChild("cube_r14", CubeListBuilder.create().texOffs(24, 58).mirror().addBox(-0.0042F, 5.5F, -0.3482F, 1.0F, 1.0F, 2.0F, new CubeDeformation(-0.2F)).mirror(false)
				.texOffs(13, 52).mirror().addBox(-0.0042F, 2.0F, 0.0518F, 1.0F, 4.0F, 1.0F, new CubeDeformation(-0.21F)).mirror(false), PartPose.offsetAndRotation(-1.4794F, 2.1238F, -0.0755F, 0.6167F, 0.0143F, -0.1494F));

		PartDefinition cube_r15 = Dilophosaurus.addOrReplaceChild("cube_r15", CubeListBuilder.create().texOffs(51, 77).mirror().addBox(-0.4475F, -0.2925F, -0.3929F, 1.0F, 3.0F, 1.0F, new CubeDeformation(-0.2F)).mirror(false), PartPose.offsetAndRotation(-1.4794F, 2.1238F, -0.0755F, 0.7897F, 0.1323F, -0.2908F));

		PartDefinition cube_r16 = Dilophosaurus.addOrReplaceChild("cube_r16", CubeListBuilder.create().texOffs(45, 79).mirror().addBox(-0.4475F, -0.6833F, 0.3317F, 1.0F, 2.0F, 1.0F, new CubeDeformation(-0.21F)).mirror(false), PartPose.offsetAndRotation(-1.4794F, 2.1238F, -0.0755F, 0.301F, 0.1323F, -0.2908F));

		PartDefinition cube_r17 = Dilophosaurus.addOrReplaceChild("cube_r17", CubeListBuilder.create().texOffs(61, 79).mirror().addBox(0.4042F, 2.2883F, -0.4974F, 1.0F, 2.0F, 1.0F, new CubeDeformation(-0.21F)).mirror(false), PartPose.offsetAndRotation(-1.7794F, 1.3238F, -2.4755F, -0.5534F, -0.0503F, -0.0987F));

		PartDefinition cube_r18 = Dilophosaurus.addOrReplaceChild("cube_r18", CubeListBuilder.create().texOffs(77, 56).mirror().addBox(-0.2051F, -0.1363F, -0.4189F, 1.0F, 3.0F, 1.0F, new CubeDeformation(-0.2F)).mirror(false), PartPose.offsetAndRotation(-1.7794F, 1.3238F, -2.4755F, -0.5411F, 0.0F, -0.4102F));

		PartDefinition cube_r19 = Dilophosaurus.addOrReplaceChild("cube_r19", CubeListBuilder.create().texOffs(32, 67).mirror().addBox(-1.3206F, -3.7311F, -1.9136F, 1.0F, 3.0F, 2.0F, new CubeDeformation(0.005F)).mirror(false), PartPose.offsetAndRotation(-0.7794F, 3.1238F, -1.6755F, -0.6807F, 0.0F, 0.1309F));

		PartDefinition cube_r20 = Dilophosaurus.addOrReplaceChild("cube_r20", CubeListBuilder.create().texOffs(60, 67).mirror().addBox(-1.3206F, -3.7571F, 0.904F, 1.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-0.7794F, 3.1238F, -1.6755F, 0.0611F, 0.0F, 0.1309F));

		PartDefinition cube_r21 = Dilophosaurus.addOrReplaceChild("cube_r21", CubeListBuilder.create().texOffs(19, 51).addBox(0.3206F, -4.4414F, -0.0674F, 1.0F, 1.0F, 5.0F, new CubeDeformation(0.003F))
				.texOffs(73, 52).addBox(0.3206F, -4.4414F, -1.5674F, 1.0F, 1.0F, 2.0F, new CubeDeformation(-0.003F)), PartPose.offsetAndRotation(0.7794F, 3.1238F, -1.6755F, -0.0698F, 0.0F, -0.1309F));

		PartDefinition cube_r22 = Dilophosaurus.addOrReplaceChild("cube_r22", CubeListBuilder.create().texOffs(60, 83).addBox(0.3206F, -4.5065F, 1.3839F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.003F)), PartPose.offsetAndRotation(0.7794F, 3.1238F, -1.6755F, 0.5585F, 0.0F, -0.1309F));

		PartDefinition cube_r23 = Dilophosaurus.addOrReplaceChild("cube_r23", CubeListBuilder.create().texOffs(55, 73).addBox(0.3206F, -3.7654F, 0.3439F, 1.0F, 1.0F, 2.0F, new CubeDeformation(-0.005F)), PartPose.offsetAndRotation(0.7794F, 3.1238F, -1.6755F, 0.4538F, 0.0F, -0.1309F));

		PartDefinition cube_r24 = Dilophosaurus.addOrReplaceChild("cube_r24", CubeListBuilder.create().texOffs(73, 40).addBox(0.3206F, -5.0808F, -0.255F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.7794F, 3.1238F, -1.6755F, 0.0175F, 0.0F, -0.1309F));

		PartDefinition cube_r25 = Dilophosaurus.addOrReplaceChild("cube_r25", CubeListBuilder.create().texOffs(54, 0).addBox(0.3206F, -5.3518F, 0.3718F, 1.0F, 1.0F, 4.0F, new CubeDeformation(-0.003F)), PartPose.offsetAndRotation(0.7794F, 3.1238F, -1.6755F, -0.2443F, 0.0F, -0.1309F));

		PartDefinition cube_r26 = Dilophosaurus.addOrReplaceChild("cube_r26", CubeListBuilder.create().texOffs(60, 67).addBox(0.3206F, -3.7571F, 0.904F, 1.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.7794F, 3.1238F, -1.6755F, 0.0611F, 0.0F, -0.1309F));

		PartDefinition cube_r27 = Dilophosaurus.addOrReplaceChild("cube_r27", CubeListBuilder.create().texOffs(33, 62).addBox(0.3206F, -1.6404F, -1.3065F, 1.0F, 1.0F, 3.0F, new CubeDeformation(0.009F)), PartPose.offsetAndRotation(0.7794F, 3.1238F, -1.6755F, -0.2793F, 0.0F, -0.1309F));

		PartDefinition cube_r28 = Dilophosaurus.addOrReplaceChild("cube_r28", CubeListBuilder.create().texOffs(32, 67).addBox(0.3206F, -3.7311F, -1.9136F, 1.0F, 3.0F, 2.0F, new CubeDeformation(0.005F)), PartPose.offsetAndRotation(0.7794F, 3.1238F, -1.6755F, -0.6807F, 0.0F, -0.1309F));

		PartDefinition cube_r29 = Dilophosaurus.addOrReplaceChild("cube_r29", CubeListBuilder.create().texOffs(77, 56).addBox(-0.7949F, -0.1363F, -0.4189F, 1.0F, 3.0F, 1.0F, new CubeDeformation(-0.2F)), PartPose.offsetAndRotation(1.7794F, 1.3238F, -2.4755F, -0.5411F, 0.0F, 0.4102F));

		PartDefinition cube_r30 = Dilophosaurus.addOrReplaceChild("cube_r30", CubeListBuilder.create().texOffs(61, 79).addBox(-1.4042F, 2.2883F, -0.4974F, 1.0F, 2.0F, 1.0F, new CubeDeformation(-0.21F)), PartPose.offsetAndRotation(1.7794F, 1.3238F, -2.4755F, -0.5534F, 0.0503F, 0.0987F));

		PartDefinition cube_r31 = Dilophosaurus.addOrReplaceChild("cube_r31", CubeListBuilder.create().texOffs(45, 83).addBox(-1.4042F, 5.9764F, -2.6532F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.203F)), PartPose.offsetAndRotation(1.7794F, 1.3238F, -2.4755F, -0.1869F, 0.0503F, 0.0987F));

		PartDefinition cube_r32 = Dilophosaurus.addOrReplaceChild("cube_r32", CubeListBuilder.create().texOffs(56, 77).addBox(-1.4042F, 3.8427F, -0.8532F, 1.0F, 3.0F, 1.0F, new CubeDeformation(-0.2F)), PartPose.offsetAndRotation(1.7794F, 1.3238F, -2.4755F, -0.4661F, 0.0503F, 0.0987F));

		PartDefinition cube_r33 = Dilophosaurus.addOrReplaceChild("cube_r33", CubeListBuilder.create().texOffs(45, 79).addBox(-0.5525F, -0.6833F, 0.3317F, 1.0F, 2.0F, 1.0F, new CubeDeformation(-0.21F)), PartPose.offsetAndRotation(1.4794F, 2.1238F, -0.0755F, 0.301F, -0.1323F, 0.2908F));

		PartDefinition cube_r34 = Dilophosaurus.addOrReplaceChild("cube_r34", CubeListBuilder.create().texOffs(67, 71).addBox(-0.5525F, -0.874F, -1.3994F, 1.0F, 2.0F, 2.0F, new CubeDeformation(-0.204F)), PartPose.offsetAndRotation(1.4794F, 2.1238F, -0.0755F, 1.6972F, -0.1323F, 0.2908F));

		PartDefinition cube_r35 = Dilophosaurus.addOrReplaceChild("cube_r35", CubeListBuilder.create().texOffs(51, 77).addBox(-0.5525F, -0.2925F, -0.3929F, 1.0F, 3.0F, 1.0F, new CubeDeformation(-0.2F)), PartPose.offsetAndRotation(1.4794F, 2.1238F, -0.0755F, 0.7897F, -0.1323F, 0.2908F));

		PartDefinition cube_r36 = Dilophosaurus.addOrReplaceChild("cube_r36", CubeListBuilder.create().texOffs(55, 69).addBox(-0.9958F, 4.1872F, -1.4915F, 1.0F, 2.0F, 1.0F, new CubeDeformation(-0.23F)), PartPose.offsetAndRotation(1.4794F, 2.1238F, -0.0755F, 0.9657F, -0.0143F, 0.1494F));

		PartDefinition cube_r37 = Dilophosaurus.addOrReplaceChild("cube_r37", CubeListBuilder.create().texOffs(27, 83).addBox(-0.9958F, 4.0421F, 2.8205F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.24F)), PartPose.offsetAndRotation(1.4794F, 2.1238F, -0.0755F, 0.0494F, -0.0143F, 0.1494F));

		PartDefinition cube_r38 = Dilophosaurus.addOrReplaceChild("cube_r38", CubeListBuilder.create().texOffs(13, 52).addBox(-0.9958F, 2.0F, 0.0518F, 1.0F, 4.0F, 1.0F, new CubeDeformation(-0.21F))
				.texOffs(24, 58).addBox(-0.9958F, 5.5F, -0.3482F, 1.0F, 1.0F, 2.0F, new CubeDeformation(-0.2F)), PartPose.offsetAndRotation(1.4794F, 2.1238F, -0.0755F, 0.6167F, -0.0143F, 0.1494F));

		PartDefinition cube_r39 = Dilophosaurus.addOrReplaceChild("cube_r39", CubeListBuilder.create().texOffs(85, 23).addBox(0.0F, 0.0F, -0.5F, 1.0F, 0.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.5F, -0.5098F, -2.8792F, -0.0595F, 0.0953F, 0.8966F));

		PartDefinition cube_r40 = Dilophosaurus.addOrReplaceChild("cube_r40", CubeListBuilder.create().texOffs(79, 38).addBox(0.9455F, -0.3256F, -0.5F, 2.0F, 0.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.5F, -0.5098F, -2.8792F, -0.0251F, 0.1095F, 1.2296F));
		...
		PartDefinition cube_r41 = Body.addOrReplaceChild("cube_r41", CubeListBuilder.create().texOffs(89, 48).mirror().addBox(-3.532F, -1.5399F, -0.5F, 1.0F, 0.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-0.5F, -0.1098F, -0.7292F, -0.1333F, 0.0376F, -1.6242F));

		PartDefinition cube_r42 = Body.addOrReplaceChild("cube_r42", CubeListBuilder.create().texOffs(80, 54).mirror().addBox(-2.9455F, -0.3256F, -0.5F, 2.0F, 0.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-0.5F, -0.1098F, -0.7292F, -0.1051F, 0.0904F, -1.1901F));

		PartDefinition cube_r43 = Body.addOrReplaceChild("cube_r43", CubeListBuilder.create().texOffs(89, 25).mirror().addBox(-1.0F, 0.0F, -0.5F, 1.0F, 0.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-0.5F, -0.1098F, -0.7292F, -0.07F, 0.1196F, -0.8579F));

		PartDefinition cube_r44 = Body.addOrReplaceChild("cube_r44", CubeListBuilder.create().texOffs(90, 88).mirror().addBox(-1.0F, 0.0F, -0.5F, 1.0F, 0.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-0.5F, -0.2098F, -2.5292F, 0.1021F, 0.0382F, -0.7965F));

		PartDefinition cube_r45 = Body.addOrReplaceChild("cube_r45", CubeListBuilder.create().texOffs(83, 16).mirror().addBox(-4.532F, -1.5399F, -0.5F, 2.0F, 0.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-0.5F, -0.2098F, -2.5292F, 0.047F, 0.0984F, -1.5641F));

		PartDefinition cube_r46 = Body.addOrReplaceChild("cube_r46", CubeListBuilder.create().texOffs(83, 18).mirror().addBox(-2.9455F, -0.3256F, -0.5F, 2.0F, 0.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-0.5F, -0.2098F, -2.5292F, 0.0842F, 0.0693F, -1.1271F));

		PartDefinition cube_r47 = Body.addOrReplaceChild("cube_r47", CubeListBuilder.create().texOffs(67, 90).mirror().addBox(-1.0F, 0.0F, -0.5F, 1.0F, 0.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-0.5F, -0.2098F, -4.4292F, 0.1696F, 0.0937F, -0.7397F));

		PartDefinition cube_r48 = Body.addOrReplaceChild("cube_r48", CubeListBuilder.create().texOffs(76, 20).mirror().addBox(-5.532F, -1.5399F, -0.5F, 3.0F, 0.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-0.5F, -0.2098F, -4.4292F, 0.0568F, 0.1851F, -1.5103F));

		PartDefinition cube_r49 = Body.addOrReplaceChild("cube_r49", CubeListBuilder.create().texOffs(83, 14).mirror().addBox(-2.9455F, -0.3256F, -0.5F, 2.0F, 0.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-0.5F, -0.2098F, -4.4292F, 0.1301F, 0.1437F, -1.0699F));

		PartDefinition cube_r50 = Body.addOrReplaceChild("cube_r50", CubeListBuilder.create().texOffs(83, 12).mirror().addBox(-2.9455F, -0.3256F, -0.5F, 2.0F, 0.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-0.5F, -0.2098F, -6.4292F, 0.1581F, 0.1882F, -1.0129F));

		PartDefinition cube_r51 = Body.addOrReplaceChild("cube_r51", CubeListBuilder.create().texOffs(75, 50).mirror().addBox(-5.532F, -1.5399F, -0.5F, 3.0F, 0.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-0.5F, -0.2098F, -6.4292F, 0.0629F, 0.2371F, -1.4567F));

		PartDefinition cube_r52 = Body.addOrReplaceChild("cube_r52", CubeListBuilder.create().texOffs(90, 66).mirror().addBox(-1.0F, 0.0F, -0.5F, 1.0F, 0.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-0.5F, -0.2098F, -6.4292F, 0.2103F, 0.1269F, -0.6828F));

		PartDefinition cube_r53 = Body.addOrReplaceChild("cube_r53", CubeListBuilder.create().texOffs(90, 41).mirror().addBox(-1.0F, 0.0F, -0.5F, 1.0F, 0.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-0.5F, -0.2098F, -8.4292F, 0.2515F, 0.1598F, -0.6246F));

		PartDefinition cube_r54 = Body.addOrReplaceChild("cube_r54", CubeListBuilder.create().texOffs(83, 66).mirror().addBox(-2.9455F, -0.3256F, -0.5F, 2.0F, 0.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-0.5F, -0.2098F, -8.4292F, 0.1866F, 0.2325F, -0.9546F));

		PartDefinition cube_r55 = Body.addOrReplaceChild("cube_r55", CubeListBuilder.create().texOffs(68, 65).mirror().addBox(-6.532F, -1.5399F, -0.5F, 4.0F, 0.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-0.5F, -0.2098F, -8.4292F, 0.0691F, 0.2891F, -1.4027F));

		PartDefinition cube_r56 = Body.addOrReplaceChild("cube_r56", CubeListBuilder.create().texOffs(67, 23).mirror().addBox(-6.532F, -1.5399F, -0.5F, 4.0F, 0.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-0.5F, 0.0902F, -10.4292F, 0.0734F, 0.3238F, -1.384F));

		PartDefinition cube_r57 = Body.addOrReplaceChild("cube_r57", CubeListBuilder.create().texOffs(82, 48).mirror().addBox(-2.9455F, -0.3256F, -0.5F, 2.0F, 0.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-0.5F, 0.0902F, -10.4292F, 0.2059F, 0.262F, -0.9324F));

		PartDefinition cube_r58 = Body.addOrReplaceChild("cube_r58", CubeListBuilder.create().texOffs(90, 39).mirror().addBox(-1.0F, 0.0F, -0.5F, 1.0F, 0.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-0.5F, 0.0902F, -10.4292F, 0.2791F, 0.1816F, -0.6024F));

		PartDefinition cube_r59 = Body.addOrReplaceChild("cube_r59", CubeListBuilder.create().texOffs(68, 65).addBox(2.532F, -1.5399F, -0.5F, 4.0F, 0.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.5F, -0.2098F, -8.4292F, 0.0691F, -0.2891F, 1.4027F));

		PartDefinition cube_r60 = Body.addOrReplaceChild("cube_r60", CubeListBuilder.create().texOffs(83, 66).addBox(0.9455F, -0.3256F, -0.5F, 2.0F, 0.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.5F, -0.2098F, -8.4292F, 0.1866F, -0.2325F, 0.9546F));

		PartDefinition cube_r61 = Body.addOrReplaceChild("cube_r61", CubeListBuilder.create().texOffs(83, 18).addBox(0.9455F, -0.3256F, -0.5F, 2.0F, 0.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.5F, -0.2098F, -2.5292F, 0.0842F, -0.0693F, 1.1271F));

		PartDefinition cube_r62 = Body.addOrReplaceChild("cube_r62", CubeListBuilder.create().texOffs(83, 16).addBox(2.532F, -1.5399F, -0.5F, 2.0F, 0.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.5F, -0.2098F, -2.5292F, 0.047F, -0.0984F, 1.5641F));

		PartDefinition cube_r63 = Body.addOrReplaceChild("cube_r63", CubeListBuilder.create().texOffs(90, 88).addBox(0.0F, 0.0F, -0.5F, 1.0F, 0.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.5F, -0.2098F, -2.5292F, 0.1021F, -0.0382F, 0.7965F));

		PartDefinition cube_r64 = Body.addOrReplaceChild("cube_r64", CubeListBuilder.create().texOffs(83, 14).addBox(0.9455F, -0.3256F, -0.5F, 2.0F, 0.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.5F, -0.2098F, -4.4292F, 0.1301F, -0.1437F, 1.0699F));

		PartDefinition cube_r65 = Body.addOrReplaceChild("cube_r65", CubeListBuilder.create().texOffs(76, 20).addBox(2.532F, -1.5399F, -0.5F, 3.0F, 0.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.5F, -0.2098F, -4.4292F, 0.0568F, -0.1851F, 1.5103F));

		PartDefinition cube_r66 = Body.addOrReplaceChild("cube_r66", CubeListBuilder.create().texOffs(67, 90).addBox(0.0F, 0.0F, -0.5F, 1.0F, 0.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.5F, -0.2098F, -4.4292F, 0.1696F, -0.0937F, 0.7397F));

		PartDefinition cube_r67 = Body.addOrReplaceChild("cube_r67", CubeListBuilder.create().texOffs(90, 66).addBox(0.0F, 0.0F, -0.5F, 1.0F, 0.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.5F, -0.2098F, -6.4292F, 0.2103F, -0.1269F, 0.6828F));

		PartDefinition cube_r68 = Body.addOrReplaceChild("cube_r68", CubeListBuilder.create().texOffs(75, 50).addBox(2.532F, -1.5399F, -0.5F, 3.0F, 0.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.5F, -0.2098F, -6.4292F, 0.0629F, -0.2371F, 1.4567F));

		PartDefinition cube_r69 = Body.addOrReplaceChild("cube_r69", CubeListBuilder.create().texOffs(83, 12).addBox(0.9455F, -0.3256F, -0.5F, 2.0F, 0.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.5F, -0.2098F, -6.4292F, 0.1581F, -0.1882F, 1.0129F));

		PartDefinition cube_r70 = Body.addOrReplaceChild("cube_r70", CubeListBuilder.create().texOffs(90, 41).addBox(0.0F, 0.0F, -0.5F, 1.0F, 0.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.5F, -0.2098F, -8.4292F, 0.2515F, -0.1598F, 0.6246F));

		PartDefinition cube_r71 = Body.addOrReplaceChild("cube_r71", CubeListBuilder.create().texOffs(90, 39).addBox(0.0F, 0.0F, -0.5F, 1.0F, 0.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.5F, 0.0902F, -10.4292F, 0.2791F, -0.1816F, 0.6024F));

		PartDefinition cube_r72 = Body.addOrReplaceChild("cube_r72", CubeListBuilder.create().texOffs(82, 48).addBox(0.9455F, -0.3256F, -0.5F, 2.0F, 0.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.5F, 0.0902F, -10.4292F, 0.2059F, -0.262F, 0.9324F));

		PartDefinition cube_r73 = Body.addOrReplaceChild("cube_r73", CubeListBuilder.create().texOffs(67, 23).addBox(2.532F, -1.5399F, -0.5F, 4.0F, 0.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.5F, 0.0902F, -10.4292F, 0.0734F, -0.3238F, 1.384F));
		...
		PartDefinition cube_r74 = Body.addOrReplaceChild("cube_r74", CubeListBuilder.create().texOffs(89, 48).addBox(2.532F, -1.5399F, -0.5F, 1.0F, 0.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.5F, -0.1098F, -0.7292F, 0.0411F, -0.0463F, 1.6168F));

		PartDefinition cube_r75 = Body.addOrReplaceChild("cube_r75", CubeListBuilder.create().texOffs(80, 54).addBox(0.9455F, -0.3256F, -0.5F, 2.0F, 0.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.5F, -0.1098F, -0.7292F, 0.0569F, -0.0246F, 1.1808F));

		PartDefinition cube_r76 = Body.addOrReplaceChild("cube_r76", CubeListBuilder.create().texOffs(89, 25).addBox(0.0F, 0.0F, -0.5F, 1.0F, 0.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.5F, -0.1098F, -0.7292F, 0.0618F, -0.0048F, 0.8497F));
		...
		PartDefinition cube_r77 = Chest.addOrReplaceChild("cube_r77", CubeListBuilder.create().texOffs(31, 26).mirror().addBox(-6.532F, -1.5399F, -0.5F, 4.0F, 0.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-0.5F, 0.0907F, -2.4054F, 0.077F, 0.2886F, -1.4699F));

		PartDefinition cube_r78 = Chest.addOrReplaceChild("cube_r78", CubeListBuilder.create().texOffs(81, 0).mirror().addBox(-2.9455F, -0.3256F, -0.5F, 2.0F, 0.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-0.5F, 0.0907F, -2.4054F, 0.1933F, 0.2287F, -1.0225F));

		PartDefinition cube_r79 = Chest.addOrReplaceChild("cube_r79", CubeListBuilder.create().texOffs(90, 11).mirror().addBox(-1.0F, 0.0F, -0.5F, 1.0F, 0.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-0.5F, 0.0907F, -2.4054F, 0.2566F, 0.1541F, -0.6933F));
		...
		PartDefinition cube_r80 = Chest.addOrReplaceChild("cube_r80", CubeListBuilder.create().texOffs(42, 26).mirror().addBox(-6.532F, -1.5399F, -0.5F, 4.0F, 0.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-0.5F, 0.0907F, -0.5054F, 0.065F, 0.2544F, -1.4387F));

		PartDefinition cube_r81 = Chest.addOrReplaceChild("cube_r81", CubeListBuilder.create().texOffs(81, 2).mirror().addBox(-2.9455F, -0.3256F, -0.5F, 2.0F, 0.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-0.5F, 0.0907F, -0.5054F, 0.1675F, 0.203F, -0.9936F));

		PartDefinition cube_r82 = Chest.addOrReplaceChild("cube_r82", CubeListBuilder.create().texOffs(90, 13).mirror().addBox(-1.0F, 0.0F, -0.5F, 1.0F, 0.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-0.5F, 0.0907F, -0.5054F, 0.224F, 0.1379F, -0.6636F));

		PartDefinition cube_r83 = Chest.addOrReplaceChild("cube_r83", CubeListBuilder.create().texOffs(90, 15).mirror().addBox(-1.0F, 0.0F, -0.5F, 1.0F, 0.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-0.5F, 0.2907F, -6.4054F, 0.4213F, 0.2882F, -0.8485F));

		PartDefinition cube_r84 = Chest.addOrReplaceChild("cube_r84", CubeListBuilder.create().texOffs(81, 4).mirror().addBox(-2.9455F, -0.3256F, -0.5F, 2.0F, 0.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-0.5F, 0.2907F, -6.4054F, 0.3079F, 0.4076F, -1.178F));

		PartDefinition cube_r85 = Chest.addOrReplaceChild("cube_r85", CubeListBuilder.create().texOffs(81, 6).mirror().addBox(-4.532F, -1.5399F, -0.5F, 2.0F, 0.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-0.5F, 0.2907F, -6.4054F, 0.0964F, 0.497F, -1.654F));

		PartDefinition cube_r86 = Chest.addOrReplaceChild("cube_r86", CubeListBuilder.create().texOffs(73, 44).mirror().addBox(-5.532F, -1.5399F, -0.5F, 3.0F, 0.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-0.5F, 0.0907F, -4.4054F, 0.0799F, 0.3758F, -1.5388F));

		PartDefinition cube_r87 = Chest.addOrReplaceChild("cube_r87", CubeListBuilder.create().texOffs(66, 80).mirror().addBox(-2.9455F, -0.3256F, -0.5F, 2.0F, 0.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-0.5F, 0.0907F, -4.4054F, 0.2354F, 0.306F, -1.0812F));

		PartDefinition cube_r88 = Chest.addOrReplaceChild("cube_r88", CubeListBuilder.create().texOffs(89, 79).mirror().addBox(-1.0F, 0.0F, -0.5F, 1.0F, 0.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-0.5F, 0.0907F, -4.4054F, 0.3211F, 0.214F, -0.7513F));
		...
		PartDefinition cube_r89 = Chest.addOrReplaceChild("cube_r89", CubeListBuilder.create().texOffs(81, 6).addBox(2.532F, -1.5399F, -0.5F, 2.0F, 0.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.5F, 0.2907F, -6.4054F, 0.0964F, -0.497F, 1.654F));

		PartDefinition cube_r90 = Chest.addOrReplaceChild("cube_r90", CubeListBuilder.create().texOffs(81, 4).addBox(0.9455F, -0.3256F, -0.5F, 2.0F, 0.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.5F, 0.2907F, -6.4054F, 0.3079F, -0.4076F, 1.178F));

		PartDefinition cube_r91 = Chest.addOrReplaceChild("cube_r91", CubeListBuilder.create().texOffs(90, 15).addBox(0.0F, 0.0F, -0.5F, 1.0F, 0.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.5F, 0.2907F, -6.4054F, 0.4213F, -0.2882F, 0.8485F));

		PartDefinition cube_r92 = Chest.addOrReplaceChild("cube_r92", CubeListBuilder.create().texOffs(90, 13).addBox(0.0F, 0.0F, -0.5F, 1.0F, 0.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.5F, 0.0907F, -0.5054F, 0.224F, -0.1379F, 0.6636F));

		PartDefinition cube_r93 = Chest.addOrReplaceChild("cube_r93", CubeListBuilder.create().texOffs(81, 2).addBox(0.9455F, -0.3256F, -0.5F, 2.0F, 0.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.5F, 0.0907F, -0.5054F, 0.1675F, -0.203F, 0.9936F));

		PartDefinition cube_r94 = Chest.addOrReplaceChild("cube_r94", CubeListBuilder.create().texOffs(42, 26).addBox(2.532F, -1.5399F, -0.5F, 4.0F, 0.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.5F, 0.0907F, -0.5054F, 0.065F, -0.2544F, 1.4387F));

		PartDefinition cube_r95 = Chest.addOrReplaceChild("cube_r95", CubeListBuilder.create().texOffs(90, 11).addBox(0.0F, 0.0F, -0.5F, 1.0F, 0.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.5F, 0.0907F, -2.4054F, 0.2566F, -0.1541F, 0.6933F));

		PartDefinition cube_r96 = Chest.addOrReplaceChild("cube_r96", CubeListBuilder.create().texOffs(81, 0).addBox(0.9455F, -0.3256F, -0.5F, 2.0F, 0.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.5F, 0.0907F, -2.4054F, 0.1933F, -0.2287F, 1.0225F));

		PartDefinition cube_r97 = Chest.addOrReplaceChild("cube_r97", CubeListBuilder.create().texOffs(31, 26).addBox(2.532F, -1.5399F, -0.5F, 4.0F, 0.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.5F, 0.0907F, -2.4054F, 0.077F, -0.2886F, 1.4699F));

		PartDefinition cube_r98 = Chest.addOrReplaceChild("cube_r98", CubeListBuilder.create().texOffs(89, 79).addBox(0.0F, 0.0F, -0.5F, 1.0F, 0.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.5F, 0.0907F, -4.4054F, 0.3211F, -0.214F, 0.7513F));

		PartDefinition cube_r99 = Chest.addOrReplaceChild("cube_r99", CubeListBuilder.create().texOffs(66, 80).addBox(0.9455F, -0.3256F, -0.5F, 2.0F, 0.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.5F, 0.0907F, -4.4054F, 0.2354F, -0.306F, 1.0812F));

		PartDefinition cube_r100 = Chest.addOrReplaceChild("cube_r100", CubeListBuilder.create().texOffs(73, 44).addBox(2.532F, -1.5399F, -0.5F, 3.0F, 0.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.5F, 0.0907F, -4.4054F, 0.0799F, -0.3758F, 1.5388F));
		...
		PartDefinition cube_r101 = Head.addOrReplaceChild("cube_r101", CubeListBuilder.create().texOffs(5, 87).addBox(-0.5F, -0.1435F, -0.1708F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.155F)), PartPose.offsetAndRotation(0.0F, -1.6339F, -9.9423F, 0.4712F, 0.0F, 0.0F));

		PartDefinition cube_r102 = Head.addOrReplaceChild("cube_r102", CubeListBuilder.create().texOffs(82, 86).mirror().addBox(-0.5F, -1.0067F, -1.4105F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.25F)).mirror(false)
		...
		PartDefinition cube_r103 = Head.addOrReplaceChild("cube_r103", CubeListBuilder.create().texOffs(82, 44).mirror().addBox(-0.3F, -0.7404F, -0.6055F, 1.0F, 2.0F, 1.0F, new CubeDeformation(-0.25F)).mirror(false)
		...
		PartDefinition cube_r104 = Head.addOrReplaceChild("cube_r104", CubeListBuilder.create().texOffs(55, 82).mirror().addBox(-0.5F, -1.201F, -1.4624F, 1.0F, 2.0F, 1.0F, new CubeDeformation(-0.25F)).mirror(false)
		...
		PartDefinition cube_r105 = Head.addOrReplaceChild("cube_r105", CubeListBuilder.create().texOffs(0, 87).mirror().addBox(-0.5F, -0.2793F, 0.442F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.25F)).mirror(false), PartPose.offsetAndRotation(-0.8F, 0.8449F, -4.685F, -0.3142F, -0.0873F, 0.0F));

		PartDefinition cube_r106 = Head.addOrReplaceChild("cube_r106", CubeListBuilder.create().texOffs(0, 87).addBox(-0.5F, -0.2793F, 0.442F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.25F)), PartPose.offsetAndRotation(0.8F, 0.8449F, -4.685F, -0.3142F, 0.0873F, 0.0F));

		PartDefinition cube_r107 = Head.addOrReplaceChild("cube_r107", CubeListBuilder.create().texOffs(82, 56).addBox(-0.6F, -1.201F, -0.4624F, 1.0F, 2.0F, 1.0F, new CubeDeformation(-0.25F))
		...
		PartDefinition cube_r108 = Head.addOrReplaceChild("cube_r108", CubeListBuilder.create().texOffs(50, 82).addBox(-0.5F, -0.5404F, 0.3945F, 1.0F, 2.0F, 1.0F, new CubeDeformation(-0.25F))
		...
		PartDefinition cube_r109 = Head.addOrReplaceChild("cube_r109", CubeListBuilder.create().texOffs(82, 86).addBox(-0.5F, -1.0067F, -1.4105F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.25F))
		...
		PartDefinition cube_r110 = Head.addOrReplaceChild("cube_r110", CubeListBuilder.create().texOffs(33, 82).addBox(-0.5F, -1.3F, 0.1F, 1.0F, 2.0F, 1.0F, new CubeDeformation(-0.25F))
		...
		PartDefinition cube_r111 = Head.addOrReplaceChild("cube_r111", CubeListBuilder.create().texOffs(86, 63).addBox(-0.5F, -0.4F, -0.6F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.15F)), PartPose.offsetAndRotation(0.0F, -1.3339F, -9.5423F, -0.1047F, 0.0F, 0.0F));

		PartDefinition cube_r112 = Head.addOrReplaceChild("cube_r112", CubeListBuilder.create().texOffs(66, 47).addBox(-0.5F, -0.9517F, -0.9977F, 1.0F, 1.0F, 3.0F, new CubeDeformation(0.001F)), PartPose.offsetAndRotation(0.0F, -1.0393F, -8.3924F, 0.1396F, 0.0F, 0.0F));

		PartDefinition cube_r113 = Head.addOrReplaceChild("cube_r113", CubeListBuilder.create().texOffs(58, 86).addBox(-0.5F, 0.0087F, -1.021F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.002F)), PartPose.offsetAndRotation(0.0F, -2.4267F, -8.5198F, 0.5323F, 0.0F, 0.0F));

		PartDefinition cube_r114 = Head.addOrReplaceChild("cube_r114", CubeListBuilder.create().texOffs(74, 75).addBox(-0.5F, -0.004F, -2.0235F, 1.0F, 1.0F, 2.0F, new CubeDeformation(-0.002F)), PartPose.offsetAndRotation(0.0F, -2.3266F, -6.5198F, -0.0436F, 0.0F, 0.0F));

		PartDefinition cube_r115 = Head.addOrReplaceChild("cube_r115", CubeListBuilder.create().texOffs(75, 46).mirror().addBox(-0.53F, -1.0843F, -0.8489F, 1.0F, 1.0F, 2.0F, new CubeDeformation(-0.2F)).mirror(false)
		...
		PartDefinition cube_r116 = Head.addOrReplaceChild("cube_r116", CubeListBuilder.create().texOffs(85, 40).mirror().addBox(-0.53F, -0.8195F, -0.7569F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.204F)).mirror(false)
		...
		PartDefinition cube_r117 = Head.addOrReplaceChild("cube_r117", CubeListBuilder.create().texOffs(74, 4).mirror().addBox(-0.53F, -0.7928F, -1.8644F, 1.0F, 1.0F, 2.0F, new CubeDeformation(-0.204F)).mirror(false)
		...
		PartDefinition cube_r118 = Head.addOrReplaceChild("cube_r118", CubeListBuilder.create().texOffs(86, 8).mirror().addBox(-0.53F, -0.7945F, -0.7743F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.2F)).mirror(false)
		...
		PartDefinition cube_r119 = Head.addOrReplaceChild("cube_r119", CubeListBuilder.create().texOffs(22, 81).mirror().addBox(-0.53F, -1.734F, -0.76F, 1.0F, 2.0F, 1.0F, new CubeDeformation(-0.199F)).mirror(false)
		...
		PartDefinition cube_r120 = Head.addOrReplaceChild("cube_r120", CubeListBuilder.create().texOffs(38, 84).mirror().addBox(-0.37F, -0.2F, -0.8F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.249F)).mirror(false)
		...
		PartDefinition cube_r121 = Head.addOrReplaceChild("cube_r121", CubeListBuilder.create().texOffs(48, 86).mirror().addBox(-0.37F, -0.8F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.254F)).mirror(false)
		...
		PartDefinition cube_r122 = Head.addOrReplaceChild("cube_r122", CubeListBuilder.create().texOffs(84, 79).mirror().addBox(-0.37F, -0.7894F, -0.2243F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.249F)).mirror(false)
		...
		PartDefinition cube_r123 = Head.addOrReplaceChild("cube_r123", CubeListBuilder.create().texOffs(84, 25).mirror().addBox(0.06F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.2F)).mirror(false)
		...
		PartDefinition cube_r124 = Head.addOrReplaceChild("cube_r124", CubeListBuilder.create().texOffs(85, 20).mirror().addBox(-0.37F, -0.78F, -0.2321F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.25F)).mirror(false)
		...
		PartDefinition cube_r125 = Head.addOrReplaceChild("cube_r125", CubeListBuilder.create().texOffs(20, 85).mirror().addBox(-0.37F, -0.7897F, -0.2482F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.249F)).mirror(false)
		...
		PartDefinition cube_r126 = Head.addOrReplaceChild("cube_r126", CubeListBuilder.create().texOffs(7, 74).mirror().addBox(-0.5F, -1.5501F, -1.4054F, 1.0F, 1.0F, 2.0F, new CubeDeformation(-0.2F)).mirror(false), PartPose.offsetAndRotation(-0.99F, -0.9611F, -4.7076F, -2.0857F, -0.1222F, 0.0F));

		PartDefinition cube_r127 = Head.addOrReplaceChild("cube_r127", CubeListBuilder.create().texOffs(74, 8).mirror().addBox(-0.5F, -0.1906F, -1.5302F, 1.0F, 1.0F, 2.0F, new CubeDeformation(-0.204F)).mirror(false)
		...
		PartDefinition cube_r128 = Head.addOrReplaceChild("cube_r128", CubeListBuilder.create().texOffs(37, 75).mirror().addBox(-0.5F, -0.5226F, -1.1313F, 1.0F, 1.0F, 2.0F, new CubeDeformation(-0.208F)).mirror(false), PartPose.offsetAndRotation(-0.99F, -0.9611F, -4.7076F, 3.0805F, -0.1222F, 0.0F));

		PartDefinition cube_r129 = Head.addOrReplaceChild("cube_r129", CubeListBuilder.create().texOffs(25, 86).mirror().addBox(-0.5F, -0.1537F, -0.0219F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.207F)).mirror(false)
		...
		PartDefinition cube_r130 = Head.addOrReplaceChild("cube_r130", CubeListBuilder.create().texOffs(86, 36).mirror().addBox(-0.5F, -1.0357F, 0.3785F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.204F)).mirror(false)
		...
		PartDefinition cube_r131 = Head.addOrReplaceChild("cube_r131", CubeListBuilder.create().texOffs(74, 71).mirror().addBox(-0.4F, -0.5F, -1.0F, 1.0F, 1.0F, 2.0F, new CubeDeformation(-0.207F)).mirror(false), PartPose.offsetAndRotation(-0.39F, -1.7057F, -8.0778F, -2.9576F, -0.0858F, -0.0159F));

		PartDefinition cube_r132 = Head.addOrReplaceChild("cube_r132", CubeListBuilder.create().texOffs(53, 86).mirror().addBox(-0.5F, 0.2597F, -1.0866F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-0.4F, -0.923F, -6.8092F, -0.925F, -0.1745F, 0.1309F));

		PartDefinition cube_r133 = Head.addOrReplaceChild("cube_r133", CubeListBuilder.create().texOffs(81, 71).mirror().addBox(-0.5F, -0.9618F, -0.7449F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.005F)).mirror(false), PartPose.offsetAndRotation(-0.4F, -0.923F, -6.8092F, -0.3665F, -0.1745F, 0.1309F));

		PartDefinition cube_r134 = Head.addOrReplaceChild("cube_r134", CubeListBuilder.create().texOffs(81, 75).mirror().addBox(-0.5F, -0.9397F, 0.1399F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-0.4F, -0.923F, -6.8092F, -0.2618F, -0.1745F, 0.1309F));

		PartDefinition cube_r135 = Head.addOrReplaceChild("cube_r135", CubeListBuilder.create().texOffs(54, 58).mirror().addBox(-1.2F, -1.0F, -1.5F, 1.0F, 2.0F, 3.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(0.0F, -0.3329F, -4.8611F, -0.2803F, -0.0839F, 0.0241F));

		PartDefinition cube_r136 = Head.addOrReplaceChild("cube_r136", CubeListBuilder.create().texOffs(65, 15).mirror().addBox(-0.0263F, -0.1597F, -0.037F, 4.0F, 1.0F, 1.0F, new CubeDeformation(-0.02F)).mirror(false), PartPose.offsetAndRotation(-1.4667F, -1.5984F, -3.0971F, -0.3274F, 1.39F, -0.3123F));

		PartDefinition cube_r137 = Head.addOrReplaceChild("cube_r137", CubeListBuilder.create().texOffs(65, 15).addBox(-3.9737F, -0.1597F, -0.037F, 4.0F, 1.0F, 1.0F, new CubeDeformation(-0.02F)), PartPose.offsetAndRotation(1.4667F, -1.5984F, -3.0971F, -0.3274F, -1.39F, 0.3123F));

		PartDefinition cube_r138 = Head.addOrReplaceChild("cube_r138", CubeListBuilder.create().texOffs(54, 32).addBox(-0.5F, -0.0573F, -3.8964F, 1.0F, 1.0F, 4.0F, new CubeDeformation(-0.025F))
		...
		PartDefinition cube_r139 = Head.addOrReplaceChild("cube_r139", CubeListBuilder.create().texOffs(81, 75).addBox(-0.5F, -0.9397F, 0.1399F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.4F, -0.923F, -6.8092F, -0.2618F, 0.1745F, -0.1309F));

		PartDefinition cube_r140 = Head.addOrReplaceChild("cube_r140", CubeListBuilder.create().texOffs(81, 71).addBox(-0.5F, -0.9618F, -0.7449F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.005F)), PartPose.offsetAndRotation(0.4F, -0.923F, -6.8092F, -0.3665F, 0.1745F, -0.1309F));

		PartDefinition cube_r141 = Head.addOrReplaceChild("cube_r141", CubeListBuilder.create().texOffs(53, 86).addBox(-0.5F, 0.2597F, -1.0866F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.4F, -0.923F, -6.8092F, -0.925F, 0.1745F, -0.1309F));

		PartDefinition cube_r142 = Head.addOrReplaceChild("cube_r142", CubeListBuilder.create().texOffs(54, 58).addBox(0.2F, -1.0F, -1.5F, 1.0F, 2.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -0.3329F, -4.8611F, -0.2803F, 0.0839F, -0.0241F));

		PartDefinition cube_r143 = Head.addOrReplaceChild("cube_r143", CubeListBuilder.create().texOffs(86, 36).addBox(-0.5F, -1.0357F, 0.3785F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.204F))
		...
		PartDefinition cube_r144 = Head.addOrReplaceChild("cube_r144", CubeListBuilder.create().texOffs(44, 75).addBox(-0.5F, -0.8906F, -1.3302F, 1.0F, 1.0F, 2.0F, new CubeDeformation(-0.204F))
		...
		PartDefinition cube_r145 = Head.addOrReplaceChild("cube_r145", CubeListBuilder.create().texOffs(37, 75).addBox(-0.5F, -0.5226F, -1.1313F, 1.0F, 1.0F, 2.0F, new CubeDeformation(-0.208F)), PartPose.offsetAndRotation(0.99F, -0.9611F, -4.7076F, 3.0805F, 0.1222F, 0.0F));

		PartDefinition cube_r146 = Head.addOrReplaceChild("cube_r146", CubeListBuilder.create().texOffs(86, 28).addBox(-0.5F, -0.1537F, 0.5781F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.199F))
		...
		PartDefinition cube_r147 = Head.addOrReplaceChild("cube_r147", CubeListBuilder.create().texOffs(74, 71).addBox(-0.6F, -0.5F, -1.0F, 1.0F, 1.0F, 2.0F, new CubeDeformation(-0.207F)), PartPose.offsetAndRotation(0.39F, -1.7057F, -8.0778F, -2.9576F, 0.0858F, 0.0159F));

		PartDefinition cube_r148 = Head.addOrReplaceChild("cube_r148", CubeListBuilder.create().texOffs(7, 74).addBox(-0.5F, -1.5501F, -1.4054F, 1.0F, 1.0F, 2.0F, new CubeDeformation(-0.2F)), PartPose.offsetAndRotation(0.99F, -0.9611F, -4.7076F, -2.0857F, 0.1222F, 0.0F));

		PartDefinition cube_r149 = Head.addOrReplaceChild("cube_r149", CubeListBuilder.create().texOffs(82, 83).mirror().addBox(-1.0F, 0.0342F, -0.0323F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.005F)).mirror(false)
		...
		PartDefinition cube_r150 = Head.addOrReplaceChild("cube_r150", CubeListBuilder.create().texOffs(0, 84).mirror().addBox(-1.0F, -0.1F, -0.3F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.005F)).mirror(false)
		...
		PartDefinition cube_r151 = Head.addOrReplaceChild("cube_r151", CubeListBuilder.create().texOffs(68, 61).addBox(-2.0F, -1.9831F, -1.0617F, 3.0F, 2.0F, 1.0F, new CubeDeformation(-0.005F)), PartPose.offsetAndRotation(0.5F, 1.4894F, -3.4394F, -0.5934F, 0.0F, 0.0F));

		PartDefinition cube_r152 = Head.addOrReplaceChild("cube_r152", CubeListBuilder.create().texOffs(39, 72).addBox(-2.0F, -2.6F, 1.4F, 3.0F, 1.0F, 1.0F, new CubeDeformation(-0.008F))
		...
		PartDefinition cube_r153 = Head.addOrReplaceChild("cube_r153", CubeListBuilder.create().texOffs(68, 57).addBox(-2.0F, -0.0386F, -0.0053F, 3.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.5F, -0.8106F, -0.2394F, -1.1345F, 0.0F, 0.0F));

		PartDefinition cube_r154 = Head.addOrReplaceChild("cube_r154", CubeListBuilder.create().texOffs(39, 68).addBox(-2.0F, 0.0F, -0.2F, 3.0F, 2.0F, 1.0F, new CubeDeformation(-0.005F)), PartPose.offsetAndRotation(0.5F, -1.2106F, -0.9394F, -0.4712F, 0.0F, 0.0F));

		PartDefinition cube_r155 = Head.addOrReplaceChild("cube_r155", CubeListBuilder.create().texOffs(79, 30).addBox(-1.0F, 0.0F, -0.2F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.005F)), PartPose.offsetAndRotation(0.0F, -1.2106F, -0.9394F, 0.0873F, 0.0F, 0.0F));

		PartDefinition cube_r156 = Head.addOrReplaceChild("cube_r156", CubeListBuilder.create().texOffs(43, 58).addBox(-2.0F, 0.0F, -2.0F, 3.0F, 2.0F, 2.0F, new CubeDeformation(0.005F)), PartPose.offsetAndRotation(0.5F, -1.3106F, -1.1394F, -0.2094F, 0.0F, 0.0F));
		...
		PartDefinition cube_r157 = ParasagittalCrest2.addOrReplaceChild("cube_r157", CubeListBuilder.create().texOffs(0, 59).addBox(-0.5F, -3.6956F, -0.5249F, 1.0F, 2.0F, 3.0F, new CubeDeformation(-0.2F)), PartPose.offsetAndRotation(0.0157F, -3.6684F, 5.5245F, -2.4544F, 0.1921F, -0.0507F));

		PartDefinition cube_r158 = ParasagittalCrest2.addOrReplaceChild("cube_r158", CubeListBuilder.create().texOffs(63, 86).addBox(-0.5F, -2.6988F, 1.6585F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.202F)), PartPose.offsetAndRotation(0.0157F, -3.6684F, 5.5245F, -1.5818F, 0.1921F, -0.0507F));

		PartDefinition cube_r159 = ParasagittalCrest2.addOrReplaceChild("cube_r159", CubeListBuilder.create().texOffs(30, 73).addBox(-0.5F, -0.8832F, 1.1988F, 1.0F, 2.0F, 2.0F, new CubeDeformation(-0.206F)), PartPose.offsetAndRotation(0.0157F, -3.6684F, 5.5245F, -0.8662F, 0.1921F, -0.0507F));

		PartDefinition cube_r160 = ParasagittalCrest2.addOrReplaceChild("cube_r160", CubeListBuilder.create().texOffs(66, 40).addBox(-0.5F, -0.2178F, -0.2377F, 1.0F, 4.0F, 2.0F, new CubeDeformation(-0.202F)), PartPose.offsetAndRotation(0.0157F, -3.6684F, 5.5245F, -0.4124F, 0.1921F, -0.0507F));

		PartDefinition cube_r161 = ParasagittalCrest2.addOrReplaceChild("cube_r161", CubeListBuilder.create().texOffs(56, 12).addBox(0.2F, -0.3799F, -0.2019F, 1.0F, 4.0F, 3.0F, new CubeDeformation(-0.202F)), PartPose.offsetAndRotation(-0.6843F, -3.1644F, 2.9878F, 0.1309F, 0.0F, 0.0F));

		PartDefinition cube_r162 = ParasagittalCrest2.addOrReplaceChild("cube_r162", CubeListBuilder.create().texOffs(40, 79).addBox(-0.5F, -0.1978F, 0.2325F, 1.0F, 3.0F, 1.0F, new CubeDeformation(-0.205F))
		...
		PartDefinition cube_r163 = ParasagittalCrest2.addOrReplaceChild("cube_r163", CubeListBuilder.create().texOffs(65, 33).addBox(-0.5F, -0.2061F, -0.2054F, 1.0F, 4.0F, 2.0F, new CubeDeformation(-0.198F)), PartPose.offsetAndRotation(0.0157F, -1.8838F, 0.8758F, 0.6894F, 0.0F, 0.0F));

		PartDefinition cube_r164 = ParasagittalCrest2.addOrReplaceChild("cube_r164", CubeListBuilder.create().texOffs(0, 70).addBox(-0.5F, -1.7F, -1.0F, 1.0F, 3.0F, 2.0F, new CubeDeformation(-0.207F)), PartPose.offsetAndRotation(0.0157F, -0.6218F, 1.9755F, 1.1956F, 0.0F, 0.0F));

		PartDefinition cube_r165 = ParasagittalCrest2.addOrReplaceChild("cube_r165", CubeListBuilder.create().texOffs(48, 69).addBox(0.2F, -0.2909F, -0.5499F, 1.0F, 3.0F, 2.0F, new CubeDeformation(-0.2F)), PartPose.offsetAndRotation(-0.6843F, 0.1356F, -0.0122F, 0.9687F, 0.0F, 0.0F));
		...
		PartDefinition cube_r166 = ParasagittalCrest3.addOrReplaceChild("cube_r166", CubeListBuilder.create().texOffs(0, 59).mirror().addBox(-0.5F, -3.6956F, -0.5249F, 1.0F, 2.0F, 3.0F, new CubeDeformation(-0.2F)).mirror(false), PartPose.offsetAndRotation(-0.0157F, -3.6684F, 5.5245F, -2.4544F, -0.1921F, 0.0507F));

		PartDefinition cube_r167 = ParasagittalCrest3.addOrReplaceChild("cube_r167", CubeListBuilder.create().texOffs(63, 86).mirror().addBox(-0.5F, -2.6988F, 1.6585F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.202F)).mirror(false), PartPose.offsetAndRotation(-0.0157F, -3.6684F, 5.5245F, -1.5818F, -0.1921F, 0.0507F));

		PartDefinition cube_r168 = ParasagittalCrest3.addOrReplaceChild("cube_r168", CubeListBuilder.create().texOffs(30, 73).mirror().addBox(-0.5F, -0.8832F, 1.1988F, 1.0F, 2.0F, 2.0F, new CubeDeformation(-0.206F)).mirror(false), PartPose.offsetAndRotation(-0.0157F, -3.6684F, 5.5245F, -0.8662F, -0.1921F, 0.0507F));

		PartDefinition cube_r169 = ParasagittalCrest3.addOrReplaceChild("cube_r169", CubeListBuilder.create().texOffs(66, 40).mirror().addBox(-0.5F, -0.2178F, -0.2377F, 1.0F, 4.0F, 2.0F, new CubeDeformation(-0.202F)).mirror(false), PartPose.offsetAndRotation(-0.0157F, -3.6684F, 5.5245F, -0.4124F, -0.1921F, 0.0507F));

		PartDefinition cube_r170 = ParasagittalCrest3.addOrReplaceChild("cube_r170", CubeListBuilder.create().texOffs(56, 12).mirror().addBox(-1.2F, -0.3799F, -0.2019F, 1.0F, 4.0F, 3.0F, new CubeDeformation(-0.202F)).mirror(false), PartPose.offsetAndRotation(0.6843F, -3.1644F, 2.9878F, 0.1309F, 0.0F, 0.0F));

		PartDefinition cube_r171 = ParasagittalCrest3.addOrReplaceChild("cube_r171", CubeListBuilder.create().texOffs(40, 79).mirror().addBox(-0.5F, -0.1978F, 0.2325F, 1.0F, 3.0F, 1.0F, new CubeDeformation(-0.205F)).mirror(false)
		...
		PartDefinition cube_r172 = ParasagittalCrest3.addOrReplaceChild("cube_r172", CubeListBuilder.create().texOffs(65, 33).mirror().addBox(-0.5F, -0.2061F, -0.2054F, 1.0F, 4.0F, 2.0F, new CubeDeformation(-0.198F)).mirror(false), PartPose.offsetAndRotation(-0.0157F, -1.8838F, 0.8758F, 0.6894F, 0.0F, 0.0F));

		PartDefinition cube_r173 = ParasagittalCrest3.addOrReplaceChild("cube_r173", CubeListBuilder.create().texOffs(0, 70).mirror().addBox(-0.5F, -1.7F, -1.0F, 1.0F, 3.0F, 2.0F, new CubeDeformation(-0.207F)).mirror(false), PartPose.offsetAndRotation(-0.0157F, -0.6218F, 1.9755F, 1.1956F, 0.0F, 0.0F));

		PartDefinition cube_r174 = ParasagittalCrest3.addOrReplaceChild("cube_r174", CubeListBuilder.create().texOffs(48, 69).mirror().addBox(-1.2F, -0.2909F, -0.5499F, 1.0F, 3.0F, 2.0F, new CubeDeformation(-0.2F)).mirror(false), PartPose.offsetAndRotation(0.6843F, 0.1356F, -0.0122F, 0.9687F, 0.0F, 0.0F));
		...
		PartDefinition cube_r175 = Jaw.addOrReplaceChild("cube_r175", CubeListBuilder.create().texOffs(35, 87).mirror().addBox(-0.9975F, 0.4959F, 3.2644F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.25F)).mirror(false)
		...
		PartDefinition cube_r176 = Jaw.addOrReplaceChild("cube_r176", CubeListBuilder.create().texOffs(87, 82).mirror().addBox(-2.22F, -1.4121F, 1.7439F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.2F)).mirror(false)
		...
		PartDefinition cube_r177 = Jaw.addOrReplaceChild("cube_r177", CubeListBuilder.create().texOffs(15, 88).mirror().addBox(-1.7F, -1.5877F, 0.4848F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.25F)).mirror(false)
		...
		PartDefinition cube_r178 = Jaw.addOrReplaceChild("cube_r178", CubeListBuilder.create().texOffs(87, 43).mirror().addBox(-1.5F, -0.0622F, -1.0126F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.005F)).mirror(false)
		...
		PartDefinition cube_r179 = Jaw.addOrReplaceChild("cube_r179", CubeListBuilder.create().texOffs(87, 50).mirror().addBox(-2.0F, -0.035F, -0.2776F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.006F)).mirror(false)
		...
		PartDefinition cube_r180 = Jaw.addOrReplaceChild("cube_r180", CubeListBuilder.create().texOffs(88, 0).mirror().addBox(-2.0F, -0.9708F, 0.0501F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.002F)).mirror(false)
		...
		PartDefinition cube_r181 = Jaw.addOrReplaceChild("cube_r181", CubeListBuilder.create().texOffs(67, 18).mirror().addBox(-0.3112F, -0.7F, -0.3F, 1.0F, 1.0F, 3.0F, new CubeDeformation(-0.25F)).mirror(false), PartPose.offsetAndRotation(0.3112F, 2.2527F, -3.6361F, 0.0F, -0.3316F, 0.0F));

		PartDefinition cube_r182 = Jaw.addOrReplaceChild("cube_r182", CubeListBuilder.create().texOffs(87, 85).mirror().addBox(-2.0F, -1.042F, -0.0583F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.008F)).mirror(false)
		...
		PartDefinition cube_r183 = Jaw.addOrReplaceChild("cube_r183", CubeListBuilder.create().texOffs(67, 76).mirror().addBox(-2.0F, -0.0125F, -1.8801F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false)
		...
		PartDefinition cube_r184 = Jaw.addOrReplaceChild("cube_r184", CubeListBuilder.create().texOffs(76, 16).mirror().addBox(-2.0F, -0.0199F, -0.0656F, 1.0F, 1.0F, 2.0F, new CubeDeformation(-0.001F)).mirror(false)
		...
		PartDefinition cube_r185 = Jaw.addOrReplaceChild("cube_r185", CubeListBuilder.create().texOffs(21, 77).mirror().addBox(-1.6F, -0.9359F, -1.8905F, 1.0F, 1.0F, 2.0F, new CubeDeformation(-0.002F)).mirror(false)
		...
		PartDefinition cube_r186 = Jaw.addOrReplaceChild("cube_r186", CubeListBuilder.create().texOffs(23, 67).mirror().addBox(-2.0F, -0.9359F, 0.0095F, 1.0F, 1.0F, 3.0F, new CubeDeformation(-0.002F)).mirror(false)
		...
		PartDefinition cube_r187 = Jaw.addOrReplaceChild("cube_r187", CubeListBuilder.create().texOffs(14, 77).mirror().addBox(-2.0F, -0.0688F, -0.0488F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false)
		...
		PartDefinition cube_r188 = Jaw.addOrReplaceChild("cube_r188", CubeListBuilder.create().texOffs(0, 76).mirror().addBox(-0.5F, -0.6F, -1.3F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.002F)).mirror(false)
		...
		PartDefinition cube_r189 = Jaw.addOrReplaceChild("cube_r189", CubeListBuilder.create().texOffs(35, 87).addBox(-0.0025F, 0.4959F, 3.2644F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.25F))
		...
		PartDefinition cube_r190 = Jaw.addOrReplaceChild("cube_r190", CubeListBuilder.create().texOffs(67, 18).addBox(-0.6888F, -0.7F, -0.3F, 1.0F, 1.0F, 3.0F, new CubeDeformation(-0.25F)), PartPose.offsetAndRotation(0.6888F, 2.2527F, -3.6361F, 0.0F, 0.3316F, 0.0F));
