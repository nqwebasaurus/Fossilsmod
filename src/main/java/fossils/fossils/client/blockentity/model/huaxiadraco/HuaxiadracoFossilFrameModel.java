...
public class HuaxiadracoFossilFrameModel extends SkullModelBase {
	...
	public HuaxiadracoFossilFrameModel(ModelPart root) {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition fossil = partdefinition.addOrReplaceChild("fossil", CubeListBuilder.create().texOffs(2, 1).addBox(-0.5F, -8.0F, 1.7F, 1.0F, 8.0F, 1.0F, new CubeDeformation(-0.31F))
				.texOffs(2, 1).addBox(-0.5F, -10.5F, -3.2F, 1.0F, 11.0F, 1.0F, new CubeDeformation(-0.31F)), PartPose.offset(0.0F, 24.0F, 0.0F));

		PartDefinition cube_r1 = fossil.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(2, 1).addBox(0.3F, -2.0F, -0.5F, 1.0F, 5.0F, 1.0F, new CubeDeformation(-0.3F)), PartPose.offsetAndRotation(-0.4F, -9.5F, -2.7F, 0.0F, 0.0F, -1.5708F));

		PartDefinition cube_r2 = fossil.addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(2, 1).addBox(-2.4F, -2.0F, -0.5F, 1.0F, 4.0F, 1.0F, new CubeDeformation(-0.3F)), PartPose.offsetAndRotation(0.0F, -9.5F, 2.2F, 0.0F, 0.0F, -1.5708F));
		...
		PartDefinition chest2_r1 = chest1.addOrReplaceChild("chest2_r1", CubeListBuilder.create().texOffs(0, 25).addBox(-0.5F, -0.3F, -1.6F, 1.0F, 1.0F, 3.0F, new CubeDeformation(-0.3F)), PartPose.offsetAndRotation(0.0F, -0.4F, -1.3F, 0.1571F, 0.0F, 0.0F));
		...
		PartDefinition body3_r1 = body1.addOrReplaceChild("body3_r1", CubeListBuilder.create().texOffs(17, 18).addBox(-0.5F, 0.2577F, -0.1854F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.3F)), PartPose.offsetAndRotation(0.0F, -0.3269F, 3.0632F, -0.1568F, 0.0054F, -0.0058F));

		PartDefinition body2_r1 = body1.addOrReplaceChild("body2_r1", CubeListBuilder.create().texOffs(15, 16).addBox(-0.5F, 0.2F, -0.4F, 1.0F, 1.0F, 4.0F, new CubeDeformation(-0.3F)), PartPose.offsetAndRotation(0.0F, -0.4412F, -0.2207F, -0.0524F, 0.0F, 0.0F));

		PartDefinition tail1 = body1.addOrReplaceChild("tail1", CubeListBuilder.create().texOffs(31, 32).addBox(-0.5F, -0.6604F, -0.4659F, 1.0F, 1.0F, 2.0F, new CubeDeformation(-0.3F)), PartPose.offsetAndRotation(0.0F, 0.6588F, 3.5793F, 0.1632F, 0.0F, 0.0F));

		PartDefinition leftleg1 = body1.addOrReplaceChild("leftleg1", CubeListBuilder.create(), PartPose.offsetAndRotation(1.7F, 0.3088F, 2.7793F, 0.7968F, -0.1274F, -0.4204F));
		...
		PartDefinition leftfoot = leftleg2.addOrReplaceChild("leftfoot", CubeListBuilder.create(), PartPose.offsetAndRotation(0.0416F, 3.9665F, 0.196F, -0.3582F, 0.0804F, -0.024F));
		...
		PartDefinition rightleg3 = body1.addOrReplaceChild("rightleg3", CubeListBuilder.create(), PartPose.offsetAndRotation(-1.7F, 0.3088F, 2.7793F, 0.535F, 0.1274F, 0.4204F));
		...
		PartDefinition rightfoot = rightleg4.addOrReplaceChild("rightfoot", CubeListBuilder.create(), PartPose.offsetAndRotation(-0.0416F, 3.9665F, 0.196F, -0.3145F, -0.0804F, 0.024F));
		...
		PartDefinition neck2_r1 = neck1.addOrReplaceChild("neck2_r1", CubeListBuilder.create().texOffs(27, 27).addBox(-0.5F, -0.6F, -2.0F, 1.0F, 1.0F, 3.0F, new CubeDeformation(-0.25F)), PartPose.offsetAndRotation(0.0F, 0.8445F, -0.5832F, 0.0436F, 0.0F, 0.0F));

		PartDefinition neck2 = neck1.addOrReplaceChild("neck2", CubeListBuilder.create().texOffs(11, 22).addBox(-0.5F, -0.0178F, -3.0187F, 1.0F, 1.0F, 3.0F, new CubeDeformation(-0.255F)), PartPose.offsetAndRotation(0.0F, 0.2945F, -1.9832F, 0.249F, 0.1723F, 0.028F));
		...
		PartDefinition neck4_r1 = neck3.addOrReplaceChild("neck4_r1", CubeListBuilder.create().texOffs(9, 27).addBox(-0.5F, 0.2F, -2.4F, 1.0F, 1.0F, 3.0F, new CubeDeformation(-0.25F)), PartPose.offsetAndRotation(0.0F, -0.2072F, -0.1519F, -0.0873F, 0.0F, 0.0F));
		...
		PartDefinition leftwing1 = chest1.addOrReplaceChild("leftwing1", CubeListBuilder.create(), PartPose.offsetAndRotation(2.4F, -0.5F, -2.4F, 0.0799F, -0.46F, 0.2713F));
		...
		PartDefinition leftwing3 = leftwing2.addOrReplaceChild("leftwing3", CubeListBuilder.create(), PartPose.offsetAndRotation(-0.3415F, 4.754F, -0.649F, 0.255F, 0.1238F, 0.5816F));

		PartDefinition leftwing4 = leftwing3.addOrReplaceChild("leftwing4", CubeListBuilder.create(), PartPose.offsetAndRotation(0.1172F, 5.6557F, 0.301F, 1.4864F, -0.5178F, -0.4679F));

		PartDefinition leftwing5 = leftwing4.addOrReplaceChild("leftwing5", CubeListBuilder.create(), PartPose.offsetAndRotation(-0.0799F, 0.4836F, 8.346F, 0.2889F, 0.2876F, 0.2714F));
		...
		PartDefinition lefthand2 = leftwing4.addOrReplaceChild("lefthand2", CubeListBuilder.create(), PartPose.offsetAndRotation(0.0413F, -0.1155F, 0.5237F, -2.1762F, -0.0989F, -2.0846F));
		...
		PartDefinition rightwing1 = chest1.addOrReplaceChild("rightwing1", CubeListBuilder.create(), PartPose.offsetAndRotation(-2.4F, -0.5F, -2.4F, -0.1781F, 0.5548F, -0.4113F));
		...
		PartDefinition rightwing3 = rightwing2.addOrReplaceChild("rightwing3", CubeListBuilder.create(), PartPose.offsetAndRotation(0.3415F, 4.754F, -0.649F, 0.255F, -0.1238F, -0.5816F));

		PartDefinition rightwing4 = rightwing3.addOrReplaceChild("rightwing4", CubeListBuilder.create(), PartPose.offsetAndRotation(-0.1172F, 5.6557F, 0.301F, 1.4864F, 0.5178F, 0.4679F));

		PartDefinition rightwing5 = rightwing4.addOrReplaceChild("rightwing5", CubeListBuilder.create(), PartPose.offsetAndRotation(0.0799F, 0.4836F, 8.346F, 0.2889F, -0.2876F, -0.2714F));
		...
		PartDefinition righthand2 = rightwing4.addOrReplaceChild("righthand2", CubeListBuilder.create(), PartPose.offsetAndRotation(-0.0413F, -0.1155F, 0.5237F, -2.2635F, 0.0989F, 2.0846F));
