...
public class ChaoyangopterusFossilFrameModel extends SkullModelBase {
	...
	public ChaoyangopterusFossilFrameModel(ModelPart root) {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition fossil = partdefinition.addOrReplaceChild("fossil", CubeListBuilder.create().texOffs(1, 1).addBox(-0.5F, -15.0F, 2.5F, 1.0F, 11.0F, 1.0F, new CubeDeformation(-0.21F))
				.texOffs(1, 1).addBox(-0.5F, -16.7F, -2.1F, 1.0F, 13.0F, 1.0F, new CubeDeformation(-0.21F)), PartPose.offset(0.0F, 28.0F, 0.0F));

		PartDefinition cube_r1 = fossil.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(1, 1).addBox(-1.2F, -3.0F, -0.5F, 1.0F, 6.0F, 1.0F, new CubeDeformation(-0.2F)), PartPose.offsetAndRotation(0.0F, -16.0F, -1.6F, 0.0F, 0.0F, 1.5708F));

		PartDefinition cube_r2 = fossil.addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(1, 1).addBox(0.5F, -2.0F, -0.5F, 1.0F, 4.0F, 1.0F, new CubeDeformation(-0.2F)), PartPose.offsetAndRotation(0.0F, -16.0F, 3.0F, 0.0F, 0.0F, 1.5708F));
		...
		PartDefinition chest2_r1 = chest1.addOrReplaceChild("chest2_r1", CubeListBuilder.create().texOffs(32, 5).addBox(-0.5F, 0.2F, -1.8F, 1.0F, 1.0F, 3.0F, new CubeDeformation(-0.2F)), PartPose.offsetAndRotation(0.0F, -0.4F, -1.3F, 0.1571F, 0.0F, 0.0F));
		...
		PartDefinition body2_r1 = body1.addOrReplaceChild("body2_r1", CubeListBuilder.create().texOffs(20, -1).addBox(-0.5F, 0.6F, -0.3F, 1.0F, 1.0F, 5.0F, new CubeDeformation(-0.2F)), PartPose.offsetAndRotation(0.0F, -0.4684F, -0.0226F, -0.0349F, 0.0F, 0.0F));

		PartDefinition tail1 = body1.addOrReplaceChild("tail1", CubeListBuilder.create().texOffs(41, 32).addBox(-0.5F, 0.2947F, 0.0397F, 1.0F, 1.0F, 2.0F, new CubeDeformation(-0.202F)), PartPose.offsetAndRotation(0.0F, -0.1663F, 4.099F, -0.3604F, 0.0F, 0.0F));
		...
		PartDefinition leftfoot = leftleg2.addOrReplaceChild("leftfoot", CubeListBuilder.create(), PartPose.offsetAndRotation(0.1711F, 6.9929F, 0.8682F, -0.4019F, 0.0788F, -0.0263F));
		...
		PartDefinition rightfoot = rightleg2.addOrReplaceChild("rightfoot", CubeListBuilder.create(), PartPose.offsetAndRotation(-0.1711F, 6.9929F, 0.8682F, -0.4019F, -0.0788F, 0.0263F));
		...
		PartDefinition neck2_r1 = neck1.addOrReplaceChild("neck2_r1", CubeListBuilder.create().texOffs(31, -1).addBox(-0.5F, -0.3219F, -3.9084F, 1.0F, 1.0F, 4.0F, new CubeDeformation(-0.2F)), PartPose.offsetAndRotation(0.0F, 0.6734F, 0.5272F, -0.0437F, 0.0698F, -0.0018F));

		PartDefinition neck2 = neck1.addOrReplaceChild("neck2", CubeListBuilder.create().texOffs(11, 29).addBox(-0.5F, 0.2F, -3.101F, 1.0F, 1.0F, 3.0F, new CubeDeformation(-0.2F)), PartPose.offsetAndRotation(0.0F, 0.1207F, -2.5762F, -0.3172F, 0.4517F, 0.2035F));

		PartDefinition neck3 = neck2.addOrReplaceChild("neck3", CubeListBuilder.create(), PartPose.offsetAndRotation(0.0F, -0.0964F, -2.7411F, 0.2134F, 0.099F, -0.0193F));

		PartDefinition neck4_r1 = neck3.addOrReplaceChild("neck4_r1", CubeListBuilder.create().texOffs(13, 17).addBox(-0.5F, 0.3124F, -0.2126F, 1.0F, 1.0F, 4.0F, new CubeDeformation(-0.2F)), PartPose.offsetAndRotation(0.0F, 0.0929F, -3.8518F, 0.0349F, 0.0F, 0.0F));
		...
		PartDefinition leftwing4 = leftwing3.addOrReplaceChild("leftwing4", CubeListBuilder.create(), PartPose.offsetAndRotation(0.3159F, 6.5818F, -0.136F, 1.4375F, -0.5083F, -0.3684F));

		PartDefinition leftwing5 = leftwing4.addOrReplaceChild("leftwing5", CubeListBuilder.create(), PartPose.offsetAndRotation(-0.0678F, 0.2873F, 8.3099F, 0.0885F, 0.162F, 0.2337F));
		...
		PartDefinition lefthand2 = leftwing4.addOrReplaceChild("lefthand2", CubeListBuilder.create(), PartPose.offsetAndRotation(0.0413F, -0.1155F, 0.5237F, -2.7434F, -0.0989F, -2.0846F));
		...
		PartDefinition rightwing3 = rightwing2.addOrReplaceChild("rightwing3", CubeListBuilder.create(), PartPose.offsetAndRotation(0.0869F, 5.8009F, 0.3333F, 0.3492F, -0.0834F, -0.6608F));

		PartDefinition rightwing4 = rightwing3.addOrReplaceChild("rightwing4", CubeListBuilder.create(), PartPose.offsetAndRotation(-0.3159F, 6.5818F, -0.136F, 1.5615F, 0.5239F, 0.6187F));

		PartDefinition rightwing5 = rightwing4.addOrReplaceChild("rightwing5", CubeListBuilder.create(), PartPose.offsetAndRotation(0.0678F, 0.2873F, 8.3099F, 0.0885F, -0.162F, -0.2337F));
		...
		PartDefinition righthand2 = rightwing4.addOrReplaceChild("righthand2", CubeListBuilder.create(), PartPose.offsetAndRotation(-0.0413F, -0.1155F, 0.5237F, -2.132F, -0.0309F, 2.1009F));
