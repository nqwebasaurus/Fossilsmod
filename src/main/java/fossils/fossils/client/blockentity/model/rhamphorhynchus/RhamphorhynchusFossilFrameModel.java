...
public class RhamphorhynchusFossilFrameModel extends SkullModelBase {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition fossil = partdefinition.addOrReplaceChild("fossil", CubeListBuilder.create().texOffs(1, 1).addBox(-0.5F, -8.6F, 4.6F, 1.0F, 9.0F, 1.0F, new CubeDeformation(-0.16F)), PartPose.offset(0.0F, 24.0F, 0.0F));

		PartDefinition cube_r1 = fossil.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(1, 1).addBox(5.2F, -2.0F, -0.5F, 1.0F, 4.0F, 1.0F, new CubeDeformation(-0.15F)), PartPose.offsetAndRotation(0.0F, -14.5F, 5.1F, 0.0F, 0.0F, 1.5708F));

		PartDefinition cube_r2 = fossil.addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(1, 1).addBox(-2.3F, -3.5F, -0.5F, 1.0F, 6.0F, 1.0F, new CubeDeformation(-0.15F)), PartPose.offsetAndRotation(-0.5F, -15.8F, -3.5F, 0.0436F, 0.0F, 1.5708F));

		PartDefinition cube_r3 = fossil.addOrReplaceChild("cube_r3", CubeListBuilder.create().texOffs(1, 1).addBox(0.0F, -3.7F, -0.5F, 1.0F, 20.0F, 1.0F, new CubeDeformation(-0.16F)), PartPose.offsetAndRotation(-0.5F, -15.8F, -3.5F, 0.0F, 0.0436F, 0.0F));
		...
		PartDefinition chest_r1 = chest.addOrReplaceChild("chest_r1", CubeListBuilder.create().texOffs(0, 62).addBox(-0.5F, 0.075F, -1.6F, 1.0F, 1.0F, 3.0F, new CubeDeformation(-0.25F)), PartPose.offsetAndRotation(0.0F, -0.4F, 0.0F, 0.0873F, 0.0F, 0.0F));
		...
		PartDefinition leftwing2 = leftwing1.addOrReplaceChild("leftwing2", CubeListBuilder.create(), PartPose.offsetAndRotation(4.1189F, 0.1874F, -1.1802F, -1.3656F, 0.4288F, -1.8285F));

		PartDefinition leftwing3 = leftwing2.addOrReplaceChild("leftwing3", CubeListBuilder.create(), PartPose.offsetAndRotation(-0.3287F, 6.8112F, -0.4604F, 0.3324F, 0.3933F, 0.354F));

		PartDefinition leftwing4 = leftwing3.addOrReplaceChild("leftwing4", CubeListBuilder.create(), PartPose.offsetAndRotation(-0.1353F, 2.8725F, 0.4866F, -1.0785F, -0.6411F, -0.4654F));

		PartDefinition leftwing5 = leftwing4.addOrReplaceChild("leftwing5", CubeListBuilder.create(), PartPose.offsetAndRotation(-0.0651F, 0.0332F, 10.0663F, 0.1899F, 0.0529F, 0.2023F));

		PartDefinition leftwing7 = leftwing5.addOrReplaceChild("leftwing7", CubeListBuilder.create(), PartPose.offsetAndRotation(-0.0488F, -0.0432F, 9.4877F, 0.1895F, 0.0193F, 0.1927F));
		...
		PartDefinition lefthand2 = leftwing4.addOrReplaceChild("lefthand2", CubeListBuilder.create(), PartPose.offsetAndRotation(0.0092F, 0.0525F, 0.712F, -1.4709F, 1.3671F, 0.7663F));
		...
		PartDefinition rightwing2 = rightwing1.addOrReplaceChild("rightwing2", CubeListBuilder.create(), PartPose.offsetAndRotation(-4.1189F, 0.1874F, -1.1802F, -1.7689F, -0.6701F, 2.2534F));
		...
		PartDefinition rightwing4 = rightwing3.addOrReplaceChild("rightwing4", CubeListBuilder.create(), PartPose.offsetAndRotation(0.1353F, 2.8725F, 0.4866F, -0.8958F, 0.416F, 0.3098F));

		PartDefinition rightwing5 = rightwing4.addOrReplaceChild("rightwing5", CubeListBuilder.create(), PartPose.offsetAndRotation(0.0651F, 0.0332F, 10.0663F, 0.1676F, -0.1221F, 0.0512F));

		PartDefinition rightwing7 = rightwing5.addOrReplaceChild("rightwing7", CubeListBuilder.create(), PartPose.offsetAndRotation(0.0488F, -0.0432F, 9.4877F, 0.1895F, -0.0193F, -0.1927F));

		PartDefinition rightwing8 = rightwing7.addOrReplaceChild("rightwing8", CubeListBuilder.create(), PartPose.offsetAndRotation(-0.0432F, -0.0296F, 9.5377F, 0.1462F, 0.0478F, -0.1737F));
		...
		PartDefinition righthand2 = rightwing4.addOrReplaceChild("righthand2", CubeListBuilder.create(), PartPose.offsetAndRotation(-0.0092F, 0.0525F, 0.712F, -1.8601F, -1.4749F, 0.0257F));
		...
		PartDefinition chest_r2 = body3.addOrReplaceChild("chest_r2", CubeListBuilder.create().texOffs(64, 61).addBox(-0.5F, 0.025F, 3.55F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.25F))
				.texOffs(62, 59).addBox(-0.5F, 0.025F, 1.05F, 1.0F, 1.0F, 3.0F, new CubeDeformation(-0.25F)), PartPose.offsetAndRotation(0.0F, 0.3F, -1.0F, 0.0873F, 0.0F, 0.0F));
		...
		PartDefinition body4_r1 = body2.addOrReplaceChild("body4_r1", CubeListBuilder.create().texOffs(44, 59).addBox(-0.5F, -0.3F, 0.15F, 1.0F, 1.0F, 3.0F, new CubeDeformation(-0.25F)), PartPose.offsetAndRotation(0.0F, 0.5F, 0.0F, -0.1309F, 0.0F, 0.0F));
		...
		PartDefinition body4_r2 = body.addOrReplaceChild("body4_r2", CubeListBuilder.create().texOffs(18, 58).addBox(-0.5F, -0.3F, 6.175F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.25F))
				.texOffs(15, 55).addBox(-0.5F, -0.3F, 2.675F, 1.0F, 1.0F, 4.0F, new CubeDeformation(-0.25F)), PartPose.offsetAndRotation(0.0F, 0.0F, -3.0F, -0.1309F, 0.0F, 0.0F));
		...
		PartDefinition body2_r1 = body1.addOrReplaceChild("body2_r1", CubeListBuilder.create().texOffs(9, 61).addBox(-0.5F, 0.2697F, -2.5889F, 1.0F, 1.0F, 3.0F, new CubeDeformation(-0.25F)), PartPose.offsetAndRotation(0.0F, 0.1918F, 3.225F, -0.0785F, 0.0F, 0.0F));

		PartDefinition tail1 = body1.addOrReplaceChild("tail1", CubeListBuilder.create().texOffs(43, 68).addBox(-0.5F, -0.025F, -0.15F, 1.0F, 1.0F, 2.0F, new CubeDeformation(-0.25F))
				.texOffs(44, 69).addBox(-0.5F, -0.025F, 1.35F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.25F)), PartPose.offsetAndRotation(0.0F, 0.5779F, 2.8993F, 0.4269F, 0.0F, 0.0F));

		PartDefinition tail2 = tail1.addOrReplaceChild("tail2", CubeListBuilder.create().texOffs(0, 0).addBox(-0.5F, 0.0F, -0.3F, 1.0F, 1.0F, 11.0F, new CubeDeformation(-0.25F))
				.texOffs(10, 10).addBox(-0.5F, 0.0F, 10.2F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.25F)), PartPose.offsetAndRotation(0.0F, 0.0079F, 1.8316F, 0.4405F, -0.0773F, 0.0F));

		PartDefinition tail3 = tail2.addOrReplaceChild("tail3", CubeListBuilder.create().texOffs(46, 44).addBox(-0.5F, 0.025F, -0.1F, 1.0F, 1.0F, 8.0F, new CubeDeformation(-0.25F)), PartPose.offsetAndRotation(0.0F, -0.0314F, 10.6992F, 0.1217F, -0.0085F, 0.067F));

		PartDefinition tail4 = tail3.addOrReplaceChild("tail4", CubeListBuilder.create().texOffs(46, 34).addBox(-0.5F, 0.04F, -0.4002F, 1.0F, 1.0F, 8.0F, new CubeDeformation(-0.25F))
				.texOffs(53, 41).addBox(-0.5F, 0.04F, 7.0998F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.25F)), PartPose.offsetAndRotation(0.0F, -0.0075F, 7.6999F, 0.0519F, 0.0F, 0.0F));

		PartDefinition tail5 = tail4.addOrReplaceChild("tail5", CubeListBuilder.create().texOffs(23, 25).addBox(-0.5F, 0.0389F, -0.2501F, 1.0F, 1.0F, 10.0F, new CubeDeformation(-0.25F)), PartPose.offsetAndRotation(0.0F, 0.0121F, 7.7995F, 0.0604F, 0.0F, 0.0F));
		...
		PartDefinition leftLeg2 = leftLeg.addOrReplaceChild("leftLeg2", CubeListBuilder.create(), PartPose.offsetAndRotation(-0.0063F, 4.2779F, 0.12F, 0.9906F, -0.0875F, 0.0975F));

		PartDefinition leftLeg3 = leftLeg2.addOrReplaceChild("leftLeg3", CubeListBuilder.create(), PartPose.offsetAndRotation(0.1238F, 6.3451F, 0.7863F, -0.404F, 0.136F, 0.069F));
		...
		PartDefinition rightLeg3 = rightLeg2.addOrReplaceChild("rightLeg3", CubeListBuilder.create(), PartPose.offsetAndRotation(-0.1238F, 6.3451F, 0.7863F, 0.2505F, -0.136F, -0.069F));
		...
		PartDefinition cube_r4 = neck1.addOrReplaceChild("cube_r4", CubeListBuilder.create().texOffs(35, 59).addBox(-0.5F, 0.125F, 0.375F, 1.0F, 1.0F, 3.0F, new CubeDeformation(-0.25F)), PartPose.offsetAndRotation(0.0F, 0.4684F, -3.1978F, 0.1309F, 0.0F, 0.0F));

		PartDefinition neck2 = neck1.addOrReplaceChild("neck2", CubeListBuilder.create(), PartPose.offsetAndRotation(0.0F, 0.372F, -2.5937F, -0.1152F, 0.0F, 0.0F));

		PartDefinition cube_r5 = neck2.addOrReplaceChild("cube_r5", CubeListBuilder.create().texOffs(58, 69).addBox(-0.525F, -0.5F, 1.2F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.25F))
				.texOffs(57, 68).addBox(-0.525F, -0.5F, -0.3F, 1.0F, 1.0F, 2.0F, new CubeDeformation(-0.25F)), PartPose.offsetAndRotation(-0.0427F, 0.6474F, -1.6469F, 0.0192F, 0.0534F, 0.0086F));

		PartDefinition neck3 = neck2.addOrReplaceChild("neck3", CubeListBuilder.create(), PartPose.offsetAndRotation(0.0F, 0.0595F, -1.7151F, -0.0249F, 0.1001F, 0.4776F));

		PartDefinition cube_r6 = neck3.addOrReplaceChild("cube_r6", CubeListBuilder.create().texOffs(53, 59).addBox(-0.5F, 0.7F, -0.5F, 1.0F, 1.0F, 3.0F, new CubeDeformation(-0.25F)), PartPose.offsetAndRotation(0.0F, -0.611F, -2.109F, 0.0F, 0.0349F, 0.0F));

		PartDefinition neck4 = neck3.addOrReplaceChild("neck4", CubeListBuilder.create(), PartPose.offsetAndRotation(0.0F, 0.0996F, -2.6108F, -0.1588F, 0.0F, 0.0F));

		PartDefinition cube_r7 = neck4.addOrReplaceChild("cube_r7", CubeListBuilder.create().texOffs(65, 69).addBox(-0.5F, -0.625F, 1.3F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.25F))
				.texOffs(64, 68).addBox(-0.5F, -0.625F, -0.2F, 1.0F, 1.0F, 2.0F, new CubeDeformation(-0.25F)), PartPose.offsetAndRotation(0.0F, 0.6243F, -1.6472F, 0.0305F, 0.0F, 0.0F));

		PartDefinition neck5 = neck4.addOrReplaceChild("neck5", CubeListBuilder.create().texOffs(7, 69).addBox(-0.5F, 0.246F, -2.0023F, 1.0F, 1.0F, 2.0F, new CubeDeformation(-0.25F)), PartPose.offsetAndRotation(0.0F, -0.2745F, -1.5681F, 0.4084F, 0.0F, 0.0F));
		...
		PartDefinition jaw = head.addOrReplaceChild("jaw", CubeListBuilder.create(), PartPose.offsetAndRotation(0.0F, 1.7371F, -0.425F, 1.2039F, 0.0F, 0.0F));
