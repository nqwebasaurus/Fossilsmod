...
public class StensioellaFossilSlabModel extends SkullModelBase {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition fossil = partdefinition.addOrReplaceChild("fossil", CubeListBuilder.create(), PartPose.offset(0.0F, 24.0F, -8.0F));

		PartDefinition cube_r1 = fossil.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(0, 0).addBox(-1.8177F, -1.0F, 0.2041F, 12.0F, 2.0F, 36.0F, new CubeDeformation(0.003F)), PartPose.offsetAndRotation(-8.3F, -1.0F, -8.2F, 0.0F, 0.0436F, 0.0F));

		PartDefinition cube_r2 = fossil.addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(51, 42).addBox(-10.6174F, -1.0F, -0.4939F, 10.0F, 2.0F, 24.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(12.0F, -1.0F, 9.1F, 0.0F, -0.3927F, 0.0F));

		PartDefinition cube_r3 = fossil.addOrReplaceChild("cube_r3", CubeListBuilder.create().texOffs(0, 39).addBox(-4.5F, -1.0F, -18.0F, 13.0F, 2.0F, 24.0F, new CubeDeformation(-0.003F)), PartPose.offsetAndRotation(1.5F, -1.0F, 6.5F, 0.0F, 0.4363F, 0.0F));

		PartDefinition Stensioella = fossil.addOrReplaceChild("Stensioella", CubeListBuilder.create(), PartPose.offset(0.0F, -2.0F, -2.0F));
		...
		PartDefinition head = Stensioella.addOrReplaceChild("head", CubeListBuilder.create().texOffs(22, 25).addBox(-2.0F, 0.3136F, -7.1464F, 4.0F, 0.0F, 1.0F, new CubeDeformation(0.0F))
				...
				.texOffs(18, 10).addBox(-1.0F, 0.1679F, -6.7037F, 2.0F, 0.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -0.5517F, -1.3342F));
		...
		PartDefinition cube_r4 = head.addOrReplaceChild("cube_r4", CubeListBuilder.create().texOffs(0, 8).addBox(-0.0501F, -2.3115F, -5.3811F, 1.0F, 0.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 2.3517F, 0.8342F, 0.0F, 1.0897F, -0.0669F));

		PartDefinition cube_r5 = head.addOrReplaceChild("cube_r5", CubeListBuilder.create().texOffs(0, 11).addBox(-0.9499F, -2.3115F, -5.3811F, 1.0F, 0.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 2.3517F, 0.8342F, 0.0F, -1.0897F, 0.0669F));

		PartDefinition cube_r6 = head.addOrReplaceChild("cube_r6", CubeListBuilder.create().texOffs(27, 10).addBox(-1.3827F, -2.321F, -4.1027F, 2.0F, 0.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 2.3517F, 0.8342F, 0.0F, 0.7848F, -0.0349F));

		PartDefinition cube_r7 = head.addOrReplaceChild("cube_r7", CubeListBuilder.create().texOffs(22, 27).addBox(-0.6173F, -2.321F, -4.1027F, 2.0F, 0.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 2.3517F, 0.8342F, 0.0F, -0.7848F, 0.0349F));

		PartDefinition body = head.addOrReplaceChild("body", CubeListBuilder.create().texOffs(0, 0).addBox(-2.5F, 0.0F, -1.0F, 5.0F, 0.0F, 7.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.2517F, -0.1658F, 0.0F, 0.0436F, 0.0F));
