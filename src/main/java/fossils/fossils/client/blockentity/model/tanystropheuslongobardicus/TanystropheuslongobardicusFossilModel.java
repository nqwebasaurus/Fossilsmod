...
public class TanystropheuslongobardicusFossilModel extends SkullModelBase {
	...
	public TanystropheuslongobardicusFossilModel(ModelPart root) {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition cube_r69 = neckbase.addOrReplaceChild("cube_r69", CubeListBuilder.create().texOffs(101, 26).mirror().addBox(-2.3946F, -0.9894F, -1.4753F, 2.0F, 1.0F, 7.0F, new CubeDeformation(-0.003F)).mirror(false), PartPose.offsetAndRotation(-1.0F, 8.2539F, -2.5523F, -0.2746F, 0.3031F, -0.0839F));

		PartDefinition cube_r70 = neckbase.addOrReplaceChild("cube_r70", CubeListBuilder.create().texOffs(114, 76).mirror().addBox(-2.3761F, -0.9894F, -2.6931F, 2.0F, 1.0F, 4.0F, new CubeDeformation(0.001F)).mirror(false), PartPose.offsetAndRotation(-1.0F, 8.2539F, -2.5523F, -0.3486F, -0.711F, 0.2329F));
		...
		PartDefinition cube_r111 = neckbase.addOrReplaceChild("cube_r111", CubeListBuilder.create().texOffs(101, 26).addBox(0.3946F, -0.9894F, -1.4753F, 2.0F, 1.0F, 7.0F, new CubeDeformation(-0.003F)), PartPose.offsetAndRotation(1.0F, 8.2539F, -2.5523F, -0.2746F, -0.3031F, 0.0839F));

		PartDefinition cube_r112 = neckbase.addOrReplaceChild("cube_r112", CubeListBuilder.create().texOffs(114, 76).addBox(0.3761F, -0.9894F, -2.6931F, 2.0F, 1.0F, 4.0F, new CubeDeformation(0.001F)), PartPose.offsetAndRotation(1.0F, 8.2539F, -2.5523F, -0.3486F, 0.711F, -0.2329F));
		...
		PartDefinition frontLeftLeg = neckbase.addOrReplaceChild("frontLeftLeg", CubeListBuilder.create().texOffs(123, 82).addBox(-1.4061F, -1.2135F, -1.0464F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F))
				.texOffs(114, 123).addBox(-1.4061F, 6.7865F, -1.3464F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(6.4507F, 6.8422F, -2.678F, 1.2656F, 0.1791F, -0.618F));
		...
		PartDefinition frontLeftLeg3 = frontLeftLeg2.addOrReplaceChild("frontLeftLeg3", CubeListBuilder.create().texOffs(26, 117).addBox(-3.0F, -0.5F, -1.6F, 4.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.2697F, 7.1544F, -0.0233F, 1.1262F, -0.1307F, 0.1014F));

		PartDefinition frontLeftLeg4 = frontLeftLeg3.addOrReplaceChild("frontLeftLeg4", CubeListBuilder.create().texOffs(49, 109).addBox(1.5F, -0.6F, -3.8F, 4.0F, 1.0F, 4.0F, new CubeDeformation(0.005F)), PartPose.offsetAndRotation(-4.5F, 0.1F, -1.3F, -0.1309F, 0.0F, 0.0F));
		...
		PartDefinition frontRightLeg = neckbase.addOrReplaceChild("frontRightLeg", CubeListBuilder.create().texOffs(123, 87).addBox(-0.5939F, -1.2135F, -1.0464F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F))
				.texOffs(123, 123).addBox(-0.5939F, 6.7865F, -1.3464F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-6.4507F, 6.8422F, -2.678F, 1.1856F, 0.2133F, 0.3679F));
		...
		PartDefinition frontRightLeg3 = frontRightLeg2.addOrReplaceChild("frontRightLeg3", CubeListBuilder.create().texOffs(118, 35).addBox(-1.0F, -0.5F, -1.6F, 4.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.2697F, 7.1544F, -0.0233F, 1.6149F, 0.2539F, -0.0563F));
		...
		PartDefinition neck = neckbase.addOrReplaceChild("neck", CubeListBuilder.create().texOffs(34, 109).addBox(-1.0F, -1.2F, -5.0F, 2.0F, 2.0F, 5.0F, new CubeDeformation(0.0F))
				.texOffs(86, 134).addBox(0.0F, -3.1F, -4.0F, 0.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 2.9792F, -9.902F, -0.0097F, -0.0798F, -0.0087F));
		...
		PartDefinition neck2 = neck.addOrReplaceChild("neck2", CubeListBuilder.create().texOffs(41, 0).addBox(-1.0F, -1.3F, -13.9F, 2.0F, 2.0F, 14.0F, new CubeDeformation(-0.204F)), PartPose.offsetAndRotation(0.0F, -0.4201F, -11.699F, -0.1209F, 0.1842F, 0.0643F));
		...
		PartDefinition neck3 = neck2.addOrReplaceChild("neck3", CubeListBuilder.create().texOffs(35, 40).addBox(-1.0F, -1.3F, -13.4F, 2.0F, 2.0F, 14.0F, new CubeDeformation(-0.2F)), PartPose.offsetAndRotation(0.0F, -0.0378F, -13.9646F, -0.1058F, 0.1397F, 0.0722F));
		...
		PartDefinition cube_r147 = neck4.addOrReplaceChild("cube_r147", CubeListBuilder.create().texOffs(35, 57).mirror().addBox(-3.2922F, -0.6235F, 0.0816F, 0.0F, 1.0F, 15.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(2.2712F, 0.2186F, -10.5141F, -0.0355F, -0.0862F, 0.0137F));

		PartDefinition cube_r148 = neck4.addOrReplaceChild("cube_r148", CubeListBuilder.create().texOffs(35, 57).addBox(3.2922F, -0.6235F, 0.0816F, 0.0F, 1.0F, 15.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-2.2712F, 0.2186F, -10.5141F, -0.0355F, 0.0862F, -0.0137F));
		...
		PartDefinition cube_r170 = neck10.addOrReplaceChild("cube_r170", CubeListBuilder.create().texOffs(19, 105).addBox(0.0F, -1.4F, -0.6F, 0.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
				.texOffs(114, 61).addBox(-1.0F, -0.7981F, -2.8F, 2.0F, 2.0F, 4.0F, new CubeDeformation(-0.204F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.2182F, 0.0F, 0.0F));

		PartDefinition cube_r171 = neck10.addOrReplaceChild("cube_r171", CubeListBuilder.create().texOffs(118, 117).mirror().addBox(-7.0713F, -0.3988F, 0.717F, 0.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(6.0974F, 1.2698F, -2.1408F, 0.0256F, -0.0862F, 0.0137F));

		PartDefinition cube_r172 = neck10.addOrReplaceChild("cube_r172", CubeListBuilder.create().texOffs(118, 117).addBox(7.0713F, -0.3988F, 0.717F, 0.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-6.0974F, 1.2698F, -2.1408F, 0.0256F, 0.0862F, -0.0137F));
		...
		PartDefinition cube_r387 = body3.addOrReplaceChild("cube_r387", CubeListBuilder.create().texOffs(81, 130).mirror().addBox(-1.0F, 1.0F, -0.1F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.001F)).mirror(false)
				...
				.texOffs(124, 14).addBox(4.0F, 0.0F, 0.0F, 2.0F, 1.0F, 2.0F, new CubeDeformation(0.001F)), PartPose.offsetAndRotation(-2.0F, -0.8252F, 2.4885F, -0.384F, 0.0F, 0.0F));

		PartDefinition cube_r388 = body3.addOrReplaceChild("cube_r388", CubeListBuilder.create().texOffs(57, 122).mirror().addBox(0.0F, -2.2271F, 0.8787F, 1.0F, 1.0F, 3.0F, new CubeDeformation(0.001F)).mirror(false), PartPose.offsetAndRotation(-3.0F, 3.4374F, 1.18F, -2.058F, 0.2069F, -0.4005F));

		PartDefinition cube_r389 = body3.addOrReplaceChild("cube_r389", CubeListBuilder.create().texOffs(31, 121).mirror().addBox(0.0F, -3.5732F, 2.4358F, 1.0F, 3.0F, 2.0F, new CubeDeformation(-0.004F)).mirror(false), PartPose.offsetAndRotation(-3.0F, 3.4374F, 1.18F, -1.6653F, 0.2069F, -0.4005F));

		PartDefinition cube_r390 = body3.addOrReplaceChild("cube_r390", CubeListBuilder.create().texOffs(127, 39).mirror().addBox(0.0F, -0.8989F, 3.5885F, 1.0F, 2.0F, 2.0F, new CubeDeformation(0.001F)).mirror(false), PartPose.offsetAndRotation(-3.0F, 3.4374F, 1.18F, -0.7926F, 0.2069F, -0.4005F));

		PartDefinition cube_r391 = body3.addOrReplaceChild("cube_r391", CubeListBuilder.create().texOffs(49, 115).mirror().addBox(0.0F, 0.4691F, 1.0934F, 1.0F, 2.0F, 4.0F, new CubeDeformation(0.005F)).mirror(false), PartPose.offsetAndRotation(-3.0F, 3.4374F, 1.18F, -0.1818F, 0.2069F, -0.4005F));
		...
		PartDefinition cube_r399 = body3.addOrReplaceChild("cube_r399", CubeListBuilder.create().texOffs(57, 127).mirror().addBox(0.0F, -1.3869F, -0.1937F, 1.0F, 2.0F, 2.0F, new CubeDeformation(0.004F)).mirror(false), PartPose.offsetAndRotation(-3.0F, 3.4374F, 1.18F, -1.0544F, 0.2069F, -0.4005F));
		...
		PartDefinition cube_r402 = body3.addOrReplaceChild("cube_r402", CubeListBuilder.create().texOffs(9, 126).mirror().addBox(-1.0F, -1.5F, -0.75F, 1.0F, 3.0F, 2.0F, new CubeDeformation(0.001F)).mirror(false)
				.texOffs(9, 126).addBox(4.0F, -1.5F, -0.75F, 1.0F, 3.0F, 2.0F, new CubeDeformation(0.001F)), PartPose.offsetAndRotation(-2.0F, 1.4374F, 0.68F, -0.9861F, 0.0F, 0.0F));
		...
		PartDefinition cube_r408 = body3.addOrReplaceChild("cube_r408", CubeListBuilder.create().texOffs(57, 127).addBox(-1.0F, -1.3869F, -0.1937F, 1.0F, 2.0F, 2.0F, new CubeDeformation(0.004F)), PartPose.offsetAndRotation(3.0F, 3.4374F, 1.18F, -1.0544F, -0.2069F, 0.4005F));
		...
		PartDefinition cube_r411 = body3.addOrReplaceChild("cube_r411", CubeListBuilder.create().texOffs(57, 122).addBox(-1.0F, -2.2271F, 0.8787F, 1.0F, 1.0F, 3.0F, new CubeDeformation(0.001F)), PartPose.offsetAndRotation(3.0F, 3.4374F, 1.18F, -2.058F, -0.2069F, 0.4005F));

		PartDefinition cube_r412 = body3.addOrReplaceChild("cube_r412", CubeListBuilder.create().texOffs(31, 121).addBox(-1.0F, -3.5732F, 2.4358F, 1.0F, 3.0F, 2.0F, new CubeDeformation(-0.004F)), PartPose.offsetAndRotation(3.0F, 3.4374F, 1.18F, -1.6653F, -0.2069F, 0.4005F));

		PartDefinition cube_r413 = body3.addOrReplaceChild("cube_r413", CubeListBuilder.create().texOffs(127, 39).addBox(-1.0F, -0.8989F, 3.5885F, 1.0F, 2.0F, 2.0F, new CubeDeformation(0.001F)), PartPose.offsetAndRotation(3.0F, 3.4374F, 1.18F, -0.7926F, -0.2069F, 0.4005F));

		PartDefinition cube_r414 = body3.addOrReplaceChild("cube_r414", CubeListBuilder.create().texOffs(49, 115).addBox(-1.0F, 0.4691F, 1.0934F, 1.0F, 2.0F, 4.0F, new CubeDeformation(0.005F)), PartPose.offsetAndRotation(3.0F, 3.4374F, 1.18F, -0.1818F, -0.2069F, 0.4005F));
		...
		PartDefinition cube_r428 = backLeftLeg2.addOrReplaceChild("cube_r428", CubeListBuilder.create().texOffs(25, 136).addBox(-0.6155F, -1.8472F, -0.5F, 1.0F, 2.0F, 1.0F, new CubeDeformation(-0.106F)), PartPose.offsetAndRotation(0.8851F, 6.7518F, 0.2285F, -1.8326F, 1.4399F, -1.7453F));
		...
		PartDefinition cube_r434 = backLeftLeg2.addOrReplaceChild("cube_r434", CubeListBuilder.create().texOffs(40, 128).addBox(-0.0677F, -2.5053F, -0.5F, 1.0F, 5.0F, 1.0F, new CubeDeformation(-0.007F)), PartPose.offsetAndRotation(-0.6102F, 2.5591F, 0.5885F, 1.6743F, 1.3495F, 1.7576F));
		...
		PartDefinition backLeftLeg3 = backLeftLeg2.addOrReplaceChild("backLeftLeg3", CubeListBuilder.create().texOffs(102, 83).addBox(-3.0987F, -0.0124F, -3.9766F, 6.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.0514F, 8.8797F, 0.7468F, 0.6304F, 0.0F, 0.0F));

		PartDefinition backLeftLeg4 = backLeftLeg3.addOrReplaceChild("backLeftLeg4", CubeListBuilder.create().texOffs(103, 21).addBox(-3.0981F, -0.496F, -2.9564F, 6.0F, 1.0F, 3.0F, new CubeDeformation(0.006F)), PartPose.offsetAndRotation(-0.0007F, 0.4836F, -3.7202F, -0.48F, 0.0F, 0.0F));

		PartDefinition backLeftLeg5 = backLeftLeg4.addOrReplaceChild("backLeftLeg5", CubeListBuilder.create().texOffs(103, 9).addBox(-3.0981F, -0.496F, -3.9564F, 6.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0005F, -2.9856F, -0.4363F, 0.0F, 0.0F));
		...
		PartDefinition cube_r445 = backRightLeg2.addOrReplaceChild("cube_r445", CubeListBuilder.create().texOffs(136, 30).addBox(-0.3845F, -1.8472F, -0.5F, 1.0F, 2.0F, 1.0F, new CubeDeformation(-0.106F)), PartPose.offsetAndRotation(-0.8851F, 6.7518F, 0.2285F, -1.8326F, -1.4399F, 1.7453F));
		...
		PartDefinition cube_r451 = backRightLeg2.addOrReplaceChild("cube_r451", CubeListBuilder.create().texOffs(71, 128).addBox(-0.9323F, -2.5053F, -0.5F, 1.0F, 5.0F, 1.0F, new CubeDeformation(-0.007F)), PartPose.offsetAndRotation(0.6102F, 2.5591F, 0.5885F, 1.6743F, -1.3495F, -1.7576F));
		...
		PartDefinition backRightLeg3 = backRightLeg2.addOrReplaceChild("backRightLeg3", CubeListBuilder.create().texOffs(102, 89).addBox(-2.9012F, -0.0124F, -3.9766F, 6.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0514F, 8.8797F, 0.7468F, 0.4122F, 0.0F, 0.0F));

		PartDefinition backRightLeg4 = backRightLeg3.addOrReplaceChild("backRightLeg4", CubeListBuilder.create().texOffs(86, 108).addBox(-2.9019F, -0.496F, -2.9564F, 6.0F, 1.0F, 3.0F, new CubeDeformation(0.006F)), PartPose.offsetAndRotation(0.0007F, 0.4836F, -3.7202F, -0.1309F, 0.0F, 0.0F));

		PartDefinition backRightLeg5 = backRightLeg4.addOrReplaceChild("backRightLeg5", CubeListBuilder.create().texOffs(103, 15).addBox(-2.9019F, -0.496F, -3.9564F, 6.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0005F, -2.9856F, 0.48F, 0.0F, 0.0F));
		...
		PartDefinition cube_r457 = tail.addOrReplaceChild("cube_r457", CubeListBuilder.create().texOffs(31, 59).addBox(-0.003F, -5.0F, 0.0F, 0.0F, 5.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 2.3075F, 9.4382F, -1.8239F, 0.0F, 0.0F));
		...
		PartDefinition tail3 = tail2.addOrReplaceChild("tail3", CubeListBuilder.create().texOffs(1, 21).addBox(-0.5F, -1.1769F, -0.2034F, 1.0F, 1.0F, 17.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -0.6901F, 11.0216F, 0.0222F, -0.2181F, -0.0048F));
		...
		PartDefinition tail4 = tail3.addOrReplaceChild("tail4", CubeListBuilder.create().texOffs(40, 21).addBox(-0.5F, -0.4382F, 0.0697F, 1.0F, 1.0F, 17.0F, new CubeDeformation(-0.004F)), PartPose.offsetAndRotation(0.0F, -0.7057F, 16.6901F, 0.1371F, -0.3894F, -0.0523F));

		PartDefinition tail5 = tail4.addOrReplaceChild("tail5", CubeListBuilder.create().texOffs(0, 0).addBox(-0.5F, -0.3328F, -0.0141F, 1.0F, 1.0F, 19.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -0.072F, 16.9386F, 0.2182F, 0.4702F, 0.1001F));
