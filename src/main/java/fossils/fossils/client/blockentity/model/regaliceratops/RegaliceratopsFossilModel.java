...
public class RegaliceratopsFossilModel extends SkullModelBase {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition cube_r1 = hips.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(53, 22).addBox(0.0F, 0.036F, -5.0471F, 0.0F, 3.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -3.5808F, 0.98F, 0.0524F, 0.0F, 0.0F));

		PartDefinition cube_r2 = hips.addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(0, 51).addBox(0.0F, 0.6662F, 4.0484F, 0.0F, 3.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -4.9808F, -2.92F, -0.192F, 0.0F, 0.0F));
		...
		PartDefinition cube_r80 = body.addOrReplaceChild("cube_r80", CubeListBuilder.create().texOffs(34, 106).addBox(0.0F, -2.8352F, -1.946F, 0.0F, 3.0F, 1.0F, new CubeDeformation(0.0F))
				.texOffs(31, 106).addBox(0.0F, -2.5512F, -3.8254F, 0.0F, 3.0F, 1.0F, new CubeDeformation(0.0F))
				.texOffs(69, 100).addBox(0.0F, -2.3854F, -5.7314F, 0.0F, 4.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.3064F, 0.784F, -0.3054F, 0.0F, 0.0F));
		...
		PartDefinition cube_r82 = body.addOrReplaceChild("cube_r82", CubeListBuilder.create().texOffs(5, 100).addBox(0.0F, -3.5582F, -1.3699F, 0.0F, 4.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -0.5936F, -9.516F, -0.1658F, 0.0F, 0.0F));

		PartDefinition cube_r83 = body.addOrReplaceChild("cube_r83", CubeListBuilder.create().texOffs(35, 56).addBox(0.0F, -3.0253F, -1.911F, 0.0F, 4.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -0.9936F, -6.816F, -0.2356F, 0.0F, 0.0F));
		...
		PartDefinition cube_r126 = chest.addOrReplaceChild("cube_r126", CubeListBuilder.create().texOffs(8, 100).addBox(0.0F, -3.7377F, -0.9685F, 0.0F, 4.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.147F, -3.119F, 0.1571F, 0.0F, 0.0F));

		PartDefinition cube_r127 = chest.addOrReplaceChild("cube_r127", CubeListBuilder.create().texOffs(32, 92).addBox(0.0F, -3.9739F, -1.101F, 0.0F, 5.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -0.853F, -1.219F, 0.0873F, 0.0F, 0.0F));

		PartDefinition cube_r128 = chest.addOrReplaceChild("cube_r128", CubeListBuilder.create().texOffs(99, 105).addBox(0.0F, -2.7359F, -1.1327F, 0.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 1.247F, -4.719F, 0.1745F, 0.0F, 0.0F));
		...
		PartDefinition cube_r178 = lefthand.addOrReplaceChild("cube_r178", CubeListBuilder.create().texOffs(25, 8).addBox(-1.5205F, -0.294F, -2.8905F, 3.0F, 1.0F, 3.0F, new CubeDeformation(0.002F)), PartPose.offsetAndRotation(-0.5013F, 0.5347F, -1.2899F, -1.1382F, 0.0511F, -0.1759F));

		PartDefinition cube_r179 = lefthand.addOrReplaceChild("cube_r179", CubeListBuilder.create().texOffs(74, 87).addBox(0.0983F, -0.2372F, -2.3475F, 2.0F, 1.0F, 2.0F, new CubeDeformation(0.002F)), PartPose.offsetAndRotation(-0.5013F, 0.5347F, -1.2899F, -0.9763F, -0.3374F, 0.2997F));
		...
		PartDefinition cube_r188 = righthand.addOrReplaceChild("cube_r188", CubeListBuilder.create().texOffs(61, 63).addBox(-1.4795F, -0.294F, -2.8905F, 3.0F, 1.0F, 3.0F, new CubeDeformation(0.002F)), PartPose.offsetAndRotation(0.5013F, 0.5347F, -1.2899F, -1.1382F, -0.0511F, 0.1759F));

		PartDefinition cube_r189 = righthand.addOrReplaceChild("cube_r189", CubeListBuilder.create().texOffs(83, 87).addBox(-2.0983F, -0.2372F, -2.3475F, 2.0F, 1.0F, 2.0F, new CubeDeformation(0.002F)), PartPose.offsetAndRotation(0.5013F, 0.5347F, -1.2899F, -0.9763F, 0.3374F, -0.2997F));
		...
		PartDefinition cube_r191 = neck2.addOrReplaceChild("cube_r191", CubeListBuilder.create().texOffs(77, 106).addBox(0.0F, -1.9703F, -0.1461F, 0.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -0.8216F, -0.9034F, 0.0262F, 0.0F, 0.0F));

		PartDefinition cube_r192 = neck2.addOrReplaceChild("cube_r192", CubeListBuilder.create().texOffs(105, 106).addBox(0.0F, -2.4F, -2.3F, 0.0F, 2.0F, 1.0F, new CubeDeformation(0.0F))
				.texOffs(73, 38).addBox(-1.0F, -1.1F, -2.3F, 2.0F, 2.0F, 3.0F, new CubeDeformation(0.004F)), PartPose.offsetAndRotation(0.0F, 0.2784F, -0.6034F, 0.1309F, 0.0F, 0.0F));
		...
		PartDefinition cube_r203 = neck.addOrReplaceChild("cube_r203", CubeListBuilder.create().texOffs(95, 29).addBox(0.0F, -3.4F, -2.7F, 0.0F, 2.0F, 2.0F, new CubeDeformation(0.0F))
		...
		PartDefinition cube_r204 = neck.addOrReplaceChild("cube_r204", CubeListBuilder.create().texOffs(107, 23).mirror().addBox(-1.7792F, 0.2788F, 0.0614F, 1.0F, 0.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-1.0F, -0.0844F, -2.7754F, 0.3928F, 0.8184F, -1.059F));

		PartDefinition cube_r205 = neck.addOrReplaceChild("cube_r205", CubeListBuilder.create().texOffs(107, 23).addBox(0.7792F, 0.2788F, 0.0614F, 1.0F, 0.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.0F, -0.0844F, -2.7754F, 0.3928F, -0.8184F, 1.059F));
		...
		PartDefinition cube_r206 = head.addOrReplaceChild("cube_r206", CubeListBuilder.create().texOffs(34, 41).addBox(-1.5F, -3.1045F, 0.0552F, 3.0F, 4.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -4.3381F, -1.8894F, -1.1519F, 0.0F, 0.0F));

		PartDefinition cube_r207 = head.addOrReplaceChild("cube_r207", CubeListBuilder.create().texOffs(35, 96).addBox(-1.0F, -1.067F, 1.0406F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.003F))
				.texOffs(85, 46).addBox(-1.0F, -6.067F, 5.0406F, 2.0F, 5.0F, 1.0F, new CubeDeformation(0.003F))
		...
		PartDefinition cube_r208 = head.addOrReplaceChild("cube_r208", CubeListBuilder.create().texOffs(31, 65).addBox(-1.0F, -1.2F, -0.3F, 2.0F, 3.0F, 3.0F, new CubeDeformation(0.007F)), PartPose.offsetAndRotation(0.0F, 0.1821F, -3.8631F, -1.4312F, 0.0F, 0.0F));

		PartDefinition cube_r209 = head.addOrReplaceChild("cube_r209", CubeListBuilder.create().texOffs(17, 97).addBox(-0.5F, -0.6082F, -0.1995F, 1.0F, 3.0F, 1.0F, new CubeDeformation(-0.2F)), PartPose.offsetAndRotation(0.0F, 0.0272F, -9.2972F, -2.1206F, 0.0F, 0.0F));

		PartDefinition cube_r210 = head.addOrReplaceChild("cube_r210", CubeListBuilder.create().texOffs(101, 49).addBox(-0.5F, 0.4409F, -0.9444F, 1.0F, 2.0F, 1.0F, new CubeDeformation(-0.21F)), PartPose.offsetAndRotation(0.0F, 0.0272F, -9.2972F, -1.7802F, 0.0F, 0.0F));

		PartDefinition cube_r211 = head.addOrReplaceChild("cube_r211", CubeListBuilder.create().texOffs(96, 91).addBox(-1.0F, -2.7475F, -0.387F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.005F))
		...
		PartDefinition cube_r212 = head.addOrReplaceChild("cube_r212", CubeListBuilder.create().texOffs(21, 102).addBox(-0.5F, -0.4F, 0.3F, 1.0F, 2.0F, 1.0F, new CubeDeformation(-0.148F)), PartPose.offsetAndRotation(0.0F, 4.0879F, -8.1834F, 2.9496F, 0.0F, 0.0F));

		PartDefinition cube_r213 = head.addOrReplaceChild("cube_r213", CubeListBuilder.create().texOffs(101, 34).addBox(-0.5F, -1.29F, -0.3514F, 1.0F, 2.0F, 1.0F, new CubeDeformation(-0.15F))
		...
		PartDefinition cube_r214 = head.addOrReplaceChild("cube_r214", CubeListBuilder.create().texOffs(94, 52).addBox(-0.5F, -0.3F, -1.3F, 1.0F, 1.0F, 2.0F, new CubeDeformation(-0.153F)), PartPose.offsetAndRotation(0.0F, 3.0114F, -6.8501F, 0.8378F, 0.0F, 0.0F));

		PartDefinition cube_r215 = head.addOrReplaceChild("cube_r215", CubeListBuilder.create().texOffs(32, 99).addBox(-0.5F, -0.0242F, -0.9052F, 1.0F, 2.0F, 1.0F, new CubeDeformation(-0.149F)), PartPose.offsetAndRotation(0.0F, 2.1471F, -7.0208F, -0.0175F, 0.0F, 0.0F));

		PartDefinition cube_r216 = head.addOrReplaceChild("cube_r216", CubeListBuilder.create().texOffs(16, 102).addBox(-0.5F, -1.3F, -0.5F, 1.0F, 2.0F, 1.0F, new CubeDeformation(-0.15F)), PartPose.offsetAndRotation(0.0F, 2.3471F, -7.7208F, 1.0821F, 0.0F, 0.0F));

		PartDefinition cube_r217 = head.addOrReplaceChild("cube_r217", CubeListBuilder.create().texOffs(62, 102).addBox(-0.5F, -1.0F, 0.0F, 1.0F, 2.0F, 1.0F, new CubeDeformation(-0.156F)), PartPose.offsetAndRotation(0.0F, 3.9515F, -8.8549F, 0.6981F, 0.0F, 0.0F));

		PartDefinition cube_r218 = head.addOrReplaceChild("cube_r218", CubeListBuilder.create().texOffs(18, 92).addBox(-1.0F, -0.2553F, -0.8673F, 2.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -0.4F, -6.5577F, 2.0769F, 0.0F, 0.0F));

		PartDefinition cube_r219 = head.addOrReplaceChild("cube_r219", CubeListBuilder.create().texOffs(92, 45).addBox(-1.0F, -0.0555F, -0.9935F, 2.0F, 3.0F, 1.0F, new CubeDeformation(-0.005F)), PartPose.offsetAndRotation(0.0F, -0.4F, -8.0577F, 1.5882F, 0.0F, 0.0F));

		PartDefinition cube_r220 = head.addOrReplaceChild("cube_r220", CubeListBuilder.create().texOffs(20, 75).addBox(-1.0F, 0.0112F, -2.0835F, 2.0F, 4.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -2.8F, -5.1577F, 1.4661F, 0.0F, 0.0F));

		PartDefinition cube_r221 = head.addOrReplaceChild("cube_r221", CubeListBuilder.create().texOffs(19, 40).addBox(-2.5F, -0.0499F, 0.0749F, 4.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.5F, -2.7F, -5.2577F, 0.4014F, 0.0F, 0.0F));

		PartDefinition cube_r222 = head.addOrReplaceChild("cube_r222", CubeListBuilder.create().texOffs(38, 15).addBox(-3.0F, -7.0F, 3.1F, 5.0F, 5.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.5F, 4.0F, -2.6577F, 0.4712F, 0.0F, 0.0F));
		...
		PartDefinition cube_r223 = leftCheek.addOrReplaceChild("cube_r223", CubeListBuilder.create().texOffs(94, 35).addBox(-0.9819F, -0.9936F, -0.2482F, 1.0F, 1.0F, 2.0F, new CubeDeformation(-0.004F)), PartPose.offsetAndRotation(0.526F, -0.0982F, 1.037F, 0.1697F, 0.5226F, 0.3068F));

		PartDefinition cube_r224 = leftCheek.addOrReplaceChild("cube_r224", CubeListBuilder.create().texOffs(0, 94).addBox(-0.3F, -0.5F, -1.0F, 1.0F, 1.0F, 2.0F, new CubeDeformation(-0.1F)), PartPose.offsetAndRotation(1.0794F, -0.643F, 2.6329F, 1.2607F, 0.6667F, 0.6922F));

		PartDefinition cube_r225 = leftCheek.addOrReplaceChild("cube_r225", CubeListBuilder.create().texOffs(89, 105).addBox(-0.9904F, 0.4948F, -0.1481F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.526F, -0.0982F, 1.037F, 1.0249F, 0.5273F, 0.3021F));

		PartDefinition cube_r226 = leftCheek.addOrReplaceChild("cube_r226", CubeListBuilder.create().texOffs(73, 19).addBox(-1.0768F, -0.9559F, -3.9054F, 1.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.4404F, 3.4975F, 1.5167F, 2.7296F, 0.0388F, 0.4061F));

		PartDefinition cube_r227 = leftCheek.addOrReplaceChild("cube_r227", CubeListBuilder.create().texOffs(77, 31).addBox(-0.708F, -0.7857F, -2.6134F, 1.0F, 2.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.074F, 0.3018F, 0.437F, 1.3264F, 0.3292F, 0.2883F));

		PartDefinition cube_r228 = leftCheek.addOrReplaceChild("cube_r228", CubeListBuilder.create().texOffs(89, 91).addBox(-0.9904F, -0.6342F, -1.3545F, 1.0F, 2.0F, 2.0F, new CubeDeformation(0.004F)), PartPose.offsetAndRotation(0.526F, -0.0982F, 1.037F, 0.4838F, 0.5273F, 0.3021F));

		PartDefinition cube_r229 = leftCheek.addOrReplaceChild("cube_r229", CubeListBuilder.create().texOffs(37, 99).addBox(-0.7553F, -1.3603F, -0.1349F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.074F, 0.3018F, 0.437F, 0.3057F, 0.3555F, 0.283F));
		...
		PartDefinition cube_r230 = rightCheek.addOrReplaceChild("cube_r230", CubeListBuilder.create().texOffs(94, 35).mirror().addBox(-0.0181F, -0.9936F, -0.2482F, 1.0F, 1.0F, 2.0F, new CubeDeformation(-0.004F)).mirror(false), PartPose.offsetAndRotation(-0.526F, -0.0982F, 1.037F, 0.1697F, -0.5226F, -0.3068F));

		PartDefinition cube_r231 = rightCheek.addOrReplaceChild("cube_r231", CubeListBuilder.create().texOffs(0, 94).mirror().addBox(-0.7F, -0.5F, -1.0F, 1.0F, 1.0F, 2.0F, new CubeDeformation(-0.1F)).mirror(false), PartPose.offsetAndRotation(-1.0794F, -0.643F, 2.6329F, 1.2607F, -0.6667F, -0.6922F));

		PartDefinition cube_r232 = rightCheek.addOrReplaceChild("cube_r232", CubeListBuilder.create().texOffs(89, 105).mirror().addBox(-0.0096F, 0.4948F, -0.1481F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-0.526F, -0.0982F, 1.037F, 1.0249F, -0.5273F, -0.3021F));

		PartDefinition cube_r233 = rightCheek.addOrReplaceChild("cube_r233", CubeListBuilder.create().texOffs(73, 19).mirror().addBox(0.0768F, -0.9559F, -3.9054F, 1.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(0.4404F, 3.4975F, 1.5167F, 2.7296F, -0.0388F, -0.4061F));

		PartDefinition cube_r234 = rightCheek.addOrReplaceChild("cube_r234", CubeListBuilder.create().texOffs(77, 31).mirror().addBox(-0.292F, -0.7857F, -2.6134F, 1.0F, 2.0F, 3.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(0.074F, 0.3018F, 0.437F, 1.3264F, -0.3292F, -0.2883F));

		PartDefinition cube_r235 = rightCheek.addOrReplaceChild("cube_r235", CubeListBuilder.create().texOffs(89, 91).mirror().addBox(-0.0096F, -0.6342F, -1.3545F, 1.0F, 2.0F, 2.0F, new CubeDeformation(0.004F)).mirror(false), PartPose.offsetAndRotation(-0.526F, -0.0982F, 1.037F, 0.4838F, -0.5273F, -0.3021F));

		PartDefinition cube_r236 = rightCheek.addOrReplaceChild("cube_r236", CubeListBuilder.create().texOffs(37, 99).mirror().addBox(-0.2447F, -1.3603F, -0.1349F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(0.074F, 0.3018F, 0.437F, 0.3057F, -0.3555F, -0.283F));
		...
		PartDefinition cube_r237 = leftBeak.addOrReplaceChild("cube_r237", CubeListBuilder.create().texOffs(67, 106).addBox(-0.36F, -1.0234F, -1.2071F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.004F))
		...
		PartDefinition cube_r238 = leftBeak.addOrReplaceChild("cube_r238", CubeListBuilder.create().texOffs(106, 57).addBox(-0.4152F, -1.0094F, -1.0254F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.3875F, -0.2788F, -1.4408F, -1.3825F, 0.0699F, 0.0695F));

		PartDefinition cube_r239 = leftBeak.addOrReplaceChild("cube_r239", CubeListBuilder.create().texOffs(37, 106).addBox(-0.5072F, -0.0687F, -0.0268F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.004F)), PartPose.offsetAndRotation(-0.064F, -3.1915F, -0.9019F, -0.5971F, 0.0699F, 0.0695F));

		PartDefinition cube_r240 = leftBeak.addOrReplaceChild("cube_r240", CubeListBuilder.create().texOffs(57, 106).addBox(-1.2852F, -0.9706F, -0.0906F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.007F)), PartPose.offsetAndRotation(0.5704F, -0.1934F, -0.0304F, 1.061F, 0.0699F, 0.0695F));

		PartDefinition cube_r241 = leftBeak.addOrReplaceChild("cube_r241", CubeListBuilder.create().texOffs(106, 40).addBox(-1.3697F, 1.0628F, -0.0522F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.5704F, -1.0934F, -2.1304F, 0.6945F, 0.0699F, 0.0695F));
		...
		PartDefinition cube_r242 = rightBeak.addOrReplaceChild("cube_r242", CubeListBuilder.create().texOffs(67, 106).mirror().addBox(-0.64F, -1.0234F, -1.2071F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.004F)).mirror(false)
		...
		PartDefinition cube_r243 = rightBeak.addOrReplaceChild("cube_r243", CubeListBuilder.create().texOffs(106, 57).mirror().addBox(-0.5848F, -1.0094F, -1.0254F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(0.3875F, -0.2788F, -1.4408F, -1.3825F, -0.0699F, -0.0695F));

		PartDefinition cube_r244 = rightBeak.addOrReplaceChild("cube_r244", CubeListBuilder.create().texOffs(37, 106).mirror().addBox(-0.4928F, -0.0687F, -0.0268F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.004F)).mirror(false), PartPose.offsetAndRotation(0.064F, -3.1915F, -0.9019F, -0.5971F, -0.0699F, -0.0695F));

		PartDefinition cube_r245 = rightBeak.addOrReplaceChild("cube_r245", CubeListBuilder.create().texOffs(57, 106).mirror().addBox(0.2852F, -0.9706F, -0.0906F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.007F)).mirror(false), PartPose.offsetAndRotation(-0.5704F, -0.1934F, -0.0304F, 1.061F, -0.0699F, -0.0695F));

		PartDefinition cube_r246 = rightBeak.addOrReplaceChild("cube_r246", CubeListBuilder.create().texOffs(106, 40).mirror().addBox(0.3697F, 1.0628F, -0.0522F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-0.5704F, -1.0934F, -2.1304F, 0.6945F, -0.0699F, -0.0695F));

		PartDefinition leftFace = head.addOrReplaceChild("leftFace", CubeListBuilder.create(), PartPose.offset(1.3F, 5.3588F, -5.5918F));

		PartDefinition cube_r247 = leftFace.addOrReplaceChild("cube_r247", CubeListBuilder.create().texOffs(47, 48).addBox(-2.2219F, -0.1039F, -3.866F, 2.0F, 2.0F, 4.0F, new CubeDeformation(0.004F)), PartPose.offsetAndRotation(1.3F, -7.2F, 3.4F, 0.4028F, 0.3035F, 0.1239F));

		PartDefinition cube_r248 = leftFace.addOrReplaceChild("cube_r248", CubeListBuilder.create().texOffs(21, 106).addBox(-0.5F, -0.5F, -1.3F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.004F)), PartPose.offsetAndRotation(0.0359F, -9.1788F, 1.47F, 0.7324F, -0.0524F, 0.0F));

		PartDefinition cube_r249 = leftFace.addOrReplaceChild("cube_r249", CubeListBuilder.create().texOffs(52, 106).addBox(-0.5F, -1.2F, -0.4728F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.2F))
				.texOffs(106, 51).addBox(-0.5F, -0.6F, -0.4728F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.2F)), PartPose.offsetAndRotation(0.1654F, -9.3995F, -1.0003F, 1.7098F, -0.0524F, 0.0F));

		PartDefinition cube_r250 = leftFace.addOrReplaceChild("cube_r250", CubeListBuilder.create().texOffs(101, 77).addBox(-0.3692F, -1.1272F, -0.1802F, 1.0F, 2.0F, 1.0F, new CubeDeformation(-0.199F)), PartPose.offsetAndRotation(0.0359F, -8.9788F, -1.03F, 1.6051F, -0.0524F, 0.0F));

		PartDefinition cube_r251 = leftFace.addOrReplaceChild("cube_r251", CubeListBuilder.create().texOffs(101, 57).addBox(-0.3796F, -0.1623F, -0.6175F, 1.0F, 2.0F, 1.0F, new CubeDeformation(-0.099F)), PartPose.offsetAndRotation(0.0359F, -9.4788F, -0.83F, 1.256F, -0.0524F, 0.0F));

		PartDefinition cube_r252 = leftFace.addOrReplaceChild("cube_r252", CubeListBuilder.create().texOffs(100, 16).addBox(-0.4738F, -1.9323F, -0.9307F, 1.0F, 2.0F, 1.0F, new CubeDeformation(-0.1F)), PartPose.offsetAndRotation(0.0359F, -9.4788F, 0.97F, 1.3957F, -0.0524F, 0.0F));

		PartDefinition cube_r253 = leftFace.addOrReplaceChild("cube_r253", CubeListBuilder.create().texOffs(100, 12).addBox(-0.5F, -0.6F, -0.9F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0359F, -9.1788F, 1.47F, 1.256F, -0.0524F, 0.0F));

		PartDefinition cube_r254 = leftFace.addOrReplaceChild("cube_r254", CubeListBuilder.create().texOffs(5, 106).addBox(-0.5455F, -1.3057F, -0.8519F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.004F)), PartPose.offsetAndRotation(0.2683F, -7.2838F, 1.7222F, 0.2088F, -0.0524F, 0.0F));

		PartDefinition cube_r255 = leftFace.addOrReplaceChild("cube_r255", CubeListBuilder.create().texOffs(93, 17).addBox(-0.5455F, -1.2891F, -1.21F, 1.0F, 1.0F, 2.0F, new CubeDeformation(-0.004F)), PartPose.offsetAndRotation(0.2683F, -7.2838F, 1.7222F, 2.5476F, -0.0524F, 0.0F));

		PartDefinition cube_r256 = leftFace.addOrReplaceChild("cube_r256", CubeListBuilder.create().texOffs(16, 106).addBox(-0.5455F, -1.5142F, -0.0122F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.004F)), PartPose.offsetAndRotation(0.2683F, -7.2838F, 1.7222F, 1.9716F, -0.0524F, 0.0F));

		PartDefinition cube_r257 = leftFace.addOrReplaceChild("cube_r257", CubeListBuilder.create().texOffs(0, 106).addBox(-0.5455F, -1.5625F, -0.8605F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.004F)), PartPose.offsetAndRotation(0.2683F, -7.2838F, 1.7222F, 0.8721F, -0.0524F, 0.0F));

		PartDefinition cube_r258 = leftFace.addOrReplaceChild("cube_r258", CubeListBuilder.create().texOffs(84, 25).addBox(-1.37F, -1.15F, -1.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(-0.15F))
				.texOffs(0, 74).addBox(-1.73F, -1.15F, -1.0F, 3.0F, 2.0F, 2.0F, new CubeDeformation(-0.7F))
				.texOffs(84, 15).addBox(-1.06F, -1.15F, -1.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(-0.4F)), PartPose.offsetAndRotation(0.2683F, -7.2838F, 1.7222F, 0.4014F, -0.0524F, 0.0F));

		PartDefinition cube_r259 = leftFace.addOrReplaceChild("cube_r259", CubeListBuilder.create().texOffs(74, 81).addBox(-0.2428F, -0.5511F, 0.292F, 0.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.3627F, -1.1067F, -0.3648F, 0.4191F, 0.0868F, -0.0146F));

		PartDefinition cube_r260 = leftFace.addOrReplaceChild("cube_r260", CubeListBuilder.create().texOffs(105, 10).addBox(-0.5028F, -0.9831F, -0.7642F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.8101F, -1.3242F, -0.7639F, 1.9895F, 0.0337F, -0.009F));

		PartDefinition cube_r261 = leftFace.addOrReplaceChild("cube_r261", CubeListBuilder.create().texOffs(62, 106).addBox(-0.4899F, -0.1552F, -0.5795F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.006F))
		...
		PartDefinition cube_r262 = leftFace.addOrReplaceChild("cube_r262", CubeListBuilder.create().texOffs(42, 102).addBox(-0.5114F, -1.6577F, -0.4505F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.004F)), PartPose.offsetAndRotation(-1.2109F, -5.2855F, -2.835F, 1.3258F, 0.0408F, -0.0077F));

		PartDefinition cube_r263 = leftFace.addOrReplaceChild("cube_r263", CubeListBuilder.create().texOffs(89, 101).addBox(-0.5114F, -1.2547F, -1.264F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.008F)), PartPose.offsetAndRotation(-1.2109F, -5.2855F, -2.835F, 0.7499F, 0.0408F, -0.0077F));

		PartDefinition cube_r264 = leftFace.addOrReplaceChild("cube_r264", CubeListBuilder.create().texOffs(100, 8).addBox(-0.9F, -3.8609F, 0.5179F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.4F, -0.2F, 0.7F, 1.8239F, 0.0175F, -0.0006F));

		PartDefinition cube_r265 = leftFace.addOrReplaceChild("cube_r265", CubeListBuilder.create().texOffs(72, 106).addBox(-0.5F, -0.6F, -0.4F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.005F)), PartPose.offsetAndRotation(-0.9221F, -0.2322F, -3.3852F, 1.2723F, 0.0187F, -0.1968F));

		PartDefinition cube_r266 = leftFace.addOrReplaceChild("cube_r266", CubeListBuilder.create().texOffs(26, 102).addBox(-1.0248F, -0.2643F, -0.9497F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.7335F, -1.9734F, -3.3621F, 0.1378F, 0.0187F, -0.1968F));

		PartDefinition cube_r267 = leftFace.addOrReplaceChild("cube_r267", CubeListBuilder.create().texOffs(93, 25).addBox(-1.1051F, -1.3365F, 3.5763F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.003F)), PartPose.offsetAndRotation(-0.3627F, -1.1067F, -0.3648F, 0.279F, 0.0868F, 0.0146F));

		PartDefinition cube_r268 = leftFace.addOrReplaceChild("cube_r268", CubeListBuilder.create().texOffs(31, 72).addBox(-1.1051F, -0.791F, -0.0983F, 1.0F, 1.0F, 4.0F, new CubeDeformation(-0.003F)), PartPose.offsetAndRotation(-0.3627F, -1.1067F, -0.3648F, 0.4361F, 0.0868F, 0.0146F));

		PartDefinition cube_r269 = leftFace.addOrReplaceChild("cube_r269", CubeListBuilder.create().texOffs(47, 102).addBox(-0.7F, -0.7F, -0.5F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.005F)), PartPose.offsetAndRotation(-0.8F, -3.9436F, -2.5917F, -0.4607F, 0.1874F, 0.2963F));

		PartDefinition cube_r270 = leftFace.addOrReplaceChild("cube_r270", CubeListBuilder.create().texOffs(57, 102).addBox(-1.0F, -0.0222F, -0.0677F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.006F)), PartPose.offsetAndRotation(-0.3F, -5.2588F, -3.5659F, 0.034F, -0.0079F, 0.2268F));

		PartDefinition cube_r271 = leftFace.addOrReplaceChild("cube_r271", CubeListBuilder.create().texOffs(86, 68).addBox(1.3F, -8.767F, 4.6406F, 1.0F, 1.0F, 3.0F, new CubeDeformation(0.003F)), PartPose.offsetAndRotation(-1.3F, -6.1588F, -3.9659F, -1.0821F, 0.0F, 0.0F));

		PartDefinition cube_r272 = leftFace.addOrReplaceChild("cube_r272", CubeListBuilder.create().texOffs(66, 31).addBox(-1.1906F, -0.4483F, 0.0051F, 1.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.3F, -8.8497F, 3.8393F, -0.0933F, 0.1585F, 0.0093F));

		PartDefinition cube_r273 = leftFace.addOrReplaceChild("cube_r273", CubeListBuilder.create().texOffs(11, 54).addBox(-0.8752F, -0.0886F, -0.0391F, 1.0F, 3.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.3F, -9.8497F, 6.4393F, -0.5227F, 0.7114F, -0.4319F));

		PartDefinition cube_r274 = leftFace.addOrReplaceChild("cube_r274", CubeListBuilder.create().texOffs(62, 74).addBox(-2.0736F, -0.8217F, 0.0997F, 2.0F, 1.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.3F, -8.8497F, 3.8393F, 0.0819F, 0.1401F, -0.2066F));

		PartDefinition rightFace = head.addOrReplaceChild("rightFace", CubeListBuilder.create(), PartPose.offset(-1.3F, 5.3588F, -5.5918F));

		PartDefinition cube_r275 = rightFace.addOrReplaceChild("cube_r275", CubeListBuilder.create().texOffs(47, 48).mirror().addBox(0.2219F, -0.1039F, -3.866F, 2.0F, 2.0F, 4.0F, new CubeDeformation(0.004F)).mirror(false), PartPose.offsetAndRotation(-1.3F, -7.2F, 3.4F, 0.4028F, -0.3035F, -0.1239F));

		PartDefinition cube_r276 = rightFace.addOrReplaceChild("cube_r276", CubeListBuilder.create().texOffs(21, 106).mirror().addBox(-0.5F, -0.5F, -1.3F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.004F)).mirror(false), PartPose.offsetAndRotation(-0.0359F, -9.1788F, 1.47F, 0.7324F, 0.0524F, 0.0F));

		PartDefinition cube_r277 = rightFace.addOrReplaceChild("cube_r277", CubeListBuilder.create().texOffs(52, 106).mirror().addBox(-0.5F, -1.2F, -0.4728F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.2F)).mirror(false)
				.texOffs(106, 51).mirror().addBox(-0.5F, -0.6F, -0.4728F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.2F)).mirror(false), PartPose.offsetAndRotation(-0.1654F, -9.3995F, -1.0003F, 1.7098F, 0.0524F, 0.0F));

		PartDefinition cube_r278 = rightFace.addOrReplaceChild("cube_r278", CubeListBuilder.create().texOffs(101, 77).mirror().addBox(-0.6308F, -1.1272F, -0.1802F, 1.0F, 2.0F, 1.0F, new CubeDeformation(-0.199F)).mirror(false), PartPose.offsetAndRotation(-0.0359F, -8.9788F, -1.03F, 1.6051F, 0.0524F, 0.0F));

		PartDefinition cube_r279 = rightFace.addOrReplaceChild("cube_r279", CubeListBuilder.create().texOffs(101, 57).mirror().addBox(-0.6204F, -0.1623F, -0.6175F, 1.0F, 2.0F, 1.0F, new CubeDeformation(-0.099F)).mirror(false), PartPose.offsetAndRotation(-0.0359F, -9.4788F, -0.83F, 1.256F, 0.0524F, 0.0F));

		PartDefinition cube_r280 = rightFace.addOrReplaceChild("cube_r280", CubeListBuilder.create().texOffs(100, 16).mirror().addBox(-0.5262F, -1.9323F, -0.9307F, 1.0F, 2.0F, 1.0F, new CubeDeformation(-0.1F)).mirror(false), PartPose.offsetAndRotation(-0.0359F, -9.4788F, 0.97F, 1.3957F, 0.0524F, 0.0F));

		PartDefinition cube_r281 = rightFace.addOrReplaceChild("cube_r281", CubeListBuilder.create().texOffs(100, 12).mirror().addBox(-0.5F, -0.6F, -0.9F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-0.0359F, -9.1788F, 1.47F, 1.256F, 0.0524F, 0.0F));

		PartDefinition cube_r282 = rightFace.addOrReplaceChild("cube_r282", CubeListBuilder.create().texOffs(5, 106).mirror().addBox(-0.4545F, -1.3057F, -0.8519F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.004F)).mirror(false), PartPose.offsetAndRotation(-0.2683F, -7.2838F, 1.7222F, 0.2088F, 0.0524F, 0.0F));

		PartDefinition cube_r283 = rightFace.addOrReplaceChild("cube_r283", CubeListBuilder.create().texOffs(93, 17).mirror().addBox(-0.4545F, -1.2891F, -1.21F, 1.0F, 1.0F, 2.0F, new CubeDeformation(-0.004F)).mirror(false), PartPose.offsetAndRotation(-0.2683F, -7.2838F, 1.7222F, 2.5476F, 0.0524F, 0.0F));

		PartDefinition cube_r284 = rightFace.addOrReplaceChild("cube_r284", CubeListBuilder.create().texOffs(16, 106).mirror().addBox(-0.4545F, -1.5142F, -0.0122F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.004F)).mirror(false), PartPose.offsetAndRotation(-0.2683F, -7.2838F, 1.7222F, 1.9716F, 0.0524F, 0.0F));

		PartDefinition cube_r285 = rightFace.addOrReplaceChild("cube_r285", CubeListBuilder.create().texOffs(0, 106).mirror().addBox(-0.4545F, -1.5625F, -0.8605F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.004F)).mirror(false), PartPose.offsetAndRotation(-0.2683F, -7.2838F, 1.7222F, 0.8721F, 0.0524F, 0.0F));

		PartDefinition cube_r286 = rightFace.addOrReplaceChild("cube_r286", CubeListBuilder.create().texOffs(84, 25).mirror().addBox(-0.63F, -1.15F, -1.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(-0.15F)).mirror(false)
				.texOffs(0, 74).mirror().addBox(-1.27F, -1.15F, -1.0F, 3.0F, 2.0F, 2.0F, new CubeDeformation(-0.7F)).mirror(false)
				.texOffs(84, 15).mirror().addBox(-0.94F, -1.15F, -1.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(-0.4F)).mirror(false), PartPose.offsetAndRotation(-0.2683F, -7.2838F, 1.7222F, 0.4014F, 0.0524F, 0.0F));

		PartDefinition cube_r287 = rightFace.addOrReplaceChild("cube_r287", CubeListBuilder.create().texOffs(74, 81).mirror().addBox(0.2428F, -0.5511F, 0.292F, 0.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(0.3627F, -1.1067F, -0.3648F, 0.4191F, -0.0868F, 0.0146F));

		PartDefinition cube_r288 = rightFace.addOrReplaceChild("cube_r288", CubeListBuilder.create().texOffs(105, 10).mirror().addBox(-0.4972F, -0.9831F, -0.7642F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(0.8101F, -1.3242F, -0.7639F, 1.9895F, -0.0337F, 0.009F));

		PartDefinition cube_r289 = rightFace.addOrReplaceChild("cube_r289", CubeListBuilder.create().texOffs(62, 106).mirror().addBox(-0.5101F, -0.1552F, -0.5795F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.006F)).mirror(false)
		...
		PartDefinition cube_r290 = rightFace.addOrReplaceChild("cube_r290", CubeListBuilder.create().texOffs(42, 102).mirror().addBox(-0.4886F, -1.6577F, -0.4505F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.004F)).mirror(false), PartPose.offsetAndRotation(1.2109F, -5.2855F, -2.835F, 1.3258F, -0.0408F, 0.0077F));

		PartDefinition cube_r291 = rightFace.addOrReplaceChild("cube_r291", CubeListBuilder.create().texOffs(89, 101).mirror().addBox(-0.4886F, -1.2547F, -1.264F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.008F)).mirror(false), PartPose.offsetAndRotation(1.2109F, -5.2855F, -2.835F, 0.7499F, -0.0408F, 0.0077F));

		PartDefinition cube_r292 = rightFace.addOrReplaceChild("cube_r292", CubeListBuilder.create().texOffs(100, 8).mirror().addBox(-0.1F, -3.8609F, 0.5179F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(0.4F, -0.2F, 0.7F, 1.8239F, -0.0175F, 0.0006F));

		PartDefinition cube_r293 = rightFace.addOrReplaceChild("cube_r293", CubeListBuilder.create().texOffs(72, 106).mirror().addBox(-0.5F, -0.6F, -0.4F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.005F)).mirror(false), PartPose.offsetAndRotation(0.9221F, -0.2322F, -3.3852F, 1.2723F, -0.0187F, 0.1968F));

		PartDefinition cube_r294 = rightFace.addOrReplaceChild("cube_r294", CubeListBuilder.create().texOffs(26, 102).mirror().addBox(0.0248F, -0.2643F, -0.9497F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(0.7335F, -1.9734F, -3.3621F, 0.1378F, -0.0187F, 0.1968F));

		PartDefinition cube_r295 = rightFace.addOrReplaceChild("cube_r295", CubeListBuilder.create().texOffs(93, 25).mirror().addBox(0.1051F, -1.3365F, 3.5763F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.003F)).mirror(false), PartPose.offsetAndRotation(0.3627F, -1.1067F, -0.3648F, 0.279F, -0.0868F, -0.0146F));

		PartDefinition cube_r296 = rightFace.addOrReplaceChild("cube_r296", CubeListBuilder.create().texOffs(31, 72).mirror().addBox(0.1051F, -0.791F, -0.0983F, 1.0F, 1.0F, 4.0F, new CubeDeformation(-0.003F)).mirror(false), PartPose.offsetAndRotation(0.3627F, -1.1067F, -0.3648F, 0.4361F, -0.0868F, -0.0146F));

		PartDefinition cube_r297 = rightFace.addOrReplaceChild("cube_r297", CubeListBuilder.create().texOffs(47, 102).mirror().addBox(-0.3F, -0.7F, -0.5F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.005F)).mirror(false), PartPose.offsetAndRotation(0.8F, -3.9436F, -2.5917F, -0.4607F, -0.1874F, -0.2963F));

		PartDefinition cube_r298 = rightFace.addOrReplaceChild("cube_r298", CubeListBuilder.create().texOffs(57, 102).mirror().addBox(0.0F, -0.0222F, -0.0677F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(0.3F, -5.2588F, -3.5659F, 0.034F, 0.0079F, -0.2268F));

		PartDefinition cube_r299 = rightFace.addOrReplaceChild("cube_r299", CubeListBuilder.create().texOffs(86, 68).mirror().addBox(-2.3F, -8.767F, 4.6406F, 1.0F, 1.0F, 3.0F, new CubeDeformation(0.003F)).mirror(false), PartPose.offsetAndRotation(1.3F, -6.1588F, -3.9659F, -1.0821F, 0.0F, 0.0F));

		PartDefinition cube_r300 = rightFace.addOrReplaceChild("cube_r300", CubeListBuilder.create().texOffs(66, 31).mirror().addBox(0.1906F, -0.4483F, 0.0051F, 1.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-1.3F, -8.8497F, 3.8393F, -0.0933F, -0.1585F, -0.0093F));

		PartDefinition cube_r301 = rightFace.addOrReplaceChild("cube_r301", CubeListBuilder.create().texOffs(11, 54).mirror().addBox(-0.1248F, -0.0886F, -0.0391F, 1.0F, 3.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-1.3F, -9.8497F, 6.4393F, -0.5227F, -0.7114F, 0.4319F));

		PartDefinition cube_r302 = rightFace.addOrReplaceChild("cube_r302", CubeListBuilder.create().texOffs(62, 74).mirror().addBox(0.0736F, -0.8217F, 0.0997F, 2.0F, 1.0F, 3.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-1.3F, -8.8497F, 3.8393F, 0.0819F, -0.1401F, 0.2066F));
		...
		PartDefinition cube_r303 = jaw.addOrReplaceChild("cube_r303", CubeListBuilder.create().texOffs(86, 101).mirror().addBox(0.0F, -1.4F, -0.1F, 0.0F, 4.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-2.0701F, 2.6732F, -3.2894F, -0.8674F, -0.0881F, -0.138F));

		PartDefinition cube_r304 = jaw.addOrReplaceChild("cube_r304", CubeListBuilder.create().texOffs(105, 7).mirror().addBox(0.1921F, 0.613F, -0.0414F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.006F)).mirror(false), PartPose.offsetAndRotation(-2.2164F, 4.2209F, -5.4255F, -0.1723F, -0.0386F, -0.159F));

		PartDefinition cube_r305 = jaw.addOrReplaceChild("cube_r305", CubeListBuilder.create().texOffs(42, 106).mirror().addBox(-0.5F, -0.3F, -0.7F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.007F)).mirror(false), PartPose.offsetAndRotation(-1.373F, 5.3388F, -4.4712F, 0.0982F, -0.0386F, -0.159F));

		PartDefinition cube_r306 = jaw.addOrReplaceChild("cube_r306", CubeListBuilder.create().texOffs(106, 37).mirror().addBox(-0.5F, -0.1F, -0.7F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.007F)).mirror(false), PartPose.offsetAndRotation(-1.4391F, 4.9946F, -4.1935F, -0.2072F, -0.0386F, -0.159F));

		PartDefinition cube_r307 = jaw.addOrReplaceChild("cube_r307", CubeListBuilder.create().texOffs(26, 106).mirror().addBox(0.5722F, -2.027F, -1.3919F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.007F)).mirror(false), PartPose.offsetAndRotation(-2.2164F, 6.7209F, -5.0255F, -0.9926F, -0.0386F, -0.159F));

		PartDefinition cube_r308 = jaw.addOrReplaceChild("cube_r308", CubeListBuilder.create().texOffs(52, 102).mirror().addBox(-0.2216F, -0.1671F, 0.6743F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-2.0164F, 2.8209F, -3.2255F, -0.8704F, -0.0386F, -0.159F));

		PartDefinition cube_r309 = jaw.addOrReplaceChild("cube_r309", CubeListBuilder.create().texOffs(27, 97).mirror().addBox(-0.2216F, 0.0329F, -0.0257F, 1.0F, 3.0F, 1.0F, new CubeDeformation(-0.006F)).mirror(false), PartPose.offsetAndRotation(-2.0164F, 2.8209F, -3.2255F, -0.853F, -0.0386F, -0.159F));

		PartDefinition cube_r310 = jaw.addOrReplaceChild("cube_r310", CubeListBuilder.create().texOffs(101, 53).mirror().addBox(-0.5F, -0.9314F, -0.7446F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-2.3294F, 0.9399F, 0.042F, -1.0324F, -0.0836F, -0.1783F));

		PartDefinition cube_r311 = jaw.addOrReplaceChild("cube_r311", CubeListBuilder.create().texOffs(12, 95).mirror().addBox(-0.5F, -1.45F, -0.3509F, 1.0F, 3.0F, 1.0F, new CubeDeformation(-0.006F)).mirror(false), PartPose.offsetAndRotation(-2.3294F, 0.9399F, 0.042F, -0.6135F, -0.0836F, -0.1783F));

		PartDefinition cube_r312 = jaw.addOrReplaceChild("cube_r312", CubeListBuilder.create().texOffs(22, 97).mirror().addBox(-0.3339F, 0.1888F, -1.3683F, 1.0F, 3.0F, 1.0F, new CubeDeformation(0.009F)).mirror(false), PartPose.offsetAndRotation(-2.2811F, 2.6097F, 0.1632F, -0.8561F, -0.116F, -0.1593F));

		PartDefinition cube_r313 = jaw.addOrReplaceChild("cube_r313", CubeListBuilder.create().texOffs(93, 96).mirror().addBox(-0.2643F, -0.9292F, -0.0735F, 1.0F, 3.0F, 1.0F, new CubeDeformation(0.004F)).mirror(false), PartPose.offsetAndRotation(-2.2811F, 1.7097F, -2.0368F, -0.7707F, -0.0502F, -0.209F));

		PartDefinition cube_r314 = jaw.addOrReplaceChild("cube_r314", CubeListBuilder.create().texOffs(47, 106).mirror().addBox(-0.7488F, -0.3961F, -0.0236F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.007F)).mirror(false), PartPose.offsetAndRotation(-1.9164F, 0.7209F, -3.1255F, -0.1392F, -0.0855F, -0.1974F));

		PartDefinition cube_r315 = jaw.addOrReplaceChild("cube_r315", CubeListBuilder.create().texOffs(88, 96).mirror().addBox(-0.7338F, -3.2252F, -1.0587F, 1.0F, 3.0F, 1.0F, new CubeDeformation(-0.004F)).mirror(false), PartPose.offsetAndRotation(-1.9164F, 2.0209F, -0.3255F, 0.7335F, -0.0855F, -0.1974F));

		PartDefinition cube_r316 = jaw.addOrReplaceChild("cube_r316", CubeListBuilder.create().texOffs(83, 95).mirror().addBox(-0.7338F, -3.234F, 0.1117F, 1.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-1.9164F, 2.0209F, -0.3255F, 1.1F, -0.0855F, -0.1974F));

		PartDefinition cube_r317 = jaw.addOrReplaceChild("cube_r317", CubeListBuilder.create().texOffs(86, 101).addBox(0.0F, -1.4F, -0.1F, 0.0F, 4.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.8702F, 2.6732F, -3.2894F, -0.8674F, 0.0881F, 0.138F));

		PartDefinition cube_r318 = jaw.addOrReplaceChild("cube_r318", CubeListBuilder.create().texOffs(105, 7).addBox(-1.1921F, 0.613F, -0.0414F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.006F)), PartPose.offsetAndRotation(1.0165F, 4.2209F, -5.4255F, -0.1723F, 0.0386F, 0.159F));

		PartDefinition cube_r319 = jaw.addOrReplaceChild("cube_r319", CubeListBuilder.create().texOffs(42, 106).addBox(-0.5F, -0.3F, -0.7F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.007F)), PartPose.offsetAndRotation(0.1731F, 5.3388F, -4.4712F, 0.0982F, 0.0386F, 0.159F));

		PartDefinition cube_r320 = jaw.addOrReplaceChild("cube_r320", CubeListBuilder.create().texOffs(106, 37).addBox(-0.5F, -0.1F, -0.7F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.007F)), PartPose.offsetAndRotation(0.2391F, 4.9946F, -4.1935F, -0.2072F, 0.0386F, 0.159F));

		PartDefinition cube_r321 = jaw.addOrReplaceChild("cube_r321", CubeListBuilder.create().texOffs(26, 106).addBox(-1.5722F, -2.027F, -1.3919F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.007F)), PartPose.offsetAndRotation(1.0165F, 6.7209F, -5.0255F, -0.9926F, 0.0386F, 0.159F));

		PartDefinition cube_r322 = jaw.addOrReplaceChild("cube_r322", CubeListBuilder.create().texOffs(52, 102).addBox(-0.7784F, -0.1671F, 0.6743F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.8165F, 2.8209F, -3.2255F, -0.8704F, 0.0386F, 0.159F));

		PartDefinition cube_r323 = jaw.addOrReplaceChild("cube_r323", CubeListBuilder.create().texOffs(27, 97).addBox(-0.7784F, 0.0329F, -0.0257F, 1.0F, 3.0F, 1.0F, new CubeDeformation(-0.006F)), PartPose.offsetAndRotation(0.8165F, 2.8209F, -3.2255F, -0.853F, 0.0386F, 0.159F));

		PartDefinition cube_r324 = jaw.addOrReplaceChild("cube_r324", CubeListBuilder.create().texOffs(101, 53).addBox(-0.5F, -0.9314F, -0.7446F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.1295F, 0.9399F, 0.042F, -1.0324F, 0.0836F, 0.1783F));

		PartDefinition cube_r325 = jaw.addOrReplaceChild("cube_r325", CubeListBuilder.create().texOffs(12, 95).addBox(-0.5F, -1.45F, -0.3509F, 1.0F, 3.0F, 1.0F, new CubeDeformation(-0.006F)), PartPose.offsetAndRotation(1.1295F, 0.9399F, 0.042F, -0.6135F, 0.0836F, 0.1783F));

		PartDefinition cube_r326 = jaw.addOrReplaceChild("cube_r326", CubeListBuilder.create().texOffs(22, 97).addBox(-0.6661F, 0.1888F, -1.3683F, 1.0F, 3.0F, 1.0F, new CubeDeformation(0.009F)), PartPose.offsetAndRotation(1.0811F, 2.6097F, 0.1632F, -0.8561F, 0.116F, 0.1593F));

		PartDefinition cube_r327 = jaw.addOrReplaceChild("cube_r327", CubeListBuilder.create().texOffs(93, 96).addBox(-0.7357F, -0.9292F, -0.0735F, 1.0F, 3.0F, 1.0F, new CubeDeformation(0.004F)), PartPose.offsetAndRotation(1.0811F, 1.7097F, -2.0368F, -0.7707F, 0.0502F, 0.209F));

		PartDefinition cube_r328 = jaw.addOrReplaceChild("cube_r328", CubeListBuilder.create().texOffs(47, 106).addBox(-0.2512F, -0.3961F, -0.0236F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.007F)), PartPose.offsetAndRotation(0.7165F, 0.7209F, -3.1255F, -0.1392F, 0.0855F, 0.1974F));

		PartDefinition cube_r329 = jaw.addOrReplaceChild("cube_r329", CubeListBuilder.create().texOffs(88, 96).addBox(-0.2662F, -3.2252F, -1.0587F, 1.0F, 3.0F, 1.0F, new CubeDeformation(-0.004F)), PartPose.offsetAndRotation(0.7165F, 2.0209F, -0.3255F, 0.7335F, 0.0855F, 0.1974F));

		PartDefinition cube_r330 = jaw.addOrReplaceChild("cube_r330", CubeListBuilder.create().texOffs(83, 95).addBox(-0.2662F, -3.234F, 0.1117F, 1.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.7165F, 2.0209F, -0.3255F, 1.1F, 0.0855F, 0.1974F));
		...
		PartDefinition cube_r331 = leftLowerbeak.addOrReplaceChild("cube_r331", CubeListBuilder.create().texOffs(103, 97).addBox(-1.0F, -1.0953F, -0.8971F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.004F)), PartPose.offsetAndRotation(0.1947F, -0.2786F, -0.0682F, -1.0123F, 0.0873F, 0.0F));

		PartDefinition cube_r332 = leftLowerbeak.addOrReplaceChild("cube_r332", CubeListBuilder.create().texOffs(98, 98).addBox(-1.0F, 0.8203F, -0.492F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.1947F, -0.7786F, 0.9318F, -1.4661F, 0.0873F, 0.0F));

		PartDefinition cube_r333 = leftLowerbeak.addOrReplaceChild("cube_r333", CubeListBuilder.create().texOffs(75, 102).addBox(-1.3312F, -1.6997F, -0.2256F, 1.0F, 2.0F, 1.0F, new CubeDeformation(-0.2F)), PartPose.offsetAndRotation(0.1947F, -1.3786F, -2.9682F, -2.234F, 0.0873F, 0.0F));

		PartDefinition cube_r334 = leftLowerbeak.addOrReplaceChild("cube_r334", CubeListBuilder.create().texOffs(81, 100).addBox(-1.0F, 2.0724F, 0.5434F, 1.0F, 2.0F, 1.0F, new CubeDeformation(-0.21F)), PartPose.offsetAndRotation(0.1947F, -0.6786F, 0.8318F, -1.9548F, 0.0873F, 0.0F));

		PartDefinition cube_r335 = leftLowerbeak.addOrReplaceChild("cube_r335", CubeListBuilder.create().texOffs(94, 102).addBox(-1.2615F, -1.9541F, -0.898F, 1.0F, 2.0F, 1.0F, new CubeDeformation(-0.005F)), PartPose.offsetAndRotation(0.1947F, -0.0786F, -2.0682F, -1.8675F, 0.0873F, 0.0F));

		PartDefinition cube_r336 = leftLowerbeak.addOrReplaceChild("cube_r336", CubeListBuilder.create().texOffs(106, 54).addBox(-1.09F, -0.7301F, -0.1274F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.004F))
		...
		PartDefinition cube_r337 = rightLowerbeak.addOrReplaceChild("cube_r337", CubeListBuilder.create().texOffs(103, 97).mirror().addBox(0.0F, -1.0953F, -0.8971F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.004F)).mirror(false), PartPose.offsetAndRotation(-0.1947F, -0.2786F, -0.0682F, -1.0123F, -0.0873F, 0.0F));

		PartDefinition cube_r338 = rightLowerbeak.addOrReplaceChild("cube_r338", CubeListBuilder.create().texOffs(98, 98).mirror().addBox(0.0F, 0.8203F, -0.492F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-0.1947F, -0.7786F, 0.9318F, -1.4661F, -0.0873F, 0.0F));

		PartDefinition cube_r339 = rightLowerbeak.addOrReplaceChild("cube_r339", CubeListBuilder.create().texOffs(75, 102).mirror().addBox(0.3312F, -1.6997F, -0.2256F, 1.0F, 2.0F, 1.0F, new CubeDeformation(-0.2F)).mirror(false), PartPose.offsetAndRotation(-0.1947F, -1.3786F, -2.9682F, -2.234F, -0.0873F, 0.0F));

		PartDefinition cube_r340 = rightLowerbeak.addOrReplaceChild("cube_r340", CubeListBuilder.create().texOffs(81, 100).mirror().addBox(0.0F, 2.0724F, 0.5434F, 1.0F, 2.0F, 1.0F, new CubeDeformation(-0.21F)).mirror(false), PartPose.offsetAndRotation(-0.1947F, -0.6786F, 0.8318F, -1.9548F, -0.0873F, 0.0F));

		PartDefinition cube_r341 = rightLowerbeak.addOrReplaceChild("cube_r341", CubeListBuilder.create().texOffs(94, 102).mirror().addBox(0.2615F, -1.9541F, -0.898F, 1.0F, 2.0F, 1.0F, new CubeDeformation(-0.005F)).mirror(false), PartPose.offsetAndRotation(-0.1947F, -0.0786F, -2.0682F, -1.8675F, -0.0873F, 0.0F));

		PartDefinition cube_r342 = rightLowerbeak.addOrReplaceChild("cube_r342", CubeListBuilder.create().texOffs(106, 54).mirror().addBox(0.09F, -0.7301F, -0.1274F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.004F)).mirror(false)
		...
		PartDefinition cube_r343 = frill.addOrReplaceChild("cube_r343", CubeListBuilder.create().texOffs(104, 100).addBox(-0.5F, -0.7739F, -0.3368F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.1F)), PartPose.offsetAndRotation(0.0F, -4.8381F, 2.7683F, -2.0769F, 0.0F, 0.0F));

		PartDefinition cube_r344 = frill.addOrReplaceChild("cube_r344", CubeListBuilder.create().texOffs(105, 16).addBox(-0.5F, -0.1358F, -0.1009F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.099F)), PartPose.offsetAndRotation(0.0F, -4.5039F, 1.5366F, -0.6981F, 0.0F, 0.0F));

		PartDefinition cube_r345 = frill.addOrReplaceChild("cube_r345", CubeListBuilder.create().texOffs(105, 13).addBox(-0.5F, -0.594F, -0.4658F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.1F)), PartPose.offsetAndRotation(0.0F, -4.2039F, 1.9366F, -1.3963F, 0.0F, 0.0F));

		PartDefinition cube_r346 = frill.addOrReplaceChild("cube_r346", CubeListBuilder.create().texOffs(94, 77).addBox(-1.0F, -3.9532F, -1.0209F, 2.0F, 2.0F, 1.0F, new CubeDeformation(0.0F))
				.texOffs(50, 94).addBox(-1.0F, -1.9532F, -1.0209F, 2.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -5.6381F, 6.3683F, -0.5323F, 0.0F, 0.0F));

		PartDefinition cube_r347 = frill.addOrReplaceChild("cube_r347", CubeListBuilder.create().texOffs(93, 0).addBox(-1.5F, -2.0524F, -0.964F, 2.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.5F, -4.4381F, 4.7683F, -0.8988F, 0.0F, 0.0F));

		PartDefinition cube_r348 = frill.addOrReplaceChild("cube_r348", CubeListBuilder.create().texOffs(99, 102).addBox(0.7997F, -1.8342F, -0.9714F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.005F)), PartPose.offsetAndRotation(0.0884F, -8.1424F, 7.6716F, -0.2492F, -0.2355F, -0.7705F));

		PartDefinition cube_r349 = frill.addOrReplaceChild("cube_r349", CubeListBuilder.create().texOffs(98, 94).addBox(-1.0971F, -1.7083F, -0.9714F, 1.0F, 2.0F, 1.0F, new CubeDeformation(-0.004F)), PartPose.offsetAndRotation(0.0884F, -8.1424F, 7.6716F, -0.334F, 0.0713F, 0.174F));

		PartDefinition cube_r350 = frill.addOrReplaceChild("cube_r350", CubeListBuilder.create().texOffs(57, 98).addBox(-0.0465F, -1.7411F, -0.9714F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0884F, -8.1424F, 7.6716F, -0.3387F, -0.042F, -0.1472F));

		PartDefinition cube_r351 = frill.addOrReplaceChild("cube_r351", CubeListBuilder.create().texOffs(11, 100).addBox(-0.5F, -1.8647F, -0.0282F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F))
				.texOffs(26, 47).addBox(-1.0F, -2.6324F, 0.2617F, 2.0F, 0.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -4.8381F, 2.7683F, -1.2915F, 0.0F, 0.0F));

		PartDefinition cube_r352 = frill.addOrReplaceChild("cube_r352", CubeListBuilder.create().texOffs(20, 82).addBox(-1.5F, -2.6324F, 0.2617F, 3.0F, 4.0F, 1.0F, new CubeDeformation(0.005F)), PartPose.offsetAndRotation(0.0F, -4.8381F, 2.7683F, -1.2043F, 0.0F, 0.0F));
		...
		PartDefinition cube_r353 = leftFrill.addOrReplaceChild("cube_r353", CubeListBuilder.create().texOffs(27, 88).addBox(-2.2F, 0.2F, 0.1F, 3.0F, 2.0F, 1.0F, new CubeDeformation(0.004F)), PartPose.offsetAndRotation(0.9885F, 2.0697F, -1.9428F, -0.4457F, 0.0502F, 0.3268F));

		PartDefinition cube_r354 = leftFrill.addOrReplaceChild("cube_r354", CubeListBuilder.create().texOffs(73, 74).addBox(-4.0F, -3.9F, -0.5F, 3.0F, 5.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.7459F, 3.7253F, -1.64F, 0.0889F, -0.2145F, -1.4049F));

		PartDefinition cube_r355 = leftFrill.addOrReplaceChild("cube_r355", CubeListBuilder.create().texOffs(0, 81).addBox(-2.5F, -0.5F, -0.5F, 4.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.3739F, 4.2337F, -1.7897F, -0.2992F, -0.2719F, -0.1534F));

		PartDefinition cube_r356 = leftFrill.addOrReplaceChild("cube_r356", CubeListBuilder.create().texOffs(43, 94).addBox(-0.7F, -0.8F, -0.5F, 2.0F, 2.0F, 1.0F, new CubeDeformation(-0.004F)), PartPose.offsetAndRotation(4.3214F, 4.3352F, -1.4169F, -0.3885F, 0.0187F, 0.7952F));

		PartDefinition cube_r357 = leftFrill.addOrReplaceChild("cube_r357", CubeListBuilder.create().texOffs(22, 56).addBox(0.1F, -1.6F, -0.5F, 5.0F, 4.0F, 1.0F, new CubeDeformation(0.007F)), PartPose.offsetAndRotation(4.1283F, 1.2253F, -0.4618F, 0.16F, 0.2896F, 2.5574F));

		PartDefinition cube_r358 = leftFrill.addOrReplaceChild("cube_r358", CubeListBuilder.create().texOffs(74, 55).addBox(0.0333F, 1.6699F, -0.0648F, 4.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(6.6273F, -1.4393F, 0.5517F, -0.2918F, 0.2666F, 1.2784F));

		PartDefinition cube_r359 = leftFrill.addOrReplaceChild("cube_r359", CubeListBuilder.create().texOffs(25, 92).addBox(-1.0F, -1.5F, -0.5F, 2.0F, 3.0F, 1.0F, new CubeDeformation(0.004F)), PartPose.offsetAndRotation(4.4496F, 3.461F, -1.1189F, -0.1654F, 0.3248F, 1.7142F));

		PartDefinition cube_r360 = leftFrill.addOrReplaceChild("cube_r360", CubeListBuilder.create().texOffs(57, 87).addBox(1.912F, -0.9086F, -0.1692F, 3.0F, 2.0F, 1.0F, new CubeDeformation(0.004F)), PartPose.offsetAndRotation(0.8542F, -3.7795F, 0.3388F, -0.3976F, 0.0955F, 0.7524F));

		PartDefinition cube_r361 = leftFrill.addOrReplaceChild("cube_r361", CubeListBuilder.create().texOffs(93, 73).addBox(0.0786F, -0.0605F, -0.0207F, 2.0F, 2.0F, 1.0F, new CubeDeformation(0.005F)), PartPose.offsetAndRotation(0.8542F, -3.7795F, 0.3388F, -0.3802F, 0.0047F, 0.3566F));

		PartDefinition cube_r362 = leftFrill.addOrReplaceChild("cube_r362", CubeListBuilder.create().texOffs(104, 4).addBox(-0.4F, -0.2F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.1F)), PartPose.offsetAndRotation(4.2546F, 5.8742F, -1.8038F, 0.2017F, 0.3311F, 2.7452F));

		PartDefinition cube_r363 = leftFrill.addOrReplaceChild("cube_r363", CubeListBuilder.create().texOffs(103, 91).addBox(-0.4F, -0.3F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.1F)), PartPose.offsetAndRotation(5.3323F, 5.2911F, -1.3583F, -0.2164F, 0.3219F, 1.5766F));

		PartDefinition cube_r364 = leftFrill.addOrReplaceChild("cube_r364", CubeListBuilder.create().texOffs(11, 104).addBox(-0.5F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.1F)), PartPose.offsetAndRotation(5.7563F, 4.2267F, -0.9657F, -0.2728F, 0.1552F, 0.8967F));

		PartDefinition cube_r365 = leftFrill.addOrReplaceChild("cube_r365", CubeListBuilder.create().texOffs(104, 103).addBox(0.0687F, -0.8961F, -0.5584F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.005F)), PartPose.offsetAndRotation(5.5191F, 2.4087F, -0.4952F, -0.2998F, 0.0909F, 0.6774F));

		PartDefinition cube_r366 = leftFrill.addOrReplaceChild("cube_r366", CubeListBuilder.create().texOffs(80, 104).addBox(-0.7184F, -0.5809F, -0.5584F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.004F)), PartPose.offsetAndRotation(5.5191F, 2.4087F, -0.4952F, -0.0908F, 0.2998F, 1.6635F));

		PartDefinition cube_r367 = leftFrill.addOrReplaceChild("cube_r367", CubeListBuilder.create().texOffs(104, 81).addBox(-0.0658F, -0.552F, -0.5584F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(5.5191F, 2.4087F, -0.4952F, -0.1872F, 0.2521F, 1.3131F));

		PartDefinition cube_r368 = leftFrill.addOrReplaceChild("cube_r368", CubeListBuilder.create().texOffs(31, 103).addBox(0.0687F, -0.8961F, -0.5584F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.005F)), PartPose.offsetAndRotation(5.5191F, 0.5087F, 0.1048F, -0.2998F, 0.0909F, 0.5552F));

		PartDefinition cube_r369 = leftFrill.addOrReplaceChild("cube_r369", CubeListBuilder.create().texOffs(102, 63).addBox(-0.7184F, -0.5809F, -0.5584F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.004F)), PartPose.offsetAndRotation(5.5191F, 0.5087F, 0.1048F, -0.0908F, 0.2998F, 1.5414F));

		PartDefinition cube_r370 = leftFrill.addOrReplaceChild("cube_r370", CubeListBuilder.create().texOffs(102, 70).addBox(-0.0658F, -0.552F, -0.5584F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(5.5191F, 0.5087F, 0.1048F, -0.1872F, 0.2521F, 1.1909F));

		PartDefinition cube_r371 = leftFrill.addOrReplaceChild("cube_r371", CubeListBuilder.create().texOffs(47, 98).addBox(-0.0658F, -0.552F, -0.5584F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(4.9191F, -1.8913F, 0.7048F, -0.2479F, 0.0768F, 0.6139F));

		PartDefinition cube_r372 = leftFrill.addOrReplaceChild("cube_r372", CubeListBuilder.create().texOffs(42, 98).addBox(-0.7184F, -0.5809F, -0.5584F, 1.0F, 2.0F, 1.0F, new CubeDeformation(-0.004F)), PartPose.offsetAndRotation(4.9191F, -1.8913F, 0.7048F, -0.209F, 0.1546F, 0.9476F));

		PartDefinition cube_r373 = leftFrill.addOrReplaceChild("cube_r373", CubeListBuilder.create().texOffs(36, 78).addBox(0.0687F, -0.8961F, -0.5584F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.005F)), PartPose.offsetAndRotation(4.9191F, -1.8913F, 0.7048F, -0.2449F, -0.0861F, -0.0117F));

		PartDefinition cube_r374 = leftFrill.addOrReplaceChild("cube_r374", CubeListBuilder.create().texOffs(36, 103).addBox(-0.049F, -0.8742F, -0.4865F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.005F)), PartPose.offsetAndRotation(2.9249F, -3.875F, 1.0688F, -0.2119F, -0.21F, -0.3989F));

		PartDefinition cube_r375 = leftFrill.addOrReplaceChild("cube_r375", CubeListBuilder.create().texOffs(76, 98).addBox(-0.7651F, -0.4707F, -0.4865F, 1.0F, 2.0F, 1.0F, new CubeDeformation(-0.004F)), PartPose.offsetAndRotation(2.9249F, -3.875F, 1.0688F, -0.2919F, 0.0565F, 0.5564F));

		PartDefinition cube_r376 = leftFrill.addOrReplaceChild("cube_r376", CubeListBuilder.create().texOffs(52, 98).addBox(-0.1465F, -0.4636F, -0.4865F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.9249F, -3.875F, 1.0688F, -0.2942F, -0.0427F, 0.2307F));

		PartDefinition cube_r377 = leftFrill.addOrReplaceChild("cube_r377", CubeListBuilder.create().texOffs(0, 98).addBox(-0.9611F, -0.8761F, -0.2111F, 1.0F, 2.0F, 1.0F, new CubeDeformation(-0.004F)), PartPose.offsetAndRotation(0.3168F, -4.4576F, 0.8571F, -0.351F, 0.0755F, 0.2425F));

		PartDefinition cube_r378 = leftFrill.addOrReplaceChild("cube_r378", CubeListBuilder.create().texOffs(103, 94).addBox(-0.5F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.005F)), PartPose.offsetAndRotation(0.3097F, -5.3129F, 1.4859F, -0.263F, -0.2468F, -0.6974F));

		PartDefinition cube_r379 = leftFrill.addOrReplaceChild("cube_r379", CubeListBuilder.create().texOffs(13, 43).addBox(-0.196F, -0.9113F, -0.2111F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.3168F, -4.4576F, 0.8571F, -0.3561F, -0.0434F, -0.0766F));

		PartDefinition cube_r380 = leftFrill.addOrReplaceChild("cube_r380", CubeListBuilder.create().texOffs(18, 88).addBox(-1.5F, -0.6F, -0.5F, 3.0F, 2.0F, 1.0F, new CubeDeformation(-0.1F)), PartPose.offsetAndRotation(-0.1311F, 1.1893F, -0.8651F, 0.2511F, -0.2076F, -2.6177F));

		PartDefinition cube_r381 = leftFrill.addOrReplaceChild("cube_r381", CubeListBuilder.create().texOffs(75, 70).addBox(-5.5F, -1.6F, -0.5F, 4.0F, 2.0F, 1.0F, new CubeDeformation(-0.099F)), PartPose.offsetAndRotation(0.113F, -3.5754F, 0.7059F, -0.0885F, -0.3125F, -1.443F));

		PartDefinition cube_r382 = leftFrill.addOrReplaceChild("cube_r382", CubeListBuilder.create().texOffs(92, 87).addBox(0.0642F, -0.3081F, -0.0864F, 2.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-1.1615F, -3.4945F, 0.3846F, -0.3318F, 0.033F, -0.0114F));
		...
		PartDefinition cube_r383 = rightFrill.addOrReplaceChild("cube_r383", CubeListBuilder.create().texOffs(27, 88).mirror().addBox(-0.8F, 0.2F, 0.1F, 3.0F, 2.0F, 1.0F, new CubeDeformation(0.004F)).mirror(false), PartPose.offsetAndRotation(-0.9885F, 2.0697F, -1.9428F, -0.4457F, -0.0502F, -0.3268F));

		PartDefinition cube_r384 = rightFrill.addOrReplaceChild("cube_r384", CubeListBuilder.create().texOffs(73, 74).mirror().addBox(1.0F, -3.9F, -0.5F, 3.0F, 5.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-0.7459F, 3.7253F, -1.64F, 0.0889F, 0.2145F, 1.4049F));

		PartDefinition cube_r385 = rightFrill.addOrReplaceChild("cube_r385", CubeListBuilder.create().texOffs(0, 81).mirror().addBox(-1.5F, -0.5F, -0.5F, 4.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-2.3739F, 4.2337F, -1.7897F, -0.2992F, 0.2719F, 0.1534F));

		PartDefinition cube_r386 = rightFrill.addOrReplaceChild("cube_r386", CubeListBuilder.create().texOffs(43, 94).mirror().addBox(-1.3F, -0.8F, -0.5F, 2.0F, 2.0F, 1.0F, new CubeDeformation(-0.004F)).mirror(false), PartPose.offsetAndRotation(-4.3214F, 4.3352F, -1.4169F, -0.3885F, -0.0187F, -0.7952F));

		PartDefinition cube_r387 = rightFrill.addOrReplaceChild("cube_r387", CubeListBuilder.create().texOffs(22, 56).mirror().addBox(-5.1F, -1.6F, -0.5F, 5.0F, 4.0F, 1.0F, new CubeDeformation(0.007F)).mirror(false), PartPose.offsetAndRotation(-4.1283F, 1.2253F, -0.4618F, 0.16F, -0.2896F, -2.5574F));

		PartDefinition cube_r388 = rightFrill.addOrReplaceChild("cube_r388", CubeListBuilder.create().texOffs(74, 55).mirror().addBox(-4.0333F, 1.6699F, -0.0648F, 4.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-6.6273F, -1.4393F, 0.5517F, -0.2918F, -0.2666F, -1.2784F));

		PartDefinition cube_r389 = rightFrill.addOrReplaceChild("cube_r389", CubeListBuilder.create().texOffs(25, 92).mirror().addBox(-1.0F, -1.5F, -0.5F, 2.0F, 3.0F, 1.0F, new CubeDeformation(0.004F)).mirror(false), PartPose.offsetAndRotation(-4.4496F, 3.461F, -1.1189F, -0.1654F, -0.3248F, -1.7142F));

		PartDefinition cube_r390 = rightFrill.addOrReplaceChild("cube_r390", CubeListBuilder.create().texOffs(57, 87).mirror().addBox(-4.912F, -0.9086F, -0.1692F, 3.0F, 2.0F, 1.0F, new CubeDeformation(0.004F)).mirror(false), PartPose.offsetAndRotation(-0.8542F, -3.7795F, 0.3388F, -0.3976F, -0.0955F, -0.7524F));

		PartDefinition cube_r391 = rightFrill.addOrReplaceChild("cube_r391", CubeListBuilder.create().texOffs(93, 73).mirror().addBox(-2.0786F, -0.0605F, -0.0207F, 2.0F, 2.0F, 1.0F, new CubeDeformation(0.005F)).mirror(false), PartPose.offsetAndRotation(-0.8542F, -3.7795F, 0.3388F, -0.3802F, -0.0047F, -0.3566F));

		PartDefinition cube_r392 = rightFrill.addOrReplaceChild("cube_r392", CubeListBuilder.create().texOffs(104, 4).mirror().addBox(-0.6F, -0.2F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.1F)).mirror(false), PartPose.offsetAndRotation(-4.2546F, 5.8742F, -1.8038F, 0.2017F, -0.3311F, -2.7452F));

		PartDefinition cube_r393 = rightFrill.addOrReplaceChild("cube_r393", CubeListBuilder.create().texOffs(103, 91).mirror().addBox(-0.6F, -0.3F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.1F)).mirror(false), PartPose.offsetAndRotation(-5.3323F, 5.2911F, -1.3583F, -0.2164F, -0.3219F, -1.5766F));

		PartDefinition cube_r394 = rightFrill.addOrReplaceChild("cube_r394", CubeListBuilder.create().texOffs(11, 104).mirror().addBox(-0.5F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.1F)).mirror(false), PartPose.offsetAndRotation(-5.7563F, 4.2267F, -0.9657F, -0.2728F, -0.1552F, -0.8967F));

		PartDefinition cube_r395 = rightFrill.addOrReplaceChild("cube_r395", CubeListBuilder.create().texOffs(104, 103).mirror().addBox(-1.0687F, -0.8961F, -0.5584F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.005F)).mirror(false), PartPose.offsetAndRotation(-5.5191F, 2.4087F, -0.4952F, -0.2998F, -0.0909F, -0.6774F));

		PartDefinition cube_r396 = rightFrill.addOrReplaceChild("cube_r396", CubeListBuilder.create().texOffs(80, 104).mirror().addBox(-0.2816F, -0.5809F, -0.5584F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.004F)).mirror(false), PartPose.offsetAndRotation(-5.5191F, 2.4087F, -0.4952F, -0.0908F, -0.2998F, -1.6635F));

		PartDefinition cube_r397 = rightFrill.addOrReplaceChild("cube_r397", CubeListBuilder.create().texOffs(104, 81).mirror().addBox(-0.9342F, -0.552F, -0.5584F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-5.5191F, 2.4087F, -0.4952F, -0.1872F, -0.2521F, -1.3131F));

		PartDefinition cube_r398 = rightFrill.addOrReplaceChild("cube_r398", CubeListBuilder.create().texOffs(31, 103).mirror().addBox(-1.0687F, -0.8961F, -0.5584F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.005F)).mirror(false), PartPose.offsetAndRotation(-5.5191F, 0.5087F, 0.1048F, -0.2998F, -0.0909F, -0.5552F));

		PartDefinition cube_r399 = rightFrill.addOrReplaceChild("cube_r399", CubeListBuilder.create().texOffs(102, 63).mirror().addBox(-0.2816F, -0.5809F, -0.5584F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.004F)).mirror(false), PartPose.offsetAndRotation(-5.5191F, 0.5087F, 0.1048F, -0.0908F, -0.2998F, -1.5414F));

		PartDefinition cube_r400 = rightFrill.addOrReplaceChild("cube_r400", CubeListBuilder.create().texOffs(102, 70).mirror().addBox(-0.9342F, -0.552F, -0.5584F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-5.5191F, 0.5087F, 0.1048F, -0.1872F, -0.2521F, -1.1909F));

		PartDefinition cube_r401 = rightFrill.addOrReplaceChild("cube_r401", CubeListBuilder.create().texOffs(47, 98).mirror().addBox(-0.9342F, -0.552F, -0.5584F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-4.9191F, -1.8913F, 0.7048F, -0.2479F, -0.0768F, -0.6139F));

		PartDefinition cube_r402 = rightFrill.addOrReplaceChild("cube_r402", CubeListBuilder.create().texOffs(42, 98).mirror().addBox(-0.2816F, -0.5809F, -0.5584F, 1.0F, 2.0F, 1.0F, new CubeDeformation(-0.004F)).mirror(false), PartPose.offsetAndRotation(-4.9191F, -1.8913F, 0.7048F, -0.209F, -0.1546F, -0.9476F));

		PartDefinition cube_r403 = rightFrill.addOrReplaceChild("cube_r403", CubeListBuilder.create().texOffs(36, 78).mirror().addBox(-1.0687F, -0.8961F, -0.5584F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.005F)).mirror(false), PartPose.offsetAndRotation(-4.9191F, -1.8913F, 0.7048F, -0.2449F, 0.0861F, 0.0117F));

		PartDefinition cube_r404 = rightFrill.addOrReplaceChild("cube_r404", CubeListBuilder.create().texOffs(36, 103).mirror().addBox(-0.951F, -0.8742F, -0.4865F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.005F)).mirror(false), PartPose.offsetAndRotation(-2.9249F, -3.875F, 1.0688F, -0.2119F, 0.21F, 0.3989F));

		PartDefinition cube_r405 = rightFrill.addOrReplaceChild("cube_r405", CubeListBuilder.create().texOffs(76, 98).mirror().addBox(-0.2349F, -0.4707F, -0.4865F, 1.0F, 2.0F, 1.0F, new CubeDeformation(-0.004F)).mirror(false), PartPose.offsetAndRotation(-2.9249F, -3.875F, 1.0688F, -0.2919F, -0.0565F, -0.5564F));

		PartDefinition cube_r406 = rightFrill.addOrReplaceChild("cube_r406", CubeListBuilder.create().texOffs(52, 98).mirror().addBox(-0.8535F, -0.4636F, -0.4865F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-2.9249F, -3.875F, 1.0688F, -0.2942F, 0.0427F, -0.2307F));

		PartDefinition cube_r407 = rightFrill.addOrReplaceChild("cube_r407", CubeListBuilder.create().texOffs(0, 98).mirror().addBox(-0.0389F, -0.8761F, -0.2111F, 1.0F, 2.0F, 1.0F, new CubeDeformation(-0.004F)).mirror(false), PartPose.offsetAndRotation(-0.3168F, -4.4576F, 0.8571F, -0.351F, -0.0755F, -0.2425F));

		PartDefinition cube_r408 = rightFrill.addOrReplaceChild("cube_r408", CubeListBuilder.create().texOffs(103, 94).mirror().addBox(-0.5F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.005F)).mirror(false), PartPose.offsetAndRotation(-0.3097F, -5.3129F, 1.4859F, -0.263F, 0.2468F, 0.6974F));

		PartDefinition cube_r409 = rightFrill.addOrReplaceChild("cube_r409", CubeListBuilder.create().texOffs(13, 43).mirror().addBox(-0.804F, -0.9113F, -0.2111F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-0.3168F, -4.4576F, 0.8571F, -0.3561F, 0.0434F, 0.0766F));

		PartDefinition cube_r410 = rightFrill.addOrReplaceChild("cube_r410", CubeListBuilder.create().texOffs(18, 88).mirror().addBox(-1.5F, -0.6F, -0.5F, 3.0F, 2.0F, 1.0F, new CubeDeformation(-0.1F)).mirror(false), PartPose.offsetAndRotation(0.1311F, 1.1893F, -0.8651F, 0.2511F, 0.2076F, 2.6177F));

		PartDefinition cube_r411 = rightFrill.addOrReplaceChild("cube_r411", CubeListBuilder.create().texOffs(75, 70).mirror().addBox(1.5F, -1.6F, -0.5F, 4.0F, 2.0F, 1.0F, new CubeDeformation(-0.099F)).mirror(false), PartPose.offsetAndRotation(-0.113F, -3.5754F, 0.7059F, -0.0885F, 0.3125F, 1.443F));

		PartDefinition cube_r412 = rightFrill.addOrReplaceChild("cube_r412", CubeListBuilder.create().texOffs(92, 87).mirror().addBox(-2.0642F, -0.3081F, -0.0864F, 2.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(1.1615F, -3.4945F, 0.3846F, -0.3318F, -0.033F, 0.0114F));
