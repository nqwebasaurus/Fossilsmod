...
public class TupuxuaraFossilFrameModel extends SkullModelBase {
	...
	public TupuxuaraFossilFrameModel(ModelPart root) {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition chest1 = root.addOrReplaceChild("chest1", CubeListBuilder.create(), PartPose.offsetAndRotation(0.0357F, -11.1722F, 4.6311F, -0.5202F, 0.0435F, 0.0757F));

		PartDefinition cube_r1 = chest1.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(8, 135).addBox(-0.5357F, 0.3877F, 1.9852F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.15F))
				.texOffs(7, 134).addBox(-0.5357F, 0.3877F, 0.2852F, 1.0F, 1.0F, 2.0F, new CubeDeformation(-0.15F)), PartPose.offsetAndRotation(0.0F, 0.4212F, -0.7096F, 0.1047F, 0.0F, 0.0F));

		PartDefinition cube_r2 = chest1.addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(0, 127).addBox(0.9F, -0.5F, -4.5F, 1.0F, 1.0F, 9.0F, new CubeDeformation(-0.15F)), PartPose.offsetAndRotation(-0.0357F, 2.8604F, 0.8391F, -1.5708F, -0.1047F, 1.5708F));

		PartDefinition cube_r3 = chest1.addOrReplaceChild("cube_r3", CubeListBuilder.create().texOffs(6, 133).addBox(-0.5F, -0.5F, 0.2F, 1.0F, 1.0F, 3.0F, new CubeDeformation(-0.16F)), PartPose.offsetAndRotation(-0.0357F, 1.1697F, 0.6614F, -1.4661F, 0.0F, 0.0F));
		...
		PartDefinition cube_r4 = neck1.addOrReplaceChild("cube_r4", CubeListBuilder.create().texOffs(143, 143).addBox(-0.5357F, -0.175F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.15F)), PartPose.offsetAndRotation(0.0F, 0.4445F, -0.5867F, 0.0436F, 0.0F, 0.0F));
		...
		PartDefinition cube_r5 = neck5.addOrReplaceChild("cube_r5", CubeListBuilder.create().texOffs(120, 35).addBox(-0.5357F, -0.15F, -4.2F, 1.0F, 1.0F, 4.0F, new CubeDeformation(-0.15F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.4F, 0.0436F, 0.0F, 0.0F));
		...
		PartDefinition cube_r6 = neck.addOrReplaceChild("cube_r6", CubeListBuilder.create().texOffs(120, 41).addBox(-0.5357F, -0.0759F, -3.8016F, 1.0F, 1.0F, 4.0F, new CubeDeformation(-0.15F)), PartPose.offsetAndRotation(0.0F, 0.3956F, -0.0591F, -0.1658F, 0.0F, 0.0F));

		PartDefinition neck2 = neck.addOrReplaceChild("neck2", CubeListBuilder.create().texOffs(111, 0).addBox(-0.5357F, -0.1179F, -5.0187F, 1.0F, 1.0F, 5.0F, new CubeDeformation(-0.15F))
				.texOffs(115, 4).addBox(-0.5357F, -0.1179F, -0.3187F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.15F)), PartPose.offsetAndRotation(0.0F, -0.2953F, -4.0192F, -0.3384F, 0.0412F, -0.0145F));

		PartDefinition neck3 = neck2.addOrReplaceChild("neck3", CubeListBuilder.create(), PartPose.offsetAndRotation(0.0F, -0.3474F, -4.8445F, -0.1359F, 0.0924F, 0.0314F));

		PartDefinition cube_r7 = neck3.addOrReplaceChild("cube_r7", CubeListBuilder.create().texOffs(130, 69).addBox(-0.5357F, 0.4F, -0.075F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.15F))
				.texOffs(128, 67).addBox(-0.5357F, 0.4F, -2.775F, 1.0F, 1.0F, 3.0F, new CubeDeformation(-0.15F)), PartPose.offsetAndRotation(0.0F, -0.198F, -0.4517F, -0.0873F, 0.0F, 0.0F));
		...
		PartDefinition cube_r8 = neck4.addOrReplaceChild("cube_r8", CubeListBuilder.create().texOffs(62, 134).addBox(-0.5357F, 0.4F, -7.3F, 1.0F, 1.0F, 2.0F, new CubeDeformation(-0.15F)), PartPose.offsetAndRotation(0.0F, -0.2033F, 5.5443F, -0.0873F, 0.0F, 0.0F));
		...
		PartDefinition leftwing2 = leftwing1.addOrReplaceChild("leftwing2", CubeListBuilder.create(), PartPose.offsetAndRotation(9.0064F, 0.213F, -3.1633F, -1.2342F, 0.5718F, -2.7543F));

		PartDefinition leftwing3 = leftwing2.addOrReplaceChild("leftwing3", CubeListBuilder.create(), PartPose.offsetAndRotation(-1.6016F, 16.0866F, -0.3174F, 0.1312F, 0.2144F, 0.4912F));
		...
		PartDefinition leftwing5 = leftwing4.addOrReplaceChild("leftwing5", CubeListBuilder.create(), PartPose.offsetAndRotation(-0.6158F, -0.2375F, 24.2482F, 0.2214F, 0.1335F, 0.7286F));

		PartDefinition leftwing6 = leftwing5.addOrReplaceChild("leftwing6", CubeListBuilder.create(), PartPose.offsetAndRotation(0.0609F, 0.3715F, 15.7457F, 0.1929F, 0.0745F, -0.041F));

		PartDefinition leftwing7 = leftwing6.addOrReplaceChild("leftwing7", CubeListBuilder.create(), PartPose.offsetAndRotation(-0.0803F, -0.4157F, 10.7082F, 0.0886F, 0.2178F, 0.0078F));
		...
		PartDefinition rightwing2 = rightwing1.addOrReplaceChild("rightwing2", CubeListBuilder.create(), PartPose.offsetAndRotation(-9.0064F, 0.213F, -3.1633F, -1.2778F, -0.5718F, 2.7543F));

		PartDefinition rightwing3 = rightwing2.addOrReplaceChild("rightwing3", CubeListBuilder.create(), PartPose.offsetAndRotation(1.6016F, 16.0866F, -0.3174F, 0.1312F, -0.2144F, -0.4912F));
		...
		PartDefinition rightwing5 = rightwing4.addOrReplaceChild("rightwing5", CubeListBuilder.create(), PartPose.offsetAndRotation(0.6158F, -0.2375F, 24.2482F, 0.2665F, -0.176F, -0.7383F));

		PartDefinition rightwing6 = rightwing5.addOrReplaceChild("rightwing6", CubeListBuilder.create(), PartPose.offsetAndRotation(-0.0609F, 0.3715F, 15.7457F, 0.1949F, -0.1601F, 0.024F));

		PartDefinition rightwing7 = rightwing6.addOrReplaceChild("rightwing7", CubeListBuilder.create(), PartPose.offsetAndRotation(0.0803F, -0.4157F, 10.7082F, 0.0886F, -0.2178F, -0.0078F));

		PartDefinition body = chest1.addOrReplaceChild("body", CubeListBuilder.create().texOffs(123, 111).addBox(-0.5357F, 0.1919F, 0.0316F, 1.0F, 1.0F, 4.0F, new CubeDeformation(-0.15F)), PartPose.offsetAndRotation(0.0F, 0.3212F, 1.9887F, -0.0175F, 0.0F, 0.0F));
		...
		PartDefinition cube_r9 = body2.addOrReplaceChild("cube_r9", CubeListBuilder.create().texOffs(131, 84).addBox(-0.5357F, 0.7076F, 2.5318F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.15F))
				.texOffs(129, 82).addBox(-0.5357F, 0.7076F, -0.1682F, 1.0F, 1.0F, 3.0F, new CubeDeformation(-0.15F)), PartPose.offsetAndRotation(0.0F, -0.4F, 0.0F, -0.0872F, 0.0012F, -0.0018F));
		...
		PartDefinition cube_r10 = body3.addOrReplaceChild("cube_r10", CubeListBuilder.create().texOffs(18, 131).addBox(-0.5357F, 0.7076F, 0.2818F, 1.0F, 1.0F, 3.0F, new CubeDeformation(-0.15F)), PartPose.offsetAndRotation(0.0F, -0.4F, 0.0F, -0.0872F, 0.0012F, -0.0018F));
		...
		PartDefinition cube_r11 = body1.addOrReplaceChild("cube_r11", CubeListBuilder.create().texOffs(106, 54).addBox(0.7F, -0.3F, -2.0F, 1.0F, 1.0F, 4.0F, new CubeDeformation(-0.15F)), PartPose.offsetAndRotation(-0.0357F, 0.826F, 1.9046F, -1.5708F, -1.5359F, 1.5708F));

		PartDefinition cube_r12 = body1.addOrReplaceChild("cube_r12", CubeListBuilder.create().texOffs(104, 52).addBox(-0.5357F, 0.6F, -2.5F, 1.0F, 1.0F, 6.0F, new CubeDeformation(-0.15F)), PartPose.offsetAndRotation(0.0F, -0.2908F, 1.4433F, -0.0349F, 0.0F, 0.0F));

		PartDefinition tail1 = body1.addOrReplaceChild("tail1", CubeListBuilder.create().texOffs(40, 104).addBox(-0.5357F, 0.1472F, -0.3829F, 1.0F, 1.0F, 6.0F, new CubeDeformation(-0.15F)), PartPose.offsetAndRotation(0.0F, 0.3008F, 5.043F, -0.1248F, 0.0F, 0.0F));

		PartDefinition leftleg1 = body1.addOrReplaceChild("leftleg1", CubeListBuilder.create(), PartPose.offsetAndRotation(1.6143F, 1.4361F, 3.1118F, 1.4115F, 0.4808F, -0.3622F));
		...
		PartDefinition rightleg1 = body1.addOrReplaceChild("rightleg1", CubeListBuilder.create(), PartPose.offsetAndRotation(-1.6858F, 1.4361F, 3.1118F, 1.4115F, -0.4808F, 0.3622F));
