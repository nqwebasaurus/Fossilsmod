...
public class FossilSlabRenderer implements BlockEntityRenderer<FossilSlabBlockEntity> {
    ...
    public static final Map<RotatableFossilEntity.FossilType, ResourceLocation> SKIN_BY_TYPE = Util.make(Maps.newHashMap(), (type) -> {
        ...
        type.put(RotatableFossilEntity.Types.MARALDICHTHYS, new ResourceLocation(FossilMod.MOD_ID, "textures/block/slabs/maraldichthys.png"));
        type.put(RotatableFossilEntity.Types.HENSODON, new ResourceLocation(FossilMod.MOD_ID, "textures/block/slabs/hensodon.png"));
        type.put(RotatableFossilEntity.Types.BOBASATRANIA, new ResourceLocation(FossilMod.MOD_ID, "textures/block/slabs/bobasatrania.png"));
        type.put(RotatableFossilEntity.Types.HARPAGOFUTUTOR, new ResourceLocation(FossilMod.MOD_ID, "textures/block/slabs/harpagofututor.png"));
        type.put(RotatableFossilEntity.Types.PARAMETEORASPIS, new ResourceLocation(FossilMod.MOD_ID, "textures/block/slabs/parameteoraspis.png"));
        type.put(RotatableFossilEntity.Types.CLADOSELACHE, new ResourceLocation(FossilMod.MOD_ID, "textures/block/slabs/cladoselache.png"));
        type.put(RotatableFossilEntity.Types.MIMETASTER, new ResourceLocation(FossilMod.MOD_ID, "textures/block/slabs/mimetaster.png"));
        type.put(RotatableFossilEntity.Types.HELIANTHASTER, new ResourceLocation(FossilMod.MOD_ID, "textures/block/slabs/helianthaster.png"));
        type.put(RotatableFossilEntity.Types.FLAGELLOPANTOPUS, new ResourceLocation(FossilMod.MOD_ID, "textures/block/slabs/flagellopantopus.png"));
        type.put(RotatableFossilEntity.Types.STENSIOELLA, new ResourceLocation(FossilMod.MOD_ID, "textures/block/slabs/stensioella.png"));
        type.put(RotatableFossilEntity.Types.LUNGMENSHANASPIS, new ResourceLocation(FossilMod.MOD_ID, "textures/block/slabs/lungmenshanaspis.png"));
        type.put(RotatableFossilEntity.Types.DORYASPIS, new ResourceLocation(FossilMod.MOD_ID, "textures/block/slabs/doryaspis.png"));
        type.put(RotatableFossilEntity.Types.GANTAROSTRATASPIS, new ResourceLocation(FossilMod.MOD_ID, "textures/block/slabs/gantarostrataspis.png"));
        type.put(RotatableFossilEntity.Types.FURCACAUDA, new ResourceLocation(FossilMod.MOD_ID, "textures/block/slabs/furcacauda.png"));
        type.put(RotatableFossilEntity.Types.ANGELACANTHUS, new ResourceLocation(FossilMod.MOD_ID, "textures/block/slabs/angelacanthus.png"));
        type.put(RotatableFossilEntity.Types.OSTEOLEPIS, new ResourceLocation(FossilMod.MOD_ID, "textures/block/slabs/osteolepis.png"));
        type.put(RotatableFossilEntity.Types.SEMIONOTUS, new ResourceLocation(FossilMod.MOD_ID, "textures/block/slabs/semionotus.png"));
        type.put(RotatableFossilEntity.Types.BUNDENBACHIELLUS, new ResourceLocation(FossilMod.MOD_ID, "textures/block/slabs/bundenbachiellus.png"));
        type.put(RotatableFossilEntity.Types.HIBBERTOPTERUS, new ResourceLocation(FossilMod.MOD_ID, "textures/block/slabs/hibbertopterus.png"));
        type.put(RotatableFossilEntity.Types.EUSTHENOPTERON, new ResourceLocation(FossilMod.MOD_ID, "textures/block/slabs/eusthenopteron.png"));
        type.put(RotatableFossilEntity.Types.JAEKELOPTERUS, new ResourceLocation(FossilMod.MOD_ID, "textures/block/slabs/jaekelopterus.png"));
        type.put(RotatableFossilEntity.Types.PRAEARCTURUS, new ResourceLocation(FossilMod.MOD_ID, "textures/block/slabs/praearcturus.png"));
        type.put(RotatableFossilEntity.Types.XENACANTHUS, new ResourceLocation(FossilMod.MOD_ID, "textures/block/slabs/xenacanthus.png"));
        type.put(RotatableFossilEntity.Types.SANTANMANTIS, new ResourceLocation(FossilMod.MOD_ID, "textures/block/slabs/santanmantis.png"));
        type.put(RotatableFossilEntity.Types.HELIOPELTIS, new ResourceLocation(FossilMod.MOD_ID, "textures/block/slabs/heliopeltis.png"));
        type.put(RotatableFossilEntity.Types.PSYCHOPYGE, new ResourceLocation(FossilMod.MOD_ID, "textures/block/slabs/psychopyge.png"));
        type.put(RotatableFossilEntity.Types.ATTERCOPUS, new ResourceLocation(FossilMod.MOD_ID, "textures/block/slabs/attercopus.png"));
        type.put(RotatableFossilEntity.Types.GIGATITAN, new ResourceLocation(FossilMod.MOD_ID, "textures/block/slabs/gigatitan.png"));
        type.put(RotatableFossilEntity.Types.FOREYIA, new ResourceLocation(FossilMod.MOD_ID, "textures/block/slabs/foreyia.png"));
        type.put(RotatableFossilEntity.Types.GOSFORDIA, new ResourceLocation(FossilMod.MOD_ID, "textures/block/slabs/gosfordia.png"));
        type.put(RotatableFossilEntity.Types.DIPTERONOTUS, new ResourceLocation(FossilMod.MOD_ID, "textures/block/slabs/dipteronotus.png"));
        type.put(RotatableFossilEntity.Types.BELANTSEA, new ResourceLocation(FossilMod.MOD_ID, "textures/block/slabs/belantsea.png"));
        type.put(RotatableFossilEntity.Types.BANDRINGA, new ResourceLocation(FossilMod.MOD_ID, "textures/block/slabs/bandringa.png"));
        type.put(RotatableFossilEntity.Types.TYRANNOPHONTES, new ResourceLocation(FossilMod.MOD_ID, "textures/block/slabs/tyrannophontes.png"));
        type.put(RotatableFossilEntity.Types.VESTINAUTILUS, new ResourceLocation(FossilMod.MOD_ID, "textures/block/slabs/vestinautilus.png"));
        type.put(RotatableFossilEntity.Types.ECHINOCHIMAERA, new ResourceLocation(FossilMod.MOD_ID, "textures/block/slabs/echinochimaera.png"));
        type.put(RotatableFossilEntity.Types.SQUATINACTIS, new ResourceLocation(FossilMod.MOD_ID, "textures/block/slabs/squatinactis.png"));
        type.put(RotatableFossilEntity.Types.ALLENYPTERUS, new ResourceLocation(FossilMod.MOD_ID, "textures/block/slabs/allenypterus.png"));
        type.put(RotatableFossilEntity.Types.GROENLANDASPIS, new ResourceLocation(FossilMod.MOD_ID, "textures/block/slabs/groenlandaspis.png"));
        type.put(RotatableFossilEntity.Types.CYCLOMEDUSA, new ResourceLocation(FossilMod.MOD_ID, "textures/block/slabs/cyclomedusa.png"));
        type.put(RotatableFossilEntity.Types.HADRONECTOR, new ResourceLocation(FossilMod.MOD_ID, "textures/block/slabs/hadronector.png"));
        type.put(RotatableFossilEntity.Types.SENEKICHTHYS, new ResourceLocation(FossilMod.MOD_ID, "textures/block/slabs/senekichthys.png"));
        type.put(RotatableFossilEntity.Types.BELLINYMPHA, new ResourceLocation(FossilMod.MOD_ID, "textures/block/slabs/bellinympha.png"));
        type.put(RotatableFossilEntity.Types.AEGER, new ResourceLocation(FossilMod.MOD_ID, "textures/block/slabs/aeger.png"));
        type.put(RotatableFossilEntity.Types.GREGORIUS, new ResourceLocation(FossilMod.MOD_ID, "textures/block/slabs/gregorius.png"));
        type.put(RotatableFossilEntity.Types.ANGUSTIDONTUS, new ResourceLocation(FossilMod.MOD_ID, "textures/block/slabs/angustidontus.png"));
        type.put(RotatableFossilEntity.Types.ZENASPIS, new ResourceLocation(FossilMod.MOD_ID, "textures/block/slabs/zenaspis.png"));
        type.put(RotatableFossilEntity.Types.BROCHOADMONES, new ResourceLocation(FossilMod.MOD_ID, "textures/block/slabs/brochoadmones.png"));
        type.put(RotatableFossilEntity.Types.RHINOPTERASPIS, new ResourceLocation(FossilMod.MOD_ID, "textures/block/slabs/rhinopteraspis.png"));
        type.put(RotatableFossilEntity.Types.GEMUENDINA, new ResourceLocation(FossilMod.MOD_ID, "textures/block/slabs/gemuendina.png"));
    ...
    public static Map<RotatableFossilEntity.FossilType, SkullModelBase> createFossilRenderers(EntityModelSet model) {
        ...
        builder.put(RotatableFossilEntity.Types.MARALDICHTHYS, new MaraldichthysFossilSlabModel(model.bakeLayer(ClientEvents.MARALDICHTHYS)));
        builder.put(RotatableFossilEntity.Types.HENSODON, new HensodonFossilSlabModel(model.bakeLayer(ClientEvents.HENSODON)));
        builder.put(RotatableFossilEntity.Types.BOBASATRANIA, new BobasatraniaFossilSlabModel(model.bakeLayer(ClientEvents.BOBASATRANIA)));
        ...
        builder.put(RotatableFossilEntity.Types.LUNGMENSHANASPIS, new LungmenshanaspisFossilSlabModel(model.bakeLayer(ClientEvents.LUNGMENSHANASPIS)));
        builder.put(RotatableFossilEntity.Types.DORYASPIS, new DoryaspisFossilSlabModel(model.bakeLayer(ClientEvents.DORYASPIS)));
        builder.put(RotatableFossilEntity.Types.GANTAROSTRATASPIS, new GantarostrataspisFossilSlabModel(model.bakeLayer(ClientEvents.GANTAROSTRATASPIS)));
        builder.put(RotatableFossilEntity.Types.FURCACAUDA, new FurcacaudaFossilSlabModel(model.bakeLayer(ClientEvents.FURCACAUDA)));
        builder.put(RotatableFossilEntity.Types.ANGELACANTHUS, new AngelacanthusFossilSlabModel(model.bakeLayer(ClientEvents.ANGELACANTHUS)));
        builder.put(RotatableFossilEntity.Types.OSTEOLEPIS, new OsteolepisFossilSlabModel(model.bakeLayer(ClientEvents.OSTEOLEPIS)));
        builder.put(RotatableFossilEntity.Types.SEMIONOTUS, new SemionotusFossilSlabModel(model.bakeLayer(ClientEvents.SEMIONOTUS)));
        builder.put(RotatableFossilEntity.Types.BUNDENBACHIELLUS, new BundenbachiellusFossilSlabModel(model.bakeLayer(ClientEvents.BUNDENBACHIELLUS)));
        builder.put(RotatableFossilEntity.Types.HIBBERTOPTERUS, new HibbertopterusFossilSlabModel(model.bakeLayer(ClientEvents.HIBBERTOPTERUS)));
        builder.put(RotatableFossilEntity.Types.EUSTHENOPTERON, new EusthenopteronFossilSlabModel(model.bakeLayer(ClientEvents.EUSTHENOPTERON)));
        builder.put(RotatableFossilEntity.Types.JAEKELOPTERUS, new JaekelopterusFossilSlabModel(model.bakeLayer(ClientEvents.JAEKELOPTERUS)));
        builder.put(RotatableFossilEntity.Types.PRAEARCTURUS, new PraearcturusFossilSlabModel(model.bakeLayer(ClientEvents.PRAEARCTURUS)));
        builder.put(RotatableFossilEntity.Types.XENACANTHUS, new XenacanthusFossilSlabModel(model.bakeLayer(ClientEvents.XENACANTHUS)));
        builder.put(RotatableFossilEntity.Types.SANTANMANTIS, new SantanmantisFossilSlabModel(model.bakeLayer(ClientEvents.SANTANMANTIS)));
        builder.put(RotatableFossilEntity.Types.HELIOPELTIS, new HeliopeltisFossilSlabModel(model.bakeLayer(ClientEvents.HELIOPELTIS)));
        builder.put(RotatableFossilEntity.Types.PSYCHOPYGE, new PsychopygeFossilSlabModel(model.bakeLayer(ClientEvents.PSYCHOPYGE)));
        builder.put(RotatableFossilEntity.Types.ATTERCOPUS, new AttercopusFossilSlabModel(model.bakeLayer(ClientEvents.ATTERCOPUS)));
        builder.put(RotatableFossilEntity.Types.GIGATITAN, new GigatitanFossilSlabModel(model.bakeLayer(ClientEvents.GIGATITAN)));
        builder.put(RotatableFossilEntity.Types.FOREYIA, new ForeyiaFossilSlabModel(model.bakeLayer(ClientEvents.FOREYIA)));
        builder.put(RotatableFossilEntity.Types.GOSFORDIA, new GosfordiaFossilSlabModel(model.bakeLayer(ClientEvents.GOSFORDIA)));
        builder.put(RotatableFossilEntity.Types.DIPTERONOTUS, new DipteronotusFossilSlabModel(model.bakeLayer(ClientEvents.DIPTERONOTUS)));
        builder.put(RotatableFossilEntity.Types.BELANTSEA, new BelantseaFossilSlabModel(model.bakeLayer(ClientEvents.BELANTSEA)));
        builder.put(RotatableFossilEntity.Types.BANDRINGA, new BandringaFossilSlabModel(model.bakeLayer(ClientEvents.BANDRINGA)));
        builder.put(RotatableFossilEntity.Types.TYRANNOPHONTES, new TyrannophontesFossilSlabModel(model.bakeLayer(ClientEvents.TYRANNOPHONTES)));
        builder.put(RotatableFossilEntity.Types.VESTINAUTILUS, new VestinautilusFossilSlabModel(model.bakeLayer(ClientEvents.VESTINAUTILUS)));
        builder.put(RotatableFossilEntity.Types.ECHINOCHIMAERA, new EchinochimaeraFossilSlabModel(model.bakeLayer(ClientEvents.ECHINOCHIMAERA)));
        builder.put(RotatableFossilEntity.Types.SQUATINACTIS, new SquatinactisFossilSlabModel(model.bakeLayer(ClientEvents.SQUATINACTIS)));
        builder.put(RotatableFossilEntity.Types.ALLENYPTERUS, new AllenypterusFossilSlabModel(model.bakeLayer(ClientEvents.ALLENYPTERUS)));
        builder.put(RotatableFossilEntity.Types.GROENLANDASPIS, new GroenlandaspisFossilSlabModel(model.bakeLayer(ClientEvents.GROENLANDASPIS)));
        builder.put(RotatableFossilEntity.Types.CYCLOMEDUSA, new CyclomedusaFossilSlabModel(model.bakeLayer(ClientEvents.CYCLOMEDUSA)));
        builder.put(RotatableFossilEntity.Types.HADRONECTOR, new HadronectorFossilSlabModel(model.bakeLayer(ClientEvents.HADRONECTOR)));
        builder.put(RotatableFossilEntity.Types.SENEKICHTHYS, new SenekichthysFossilSlabModel(model.bakeLayer(ClientEvents.SENEKICHTHYS)));
        builder.put(RotatableFossilEntity.Types.BELLINYMPHA, new BellinymphaFossilSlabModel(model.bakeLayer(ClientEvents.BELLINYMPHA)));
        builder.put(RotatableFossilEntity.Types.AEGER, new AegerFossilSlabModel(model.bakeLayer(ClientEvents.AEGER)));
        builder.put(RotatableFossilEntity.Types.GREGORIUS, new GregoriusFossilSlabModel(model.bakeLayer(ClientEvents.GREGORIUS)));
        builder.put(RotatableFossilEntity.Types.ANGUSTIDONTUS, new AngustidontusFossilSlabModel(model.bakeLayer(ClientEvents.ANGUSTIDONTUS)));
        builder.put(RotatableFossilEntity.Types.ZENASPIS, new ZenaspisFossilSlabModel(model.bakeLayer(ClientEvents.ZENASPIS)));
        builder.put(RotatableFossilEntity.Types.BROCHOADMONES, new BrochoadmonesFossilSlabModel(model.bakeLayer(ClientEvents.BROCHOADMONES)));
        builder.put(RotatableFossilEntity.Types.RHINOPTERASPIS, new RhinopteraspisFossilSlabModel(model.bakeLayer(ClientEvents.RHINOPTERASPIS)));
        builder.put(RotatableFossilEntity.Types.GEMUENDINA, new GemuendinaFossilSlabModel(model.bakeLayer(ClientEvents.GEMUENDINA)));
    ...
    public static void renderFossilSlab(FossilSlabBlockEntity entity, Direction dir, float p_173665_, float p_173666_, PoseStack pose, MultiBufferSource p_173668_, int p_173669_, SkullModelBase base, RenderType p_173671_) {
        ...
        if (fossilBlock == RotatableFossilEntity.Types.TROPAEUM) {
            ...
            ;
        } else if (fossilBlock == RotatableFossilEntity.Types.MARALDICHTHYS) {
            float scale = 0.15F;
            pose.scale(-scale, -scale, scale);
            switch (dir) {
                case DOWN -> {
            ...
            ;
        } else if (fossilBlock == RotatableFossilEntity.Types.HENSODON) {
            float scale = 0.15F;
            pose.scale(-scale, -scale, scale);
            switch (dir) {
                case DOWN -> {
            ...
            ;
        } else if (fossilBlock == RotatableFossilEntity.Types.BOBASATRANIA) {
            float scale = 0.53F;
            pose.scale(-scale, -scale, scale);
            switch (dir) {
                case DOWN -> {
            ...
            ;
        } else if (fossilBlock == RotatableFossilEntity.Types.HARPAGOFUTUTOR) {
            float scale = 0.1F;
            pose.scale(-scale, -scale, scale);
            switch (dir) {
                case DOWN -> {
            ...
            ;
        } else if (fossilBlock == RotatableFossilEntity.Types.PARAMETEORASPIS) {
            float scale = 0.4F;
            pose.scale(-scale, -scale, scale);
            switch (dir) {
                case DOWN -> {
            ...
            ;
        } else if (fossilBlock == RotatableFossilEntity.Types.CLADOSELACHE) {
            float scale = 0.53F;
            pose.scale(-scale, -scale, scale);
            switch (dir) {
                case DOWN -> {
            ...
            ;
        } else if (fossilBlock == RotatableFossilEntity.Types.MIMETASTER) {
            float scale = 0.1F;
            pose.scale(-scale, -scale, scale);
            switch (dir) {
                case DOWN -> {
            ...
            ;
        } else if (fossilBlock == RotatableFossilEntity.Types.HELIANTHASTER) {
            float scale = 0.1F;
            pose.scale(-scale, -scale, scale);
            switch (dir) {
                case DOWN -> {
            ...
            ;
        } else if (fossilBlock == RotatableFossilEntity.Types.FLAGELLOPANTOPUS) {
            float scale = 0.1F;
            pose.scale(-scale, -scale, scale);
            switch (dir) {
                case DOWN -> {
            ...
            ;
        } else if (fossilBlock == RotatableFossilEntity.Types.LUNGMENSHANASPIS) {
            float scale = 0.1F;
            pose.scale(-scale, -scale, scale);
            switch (dir) {
                case DOWN -> {
            ...
            ;
        } else if (fossilBlock == RotatableFossilEntity.Types.DORYASPIS) {
            float scale = 0.1F;
            pose.scale(-scale, -scale, scale);
            switch (dir) {
                case DOWN -> {
            ...
            ;
        } else if (fossilBlock == RotatableFossilEntity.Types.GANTAROSTRATASPIS) {
            float scale = 0.1F;
            pose.scale(-scale, -scale, scale);
            switch (dir) {
                case DOWN -> {
            ...
            ;
        } else if (fossilBlock == RotatableFossilEntity.Types.FURCACAUDA) {
            float scale = 0.1F;
            pose.scale(-scale, -scale, scale);
            switch (dir) {
                case DOWN -> {
            ...
            ;
        } else if (fossilBlock == RotatableFossilEntity.Types.ANGELACANTHUS) {
            float scale = 0.1F;
            pose.scale(-scale, -scale, scale);
            switch (dir) {
                case DOWN -> {
            ...
            ;
        } else if (fossilBlock == RotatableFossilEntity.Types.OSTEOLEPIS) {
            float scale = 0.1F;
            pose.scale(-scale, -scale, scale);
            switch (dir) {
                case DOWN -> {
            ...
            ;
        } else if (fossilBlock == RotatableFossilEntity.Types.SEMIONOTUS) {
            float scale = 0.1F;
            pose.scale(-scale, -scale, scale);
            switch (dir) {
                case DOWN -> {
            ...
            ;
        } else if (fossilBlock == RotatableFossilEntity.Types.BUNDENBACHIELLUS) {
            float scale = 0.1F;
            pose.scale(-scale, -scale, scale);
            switch (dir) {
                case DOWN -> {
            ...
            ;
        } else if (fossilBlock == RotatableFossilEntity.Types.HIBBERTOPTERUS) {
            float scale = 0.53F;
            pose.scale(-scale, -scale, scale);
            switch (dir) {
                case DOWN -> {
            ...
            ;
        } else if (fossilBlock == RotatableFossilEntity.Types.EUSTHENOPTERON) {
            float scale = 0.2F;
            pose.scale(-scale, -scale, scale);
            switch (dir) {
                case DOWN -> {
            ...
            ;
        } else if (fossilBlock == RotatableFossilEntity.Types.JAEKELOPTERUS) {
            float scale = 0.53F;
            pose.scale(-scale, -scale, scale);
            switch (dir) {
                case DOWN -> {
            ...
            ;
        } else if (fossilBlock == RotatableFossilEntity.Types.PRAEARCTURUS) {
            float scale = 0.4F;
            pose.scale(-scale, -scale, scale);
            switch (dir) {
                case DOWN -> {
            ...
            ;
        } else if (fossilBlock == RotatableFossilEntity.Types.XENACANTHUS) {
            float scale = 0.53F;
            pose.scale(-scale, -scale, scale);
            switch (dir) {
                case DOWN -> {
            ...
            ;
        } else if (fossilBlock == RotatableFossilEntity.Types.SANTANMANTIS) {
            float scale = 0.15F;
            pose.scale(-scale, -scale, scale);
            switch (dir) {
                case DOWN -> {
            ...
            ;
        } else if (fossilBlock == RotatableFossilEntity.Types.HELIOPELTIS) {
            float scale = 0.1F;
            pose.scale(-scale, -scale, scale);
            switch (dir) {
                case DOWN -> {
            ...
            ;
        } else if (fossilBlock == RotatableFossilEntity.Types.PSYCHOPYGE) {
            float scale = 0.15F;
            pose.scale(-scale, -scale, scale);
            switch (dir) {
                case DOWN -> {
            ...
            ;
        } else if (fossilBlock == RotatableFossilEntity.Types.ATTERCOPUS) {
            float scale = 0.1F;
            pose.scale(-scale, -scale, scale);
            switch (dir) {
                case DOWN -> {
            ...
            ;
        } else if (fossilBlock == RotatableFossilEntity.Types.GIGATITAN) {
            float scale = 0.1F;
            pose.scale(-scale, -scale, scale);
            switch (dir) {
                case DOWN -> {
            ...
            ;
        } else if (fossilBlock == RotatableFossilEntity.Types.FOREYIA) {
            float scale = 0.2F;
            pose.scale(-scale, -scale, scale);
            switch (dir) {
                case DOWN -> {
            ...
            ;
        } else if (fossilBlock == RotatableFossilEntity.Types.GOSFORDIA) {
            float scale = 0.2F;
            pose.scale(-scale, -scale, scale);
            switch (dir) {
                case DOWN -> {
            ...
            ;
        } else if (fossilBlock == RotatableFossilEntity.Types.DIPTERONOTUS) {
            float scale = 0.2F;
            pose.scale(-scale, -scale, scale);
            switch (dir) {
                case DOWN -> {
            ...
            ;
        } else if (fossilBlock == RotatableFossilEntity.Types.BELANTSEA) {
            float scale = 0.4F;
            pose.scale(-scale, -scale, scale);
            switch (dir) {
                case DOWN -> {
            ...
            ;
        } else if (fossilBlock == RotatableFossilEntity.Types.BANDRINGA) {
            float scale = 0.4F;
            pose.scale(-scale, -scale, scale);
            switch (dir) {
                case DOWN -> {
            ...
            ;
        } else if (fossilBlock == RotatableFossilEntity.Types.TYRANNOPHONTES) {
            float scale = 0.1F;
            pose.scale(-scale, -scale, scale);
            switch (dir) {
                case DOWN -> {
            ...
            ;
        } else if (fossilBlock == RotatableFossilEntity.Types.VESTINAUTILUS) {
            float scale = 0.15F;
            pose.scale(-scale, -scale, scale);
            switch (dir) {
                case DOWN -> {
            ...
            ;
        } else if (fossilBlock == RotatableFossilEntity.Types.ECHINOCHIMAERA) {
            float scale = 0.15F;
            pose.scale(-scale, -scale, scale);
            switch (dir) {
                case DOWN -> {
            ...
            ;
        } else if (fossilBlock == RotatableFossilEntity.Types.SQUATINACTIS) {
            float scale = 0.15F;
            pose.scale(-scale, -scale, scale);
            switch (dir) {
                case DOWN -> {
            ...
            ;
        } else if (fossilBlock == RotatableFossilEntity.Types.ALLENYPTERUS) {
            float scale = 0.1F;
            pose.scale(-scale, -scale, scale);
            switch (dir) {
                case DOWN -> {
            ...
            ;
        } else if (fossilBlock == RotatableFossilEntity.Types.GROENLANDASPIS) {
            float scale = 0.2F;
            pose.scale(-scale, -scale, scale);
            switch (dir) {
                case DOWN -> {
            ...
            ;
        } else if (fossilBlock == RotatableFossilEntity.Types.CYCLOMEDUSA) {
            float scale = 0.15F;
            pose.scale(-scale, -scale, scale);
            switch (dir) {
                case DOWN -> {
            ...
            ;
        } else if (fossilBlock == RotatableFossilEntity.Types.HADRONECTOR) {
            float scale = 0.15F;
            pose.scale(-scale, -scale, scale);
            switch (dir) {
                case DOWN -> {
            ...
            ;
        } else if (fossilBlock == RotatableFossilEntity.Types.SENEKICHTHYS) {
            float scale = 0.15F;
            pose.scale(-scale, -scale, scale);
            switch (dir) {
                case DOWN -> {
            ...
            ;
        } else if (fossilBlock == RotatableFossilEntity.Types.BELLINYMPHA) {
            float scale = 0.1F;
            pose.scale(-scale, -scale, scale);
            switch (dir) {
                case DOWN -> {
            ...
            ;
        } else if (fossilBlock == RotatableFossilEntity.Types.AEGER) {
            float scale = 0.1F;
            pose.scale(-scale, -scale, scale);
            switch (dir) {
                case DOWN -> {
            ...
            ;
        } else if (fossilBlock == RotatableFossilEntity.Types.GREGORIUS) {
            float scale = 0.15F;
            pose.scale(-scale, -scale, scale);
            switch (dir) {
                case DOWN -> {
            ...
            ;
        } else if (fossilBlock == RotatableFossilEntity.Types.ANGUSTIDONTUS) {
            float scale = 0.1F;
            pose.scale(-scale, -scale, scale);
            switch (dir) {
                case DOWN -> {
            ...
            ;
        } else if (fossilBlock == RotatableFossilEntity.Types.ZENASPIS) {
            float scale = 0.15F;
            pose.scale(-scale, -scale, scale);
            switch (dir) {
                case DOWN -> {
            ...
            ;
        } else if (fossilBlock == RotatableFossilEntity.Types.BROCHOADMONES) {
            float scale = 0.15F;
            pose.scale(-scale, -scale, scale);
            switch (dir) {
                case DOWN -> {
            ...
            ;
        } else if (fossilBlock == RotatableFossilEntity.Types.RHINOPTERASPIS) {
            float scale = 0.2F;
            pose.scale(-scale, -scale, scale);
            switch (dir) {
                case DOWN -> {
            ...
            ;
        } else if (fossilBlock == RotatableFossilEntity.Types.GEMUENDINA) {
            float scale = 0.15F;
            pose.scale(-scale, -scale, scale);
            switch (dir) {
                case DOWN -> {
            ...
            ;
        } else if (fossilBlock == RotatableFossilEntity.Types.PAREXUS) {
            float scale = 0.1F;
            pose.scale(-scale, -scale, scale);
            switch (dir) {
                case DOWN -> {
            ...
            ;
        } else if (fossilBlock == RotatableFossilEntity.Types.SCAUMENACIA) {
            float scale = 0.15F;
            pose.scale(-scale, -scale, scale);
            switch (dir) {
                case DOWN -> {
            ...
            ;
        } else if (fossilBlock == RotatableFossilEntity.Types.DREPANASPIS) {
            float scale = 0.2F;
            pose.scale(-scale, -scale, scale);
            switch (dir) {
                case DOWN -> {
            ...
            ;
        }  else if (fossilBlock == RotatableFossilEntity.Types.ANOMALOCARIS) {
            float scale = 0.2F;
            pose.scale(-scale, -scale, scale);
            switch (dir) {
                case DOWN -> {
